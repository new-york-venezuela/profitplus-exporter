...
export const COMPRAS_CONFIG: ReportConfig = {
  ...
  columns: [
    { key: 'nro', label: 'Nº', defaultVisible: true, defaultOrder: 0, alwaysVisible: true, type: 'number' },
    ...
    { key: 'total_compras_incluye_iva', label: 'TOTAL COMPRAS INCLUYE IVA', defaultVisible: true, defaultOrder: 12, type: 'number' },
    { key: 'compras_sin_derecho_credito', label: 'COMPRAS SIN DERECHO A CREDITO IVA', defaultVisible: true, defaultOrder: 13, type: 'number' },
    { key: 'base_imponible', label: 'BASE IMPONIBLE', defaultVisible: true, defaultOrder: 14, type: 'number' },
    { key: 'alicuota', label: '% ALICUOTA', defaultVisible: true, defaultOrder: 15, type: 'number' },
    { key: 'impuesto_iva', label: 'IMPUESTO IVA', defaultVisible: true, defaultOrder: 16, type: 'number' },
    { key: 'iva_retenido', label: 'IVA RETENIDO', defaultVisible: true, defaultOrder: 17, type: 'number' },
  ],
};
