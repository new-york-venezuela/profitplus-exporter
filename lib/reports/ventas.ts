...
export const VENTAS_CONFIG: ReportConfig = {
  ...
  columns: [
    { key: 'item',                        label: 'ITEM',                        defaultVisible: true,  defaultOrder: 0,  alwaysVisible: true, type: 'number' },
    ...
    { key: 'ventas_exentas',              label: 'Exento',                      defaultVisible: true,  defaultOrder: 7,  type: 'number' },
    { key: 'base_imp',                    label: 'Base Imponible',              defaultVisible: true,  defaultOrder: 8,  type: 'number' },
    { key: 'tasa',                        label: '% Alic.',                     defaultVisible: true,  defaultOrder: 9,  type: 'number' },
    { key: 'monto_imp',                   label: 'Impuesto I.V.A.',             defaultVisible: true,  defaultOrder: 10, type: 'number' },
    { key: 'total_neto',                  label: 'Total ventas + IVA',          defaultVisible: true,  defaultOrder: 11, type: 'number' },
    { key: 'monto_ret_imp',               label: 'I.V.A Retenido',              defaultVisible: true,  defaultOrder: 12, type: 'number' },
    { key: 'monto_igtf',                  label: 'I.G.T.F Percibido',           defaultVisible: true,  defaultOrder: 13, type: 'number' },
