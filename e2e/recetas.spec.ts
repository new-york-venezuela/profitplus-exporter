...
//
// '0000005' (Baguette 4 Granos 220gr) and '0000083' (Harina Panadera 45Kg
// Atlas) are real article codes confirmed present in the restored backup.
...
test.describe('recetas @mssql', () => {
  test('creates a recipe, saves ERP + manual lines, and sees a live FIFO cost', async ({ adminPage }) => {
    ...
    const existingLink = adminPage.getByRole('link', { name: 'Editar / Costo' });
