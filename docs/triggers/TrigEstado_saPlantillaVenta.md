# Trigger: TrigEstado_saPlantillaVenta
...
-- Date		  : 30/06/2010
-- =============================================
CREATE TRIGGER [dbo].[TrigEstado_saPlantillaVenta]
   ON  [dbo].[saPlantillaVenta]  FOR INSERT,UPDATE
AS 
	...
	BEGIN
		...
		Begin
			Insert into saHistoricoEstado (	doc_orig, tipo_doc, Estado, fecha) values
				(@Id, 'saPlantillaVenta',  cast(@EstadoNew as char(4)), getdate())
		End
