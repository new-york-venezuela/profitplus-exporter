# Trigger: TrigEstado_saAjPrecioCostoAuto
...
-- Date		  : 16/07/2010
-- =============================================
CREATE TRIGGER [dbo].[TrigEstado_saAjPrecioCostoAuto]
   ON  [dbo].[saAjPrecioCostoAuto]  FOR INSERT,UPDATE
AS 
	...
	BEGIN
		...
		Begin
			Insert into saHistoricoEstado (	doc_orig, tipo_doc, Estado, fecha) values
				(@Id, 'saAjPrecioCostoAuto',  cast(@EstadoNew as char(4)), getdate())
		End
