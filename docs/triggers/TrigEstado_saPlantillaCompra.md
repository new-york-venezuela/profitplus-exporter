# Trigger: TrigEstado_saPlantillaCompra
...
-- Date		  : 12/07/2010
-- =============================================
CREATE TRIGGER [dbo].[TrigEstado_saPlantillaCompra]
   ON  [dbo].[saPlantillaCompra]  FOR INSERT,UPDATE
AS 
	...
	BEGIN
		...
		Begin
			Insert into saHistoricoEstado (	doc_orig, tipo_doc, Estado, fecha) values
				(@Id, 'saPlantillaCompra',  cast(@EstadoNew as char(4)), getdate())
		End
