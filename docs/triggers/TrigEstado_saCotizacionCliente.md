# Trigger: TrigEstado_saCotizacionCliente
...
-- Date		  : 30/06/2010
-- =============================================
CREATE TRIGGER [dbo].[TrigEstado_saCotizacionCliente]
   ON  [dbo].[saCotizacionCliente]  FOR INSERT,UPDATE
AS 
	...
	BEGIN
		...
		Begin
			Insert into saHistoricoEstado (	doc_orig, tipo_doc, Estado, fecha) values
				(@Id, 'saCotizacionCliente',  cast(@EstadoNew as char(4)), getdate())
		End
