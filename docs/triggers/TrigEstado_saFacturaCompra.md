# Trigger: TrigEstado_saFacturaCompra
...
-- Date		  : 12/07/2010
-- =============================================
CREATE TRIGGER [dbo].[TrigEstado_saFacturaCompra]
   ON  [dbo].[saFacturaCompra]  FOR INSERT,UPDATE
AS 
	...
	BEGIN
		...
		Begin
			Insert into saHistoricoEstado (	doc_orig, tipo_doc, Estado, fecha) values
				(@Id, 'saFacturaCompra',  cast(@EstadoNew as char(4)), getdate())
		End
