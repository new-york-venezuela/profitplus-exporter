# Trigger: TrigEstado_saBeneficiario
...
-- =============================================
CREATE TRIGGER [dbo].[TrigEstado_saBeneficiario]
   ON  [dbo].[saBeneficiario]  FOR INSERT,UPDATE
AS 
	...
	BEGIN
		...
		Begin
			Insert into saHistoricoEstado (	doc_orig, tipo_doc, Estado, fecha) values
				(@Id, 'saBeneficiario',  cast(@EstadoNew as char(4)), getdate())
		End
