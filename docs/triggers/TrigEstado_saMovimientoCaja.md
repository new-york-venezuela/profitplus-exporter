# Trigger: TrigEstado_saMovimientoCaja
...
-- Date		  : 12/07/2010
-- =============================================
CREATE TRIGGER [dbo].[TrigEstado_saMovimientoCaja]
   ON  [dbo].[saMovimientoCaja]  FOR INSERT,UPDATE
AS 
	...
	BEGIN
		...
		Begin
			Insert into saHistoricoEstado (	doc_orig, tipo_doc, Estado, fecha) values
				(@Id, 'saMovimientoCaja',  cast(@EstadoNew as char(4)), getdate())
		End
