# Trigger: TrigEstado_saProveedor
**Tabla**: `saProveedor`
...
-- Description:	<>
-- =============================================
CREATE TRIGGER [dbo].[TrigEstado_saProveedor]
   ON  [dbo].[saProveedor]  FOR INSERT,UPDATE
AS 
	...
	BEGIN
		...
		Begin
			Insert into saHistoricoEstado (	doc_orig, tipo_doc, Estado, fecha) values
				(@Id, 'saProveedor',  cast(@EstadoNew as char(4)), getdate())
		End
