# Trigger: TrigEstado_saPedidoVenta
**Tabla**: `saPedidoVenta`
...
-- Date		  : 30/06/2010
-- =============================================
CREATE TRIGGER [dbo].[TrigEstado_saPedidoVenta]
   ON  [dbo].[saPedidoVenta]  FOR INSERT,UPDATE
AS 
	...
	BEGIN
		...
		Begin
			Insert into saHistoricoEstado (	doc_orig, tipo_doc, Estado, fecha) values
				(@Id, 'saPedidoVenta',  cast(@EstadoNew as char(4)), getdate())
		End
