# Trigger: TrigEstado_saDocumentoVenta
...
-- Description:	<Inserta una traza cada vez que cambia el estado del documento (Campo anulado>
-- Date		  : 30/06/2010
-- =============================================
CREATE TRIGGER [dbo].[TrigEstado_saDocumentoVenta]
   ON  [dbo].[saDocumentoVenta]  FOR INSERT,UPDATE
AS 
	...
	BEGIN
		...
		Begin
			Insert into saHistoricoEstado (	doc_orig, tipo_doc, Estado, fecha) values
				(@Id, 'saDocumentoVenta',  cast(@EstadoNew as char(4)), getdate())
		End
