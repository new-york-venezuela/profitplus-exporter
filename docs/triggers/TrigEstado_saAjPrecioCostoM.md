# Trigger: TrigEstado_saAjPrecioCostoM
...
-- Date		  : 16/07/2010
-- =============================================
CREATE TRIGGER [dbo].[TrigEstado_saAjPrecioCostoM]
   ON  [dbo].[saAjPrecioCostoM]  FOR INSERT,UPDATE
AS 
	...
	BEGIN
		...
		Begin
			Insert into saHistoricoEstado (	doc_orig, tipo_doc, Estado, fecha) values
				(@Id, 'saAjPrecioCostoM',  cast(@EstadoNew as char(4)), getdate())
		End
