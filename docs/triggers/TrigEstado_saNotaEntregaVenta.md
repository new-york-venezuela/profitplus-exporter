# Trigger: TrigEstado_saNotaEntregaVenta
...
-- Date		  : 30/06/2010
-- =============================================
CREATE TRIGGER [dbo].[TrigEstado_saNotaEntregaVenta]
   ON  [dbo].[saNotaEntregaVenta]  FOR INSERT,UPDATE
AS 
	...
	BEGIN
		...
		Begin
			Insert into saHistoricoEstado (	doc_orig, tipo_doc, Estado, fecha) values
				(@Id, 'saNotaEntregaVenta',  cast(@EstadoNew as char(4)), getdate())
		End
