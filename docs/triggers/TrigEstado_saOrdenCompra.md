# Trigger: TrigEstado_saOrdenCompra
**Tabla**: `saOrdenCompra`
...
-- Date		  : 12/07/2010
-- =============================================
CREATE TRIGGER [dbo].[TrigEstado_saOrdenCompra]
   ON  [dbo].[saOrdenCompra]  FOR INSERT,UPDATE
AS 
	...
	BEGIN
		...
		Begin
			Insert into saHistoricoEstado (	doc_orig, tipo_doc, Estado, fecha) values
				(@Id, 'saOrdenCompra',  cast(@EstadoNew as char(4)), getdate())
		End
