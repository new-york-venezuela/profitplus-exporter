# Trigger: TrigEstado_saDocumentoCompra
...
-- Date		  : 12/07/2010
-- =============================================
CREATE TRIGGER [dbo].[TrigEstado_saDocumentoCompra]
   ON  [dbo].[saDocumentoCompra]  FOR INSERT,UPDATE
AS 
	...
	BEGIN
		...
		Begin
			Insert into saHistoricoEstado (	doc_orig, tipo_doc, Estado, fecha) values
				(@Id, 'saDocumentoCompra',  cast(@EstadoNew as char(4)), getdate())
		End
