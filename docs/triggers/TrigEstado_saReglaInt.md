...
-- =============================================
CREATE TRIGGER [dbo].[TrigEstado_saReglaInt]
   ON  [dbo].[saReglaInt]  FOR INSERT,UPDATE
AS 
	...
	BEGIN
		...
		Begin
			Insert into saHistoricoEstado (	doc_orig, tipo_doc, Estado, fecha) values
				(@Id, 'saReglaInt',  cast(@EstadoNew as char(4)), getdate())
		End
