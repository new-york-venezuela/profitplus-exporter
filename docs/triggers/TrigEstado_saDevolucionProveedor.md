# Trigger: TrigEstado_saDevolucionProveedor
...
-- Date		  : 12/07/2010
-- =============================================
CREATE TRIGGER [dbo].[TrigEstado_saDevolucionProveedor]
   ON  [dbo].[saDevolucionProveedor]  FOR INSERT,UPDATE
AS 
	...
	BEGIN
		...
		Begin
			Insert into saHistoricoEstado (	doc_orig, tipo_doc, Estado, fecha) values
				(@Id, 'saDevolucionProveedor',  cast(@EstadoNew as char(4)), getdate())
		End
