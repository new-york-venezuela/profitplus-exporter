# Trigger: TrigEstado_saOrdenPago
**Tabla**: `saOrdenPago`
...
-- Date		  : 12/07/2010
-- =============================================
CREATE TRIGGER [dbo].[TrigEstado_saOrdenPago]
   ON  [dbo].[saOrdenPago]  FOR INSERT,UPDATE
AS 
	...
	BEGIN
		...
		Begin
			Insert into saHistoricoEstado (	doc_orig, tipo_doc, Estado, fecha) values
				(@Id, 'saOrdenPago',  cast(@EstadoNew as char(4)), getdate())
		End
