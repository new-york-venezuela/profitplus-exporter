# Trigger: TrigEstado_saDevolucionCliente
...
-- Date		  : 30/06/2010
-- =============================================
CREATE TRIGGER [dbo].[TrigEstado_saDevolucionCliente]
   ON  [dbo].[saDevolucionCliente]  FOR INSERT,UPDATE
AS 
	...
	BEGIN
		...
		Begin
			Insert into saHistoricoEstado (	doc_orig, tipo_doc, Estado, fecha) values
				(@Id, 'saDevolucionCliente',  cast(@EstadoNew as char(4)), getdate())
		End
