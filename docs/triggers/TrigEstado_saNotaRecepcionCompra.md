# Trigger: TrigEstado_saNotaRecepcionCompra
...
-- Date		  : 12/07/2010
-- =============================================
CREATE TRIGGER [dbo].[TrigEstado_saNotaRecepcionCompra]
   ON  [dbo].[saNotaRecepcionCompra]  FOR INSERT,UPDATE
AS 
	...
	BEGIN
		...
		Begin
			Insert into saHistoricoEstado (	doc_orig, tipo_doc, Estado, fecha) values
				(@Id, 'saNotaRecepcionCompra',  cast(@EstadoNew as char(4)), getdate())
		End
