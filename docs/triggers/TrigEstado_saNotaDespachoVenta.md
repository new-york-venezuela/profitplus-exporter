# Trigger: TrigEstado_saNotaDespachoVenta
...
-- Date		  : 30/06/2010
-- =============================================
CREATE TRIGGER [dbo].[TrigEstado_saNotaDespachoVenta]
   ON  [dbo].[saNotaDespachoVenta]  FOR INSERT,UPDATE
AS 
	...
	BEGIN
		...
		Begin
			Insert into saHistoricoEstado (	doc_orig, tipo_doc, Estado, fecha) values
				(@Id, 'saNotaDespachoVenta',  cast(@EstadoNew as char(4)), getdate())
		End
