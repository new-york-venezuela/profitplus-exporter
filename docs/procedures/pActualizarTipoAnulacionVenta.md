# SP: pActualizarTipoAnulacionVenta
**Tipo**: Actualizar
**Módulo**: General
...
```sql
/**************************************************************************
*NOMBRE			: pActualizarTipoAnulacionVenta
*DESCRIPCIÓN	: Actualiza un Tipo de Anulacion Venta
*AUTOR			: SOFTECH SISTEMAS
**************************************************************************/
CREATE PROCEDURE [dbo].[pActualizarTipoAnulacionVenta]
	(
...
AS 
    BEGIN	
        ...
        SET co_anulacion = @sCo_Anulacion, des_tipo = @sDes_tipo, campo1 = @sCampo1,
		...
		-- Insertar Pista
                EXEC [pInsertarPista] @sUsuario_Id = @sCo_Us_Mo, @dtFecha = @dtFe_In, @sCo_Sucu = @sCo_Sucu_Mo,
                    @sTablaOri = 'saTipoAnulacionVenta', @rowguidOri = @rowGuidOri, @sTipo_Op = 'M', @sMaquina = @sMaquina,
                    @sCampos = @sCampos
            END
```
