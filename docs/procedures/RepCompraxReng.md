...
-- Description:	<Reporte de Factura de Compra con sus Renglones>
-- =============================================
CREATE PROCEDURE [dbo].[RepCompraxReng] 
...
-------------------------------
        ...
        SELECT
            @cAnulado AS Filtro_anulado, 'compra' AS tip_rep, ART.art_des, ART.modelo, ART.co_lin, ART.co_subl,
            ...
            FVR.co_art, FVR.des_art, AU.co_uni, FVR.sco_uni, FVR.co_alma, FVR.ti
```
