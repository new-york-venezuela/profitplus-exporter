...
-- Description:	<Reporte de Cotizaciones de Proveedores por Número>
-- =============================================
CREATE PROCEDURE [RepCotizacionProveedorxNum] 
...
-------------------------------
        SELECT
            ...
            CP.total_bruto, CP.monto_imp  / ( CASE WHEN @cCo_Moneda IS NULL THEN 1
                                   ELSE CP.tasa
                              END ) AS monto_imp, 
			CP.monto_imp2, CP.monto_imp3, CP.otros1, CP.otros2, CP.otros3,
