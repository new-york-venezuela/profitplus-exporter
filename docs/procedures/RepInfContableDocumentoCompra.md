# SP: RepInfContableDocumentoCompra
**Tipo**: Reporte
**Módulo**: Compras
...
-- Description:	<Información Contable Documento de Compra>
-- =============================================
CREATE PROCEDURE [dbo].[RepInfContableDocumentoCompra]
...
BEGIN
  ...
  Select A.nro_doc, DOC.co_tipo_doc, DOC.fec_emis, DOC.co_prov, (select prov_des from saProveedor where co_prov = DOC.co_prov) as prov_des, 
 ...
 Select	A.nro_doc, A.feccom, '01' as num_carp,
		...
		C.N.value('(Porcentaje)[1]', 'varchar(12)') as por
```
