# SP: RepNotaEntregaCaracteristica
**Tipo**: Reporte
**Módulo**: Inventario
...
/*=============================================
 ...
 Description:	<Nota de Entrega con sus Caracteristicas>
 =============================================*/ 
CREATE PROCEDURE [dbo].[RepNotaEntregaCaracteristica]
...
AS 
    BEGIN
	   ...
	   from saNotaEntregaVenta E
	   
	   inner join saNotaEntregaVentaReng R on e.doc_num = r.doc_num 
	   left join savArtCaracteristicaNENT V on r.doc_num = v.num_doc and r.reng_num = v.reng_num 
	   ...
	   left join sasublinea as sub_05 on sub_05.co_lin = v.co_lin05 and sub_05.co_subl = v.co_subl05
		...
		AND ( @sCo_Sucursal IS NULL OR e.co_sucu_in = @sCo_Sucu
```
