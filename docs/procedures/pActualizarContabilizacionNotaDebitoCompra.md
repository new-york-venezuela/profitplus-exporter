# SP: pActualizarContabilizacionNotaDebitoCompra
**Tipo**: Actualizar
**Módulo**: Compras
...
```sql
/*************************************************************************************************
NOMBRE:	pActualizarContabilizacionNotaDebitoCompra
DESCRIPCION:Actualizar las contabilizaciones de Nota De Debito en Compras 
CREADO POR: SOFTECH SISTEMAS
CREADO EL: 14/04/2011
**************************************************************************************************/
CREATE PROCEDURE [pActualizarContabilizacionNotaDebitoCompra]
    (
      @sCo_Doc CHAR(20) ,
      @sCo_Tipo_Doc CHAR(6),
