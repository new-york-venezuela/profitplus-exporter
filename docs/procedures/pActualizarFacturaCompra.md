...
*NOMBRE			:	pActualizarFacturaCompra
*DESCRIPCIÓN	:	Actualiza una factura de compra
*AUTOR			: Softech
**************************************************************************/

CREATE PROCEDURE [dbo].[pActualizarFacturaCompra]
     (
      @sDoc_Num CHAR(20) ,
      @sDoc_NumOri CHAR(20) ,
      @sNro_Fact CHAR(20) ,
...
AS 
    BEGIN	
        ...
        UPDATE
            saFacturaCompra
        SET doc_num = @sDoc_Num, nro_fact = @sNro_Fact, descrip = @
```
