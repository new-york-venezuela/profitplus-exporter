# SP: pSeleccionarContabilizacionNotaDebitoCompraRenglon
**Tipo**: Seleccionar
**Módulo**: Inventario
...
-- Description:	<pSeleccionarContabilizacionNotaDebitoCompraRenglon>
-- =============================================
CREATE PROCEDURE [dbo].[pSeleccionarContabilizacionNotaDebitoCompraRenglon]
    (
...
AS 
    BEGIN
		...
		FROM         dbo.saDocumentoCompraReng AS DVR LEFT OUTER JOIN
