# SP: pActualizarDescuentoArticulo
**Tipo**: Actualizar
**Módulo**: Inventario
...
***************************************************************************************************************/
CREATE PROCEDURE [dbo].[pActualizarDescuentoArticulo]
    (
...
AS 
    BEGIN
        ...
        UPDATE
            saDescArticulo
        SET co_desc = @sCo_Desc, des_des = @sDes_Des, tip_cli = @sTip_Cli, co_art = @sCo_Art, hasta1 = @deHasta1,
            hasta2 = @deHasta2, hasta3 = @deHasta3, hasta4 = @deHasta4, hasta5 = @deHasta5, porc1 = @dePorc1,
            porc2 = @dePorc2, porc3 = @dePorc3, porc4 = @dePorc4, porc5 = @dePorc5, porc6 = @dePorc6, campo1 = @sCampo1,
            campo2 = @sCampo2, campo3 = @sCampo3, campo4 = @sCampo4, campo5 = @sCampo5, campo6 = @sCampo6,
            campo7 = @sCampo7, campo8 = @sCampo8, co_us_mo = @sC
```
