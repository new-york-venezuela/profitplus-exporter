...
-- Description:	<Reporte de Cotizaciones de Clientes por Número>
-- =============================================
CREATE PROCEDURE [RepCotizacionClientexNum] 
...
-------------------------------
        SELECT
            @cAnulado AS Filtro_anulado, 'COTI' AS tipo_rep, CLI.tip_cli, CLI.cli_des, CLI.co_zon,
