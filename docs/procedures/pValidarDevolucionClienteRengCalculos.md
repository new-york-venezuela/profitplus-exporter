# SP: pValidarDevolucionClienteRengCalculos
**Tipo**: Validar
**Módulo**: Ventas
...
## Código (excerpt)
```sql
CREATE PROCEDURE [dbo].[pValidarDevolucionClienteRengCalculos]
    (
                ...
                IF ( @i = 1 ) 
                    BEGIN
                        ...
                        FOR
                            ...
                            WHERE
                                  ROUND(R.monto_desc,2) <> ROUND(dbo.CalcularMontoPorcentaje(R.porc_desc, R.prec_vta * R.total_art,
                                                                                  1), 2) --DN 050522
```
