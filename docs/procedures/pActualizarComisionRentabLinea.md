# SP: pActualizarComisionRentabLinea
**Tipo**: Actualizar
**Módulo**: General
...
```sql
/**************************************************************************************************************
NOMBRE: pActualizarComisionRentabLinea
DESCRIPCION: 
CREADO POR: SOFTECH SISTEMAS
***************************************************************************************************************/
CREATE PROCEDURE [pActualizarComisionRentabLinea]
    (
      @sCo_Comir CHAR(6) ,
      @sCo_ComirOri CHAR(6) ,
...
AS 
    BEGIN
        ...
        UPDATE
            dbo.saComisionRentabLinea
        SET co_comir = @sCo_Comir, des_comir = @sDes_Comir, tipo_ven = @sTipo_Ven, aplica_en = @sAplica_En, 
            co_lin = @sCo_Lin, hasta1 = @deHasta1, hasta2 = @deHasta2, hasta3 = @deHasta3, hasta4 = @deHasta4, 
