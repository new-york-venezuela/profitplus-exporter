# SP: pInsertarRenglonesCotizacionCliente
**Tipo**: Insertar
**Módulo**: Ventas
...
```sql
/**************************************************************************************************************
NOMBRE		: pInsertarRenglonesCotizacionCliente
DESCRIPCION	: Inserta un registro de la tabla saFacuraVentaReng
CREADO POR	: SOFTECH SISTEMAS
***************************************************************************************************************/
CREATE PROCEDURE [pInsertarRenglonesCotizacionCliente]
    (
      @iReng_Num INT ,
      @sDoc_Num CHAR(20) ,
      @sCo_Art CHAR(30) ,
...
AS 
    BEGIN
        ...
        INSERT  INTO saCotizacionClienteReng
                ( reng_num, doc_num, co_art, des_art
```
