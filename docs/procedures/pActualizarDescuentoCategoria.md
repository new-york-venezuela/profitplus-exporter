# SP: pActualizarDescuentoCategoria
**Tipo**: Actualizar
**Módulo**: General
...
***************************************************************************************************************/
CREATE PROCEDURE [dbo].[pActualizarDescuentoCategoria]
    (
...
AS 
    BEGIN
        ...
        UPDATE
            saDescCategoria
        SET co_cat = @sCo_Cat, des_des = @sDes_Des, tip_cli = @sTip_Cli, hasta1 = @deHasta1, hasta2 = @deHasta2,
            ...
            campo8 = @sCampo8, co_us_mo = @sCo_Us_Mo, co_suc
```
