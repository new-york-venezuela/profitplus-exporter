...
**************************************************************************/
CREATE PROCEDURE [dbo].[pActualizarAreaImpresion]
	(
      @sCo_Area_Imp CHAR(3) ,
...
AS 
    BEGIN	
        ...
        UPDATE
            saAreaImpresion
        SET co_area_imp = @sCo_Area_Imp, des_area_imp = @sDes_Area_Imp, campo1 = @sCampo1,
		...
		-- Insertar Pista
                EXEC [pInsertarPista] @sUsuario_Id = @sCo_Us_Mo, @dtFecha = @dtFe_In, @sCo_Sucu = @sCo_Sucu_Mo,
                    @sTablaOri = 'saAreaImpresion', @rowguidOri = @rowGuidOri, @sTipo_Op = 'M', @sMaquina = @sMaquina,
                    @sCampos = @sCampos
            END
