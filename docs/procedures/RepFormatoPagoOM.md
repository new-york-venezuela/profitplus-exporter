...
-- Description:	<Reporte de Formato de Pago OM>
-- =============================================
CREATE PROCEDURE [dbo].[RepFormatoPagoOM]
    ...
    BEGIN
        ...
        FROM
            ( SELECT
              ...
              FROM
                saPago AS Pa
                INNER JOIN sapagodocreng AS PR ON PR.cob_num = Pa.cob_num
                                                  AND Pa.anulado = 0
                INNER JOIN saTipoDocumento AS TP ON TP.co_tipo_doc = PR.co_tipo_doc
                INNER JOIN saProveedor AS P ON P.co_prov = Pa.co_prov
				INNER JOIN saDocumentoCompra DC ON DC.nro_doc = PR.nro_doc AND DC.co_tipo_doc = PR.co_tipo_doc
              WHERE
              ...
              SELECT
                ...
                PT.mont_doc / Pa.tasa AS mont_doc, CASE WHEN PT.forma_pag = 'CH'
```
