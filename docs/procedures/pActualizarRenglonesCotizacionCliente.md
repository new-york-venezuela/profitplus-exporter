# SP: pActualizarRenglonesCotizacionCliente
**Tipo**: Actualizar
**Módulo**: Ventas
...
DESCRIPCION	: Actualiza un registro de la tabla saCotizacionClienteReng
CREADO POR	: SOFTECH SISTEMAS
***************************************************************************************************************/
CREATE PROCEDURE [pActualizarRenglonesCotizacionCliente]
    (
      @iReng_Num INT ,
      @sDoc_Num CHAR(20) ,
      @iReng_NumOri INT ,
