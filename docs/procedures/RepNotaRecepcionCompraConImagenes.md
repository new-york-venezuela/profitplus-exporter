# SP: RepNotaRecepcionCompraConImagenes
**Tipo**: Reporte
**Módulo**: Compras
...
-- Description:	<Reporte de Notas de Recepcion de Compra con sus Renglones e Imágenes>
-- =============================================
CREATE PROCEDURE [dbo].[RepNotaRecepcionCompraConImagenes]
...
-------------------------------
        ...
        SELECT
            @cAnulado AS Filtro_anulado, 'nota_recep' AS tip_rep, 
