...
-- Description:	<Reporte de Factura de Compras por Artículos>
-- =============================================
CREATE PROCEDURE [dbo].[RepCompraxArt]
...
-------------------------------
		...
		/*Campos saFacturaVenta*/ FC.doc_num, FC.nro_fact, FC.descrip, FC.co_prov, FC.co_mone, FC.co_cond,
			...
			FC.monto_desc_glob, FC.monto_reca, FC.otros1, FC.otros2, FC.otros3,
            FC.monto_imp, FC.monto_imp2, FC.monto_imp3, FC.anulado, FC.impresa, FC.seriales_e, FC.salestax, FC.dis_cen,
            FC.feccom, FC.numcom, FC.dir_ent, FC.
```
