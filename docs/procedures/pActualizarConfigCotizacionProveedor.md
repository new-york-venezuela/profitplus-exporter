# SP: pActualizarConfigCotizacionProveedor
**Tipo**: Actualizar
**Módulo**: Clientes
...
```sql
/**************************************************************************
*NOMBRE			: pActualizarConfigCotizacionProveedor
*DESCRIPCIÓN	: Actualiza la configuracion del proceso Cotizacion Proveedor
*AUTOR			: SOFTECH SISTEMAS
**************************************************************************/

CREATE PROCEDURE [pActualizarConfigCotizacionProveedor]
    (
      @sCo_Config CHAR(6) ,
