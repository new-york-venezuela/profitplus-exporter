# SP: pValidarCotizacionClienteRengCalculos
**Tipo**: Validar
**Módulo**: Ventas
...
-- Description:	Validar Consistencia en los renglones de Cotización a Cliente
-- =============================================
CREATE PROCEDURE [dbo].[pValidarCotizacionClienteRengCalculos]
    (
                    ...
                    BEGIN
                        ...
                        FOR
                            ...
                            FROM
                                ...
                                INNER JOIN saCotizacionCliente E ON E.doc_num = R.doc_num
```
