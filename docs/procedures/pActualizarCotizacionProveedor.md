# SP: pActualizarCotizacionProveedor
**Tipo**: Actualizar
**Módulo**: Compras
...
*NOMBRE			:	pActualizarCotizacionProveedorN
*DESCRIPCIÓN	:	Actualiza una Cotizacion de compra
*AUTOR			:	Softech
**************************************************************************/

CREATE PROCEDURE [dbo].[pActualizarCotizacionProveedor]
    (
      @sDoc_Num CHAR(20) ,
      @sDoc_NumOri CHAR(20) ,
      @sNro_Fact CHAR(20) ,
...
AS 
    BEGIN	
        ...
        SET doc_num = @sDoc_Num, nro_fact = @sNro_Fact, descrip = @sDescrip, co_prov = @sCo_Prov, co_mone = @sC
```
