...
```sql
/************************************************************************
*NOMBRE			:pInsertarConfigOrdenCompra
*DESCRIPCIÓN	: Inserta una Configuración en la tabla saConfigOrdenCompra
*AUTOR			: SOFTECH SISTEMAS
*************************************************************************/

CREATE PROCEDURE [pInsertarConfigOrdenCompra]
    (
      @sCo_Config CHAR(6) ,
...
AS 
    BEGIN
        ...
        INSERT  INTO saConfigOrdenCompra
        ...
        EXEC [pInsertarPista] @sUsuario_Id = @sCo_Us_In, @dtFecha = @dtFe_In, @sCo_Sucu = @sCo_Sucu_in,
            @sTablaOri = 'saConfigOrdenCompra', @rowguidOri = @rowGuidOri, @sTipo_Op = 'I', @sMaqui
```
