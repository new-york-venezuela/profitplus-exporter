# SP: pActualizarContabilizacionChequeDevueltoVenta
**Tipo**: Actualizar
**Módulo**: Ventas
...
```sql
/*************************************************************************************************
NOMBRE:	pActualizarContabilizacionChequeDevueltoVenta
DESCRIPCION:Actualizar las contabilizaciones de Cheque Devuelto en Venta
CREADO POR: SOFTECH SISTEMAS
CREADO EL: 20/04/2011
**************************************************************************************************/
CREATE PROCEDURE [pActualizarContabilizacionChequeDevueltoVenta]
    (
      @sCo_Doc CHAR(20) ,
      @sCo_Tipo_Doc CHAR (6),
