...
-- Description:	<Reporte de Devoluciones a Clientes por Número>
-- =============================================
CREATE PROCEDURE [RepDevolucionClientexNum] 
...
-------------------------------
        SELECT
            @cAnulado AS Filtro_anulado, 'DEVO' AS tipo_rep, CLI.tip_cli, CLI.cli_des, CLI.co_zon,
