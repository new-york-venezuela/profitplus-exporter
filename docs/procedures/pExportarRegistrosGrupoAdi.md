...
```sql
/**************************************************************************
*NOMBRE			:	pExportarRegistrosGrupoAdi
*DESCRIPCIÓN	:	Inserta un concepto de grupo adicional
*AUTOR			:	SOFTECH SISTEMAS
***************************************************************************/

CREATE PROCEDURE [dbo].[pExportarRegistrosGrupoAdi]
    (
      @sCo_AdiGrupo			CHAR(8) ,
...
AS 
    BEGIN
		...
		SET @sSql = N'EXEC [' + @sempresa + '].[dbo].[pInsertarAdiGrupo]@sCo_AdiGrupo,
																		@sDes_AdiGrupo,
		...
		EXEC sp_executesql @sSql, N'@sCo_AdiGrupo CHAR(8),		@sDes_AdiGrupo VARCHAR(60),	
