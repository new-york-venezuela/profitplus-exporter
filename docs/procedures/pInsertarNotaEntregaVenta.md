...
```sql
/************************************************************************
*NOMBRE			: pInsertarNotaEntregaVenta
*DESCRIPCIÓN	: Inserta una nota de Entrega de venta
*CREATE DATE    : 2011-12-12
*LASTUPDATE DATE: 2020-07-27
*AUTOR			: SOFTECH SISTEMAS
*************************************************************************/

CREATE PROCEDURE [dbo].[pInsertarNotaEntregaVenta]
    (
      @sDoc_Num CHAR(20) ,
      @sDescrip VARCHAR(60) ,
      @sCo_Cli CHAR(16) ,
...
AS 
    BEGIN
        ...
        INSERT  INTO saNotaEntregaVenta
                ( doc_num, descrip, co_cli, co_tra
```
