# SP: pSeleccionarContabilizacionPagoFormaPago
**Tipo**: Seleccionar
**Módulo**: Tesorería
...
-- Description:	<pSeleccionarContabilizacionPagoFormaPago>
-- =============================================
CREATE PROCEDURE [dbo].[pSeleccionarContabilizacionPagoFormaPago]
    (
