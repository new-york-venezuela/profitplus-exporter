# SP: pActualizarContabilizacionNotaCreditoVenta
**Tipo**: Actualizar
**Módulo**: Ventas
...
```sql
/*************************************************************************************************
NOMBRE:	pActualizarContabilizacionNotaCreditoVenta
DESCRIPCION:Actualizar las contabilizaciones de Nota de Credito en Venta
CREADO POR: SOFTECH SISTEMAS
CREADO EL: 18/04/2011
**************************************************************************************************/
CREATE PROCEDURE [pActualizarContabilizacionNotaCreditoVenta]
    (
      @sCo_Doc CHAR(20) ,
      @sCo_Tipo_Doc CHAR(6),
