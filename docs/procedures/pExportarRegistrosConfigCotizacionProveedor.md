# SP: pExportarRegistrosConfigCotizacionProveedor
**Tipo**: Procedimiento
**Módulo**: Clientes
...
```sql
/**************************************************************************
*NOMBRE			:	pExportarRegistrosConfigCotizacionProveedor
*DESCRIPCIÓN	:	Inserta una Configuración en la tabla saConfigCotizacionProveedor
*AUTOR			:	SOFTECH SISTEMAS
***************************************************************************/
CREATE PROCEDURE [dbo].[pExportarRegistrosConfigCotizacionProveedor]
    (
      @sCo_Config CHAR(6) ,
...
AS 
    BEGIN
		...
		SET @sSql = N'EXEC [' + @sempresa + '].[dbo].[pInsertarConfigCotizacionProveedor]	
																		@sCo_Config,
																		@sDes_Config,
																		@sCo_Usuario,
																		@sCo_Mapa,
