# SP: pSeleccionarContabilizacionAjustePositivoVentaRenglon
**Tipo**: Seleccionar
**Módulo**: Inventario
...
```sql
/**************************************************************************************************************
NOMBRE		pSeleccionarContabilizacionAjustePositivoVentaRenglon
DESCRIPCION	:Selecciona los documentos de ajuste positivo en ventas por renglon no contabilizados
CREADO POR	:SOFTECH SISTEMAS
CREADO EL	:2019/11/26
***************************************************************************************************************/
CREATE PROCEDURE [dbo].[pSeleccionarContabilizacionAjustePositivoVentaRenglon]
    (
