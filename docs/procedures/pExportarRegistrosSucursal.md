...
```sql
/**************************************************************************
*NOMBRE			:	pExportarRegistrosSucursal
*DESCRIPCIÓN	:	Inserta un concepto de sucursal
*AUTOR			:	SOFTECH SISTEMAS
***************************************************************************/

CREATE PROCEDURE [dbo].[pExportarRegistrosSucursal]
    (
      @sCo_Sucur			CHAR(6) ,
...
AS 
    BEGIN
		...
		SET @sSql = N'EXEC [' + @sempresa + '].[dbo].[pInsertarSucursal]@sCo_Sucur,
																		@sSucur_Des,
		...
		EXEC sp_executesql @sSql, N'@sCo_Sucur CHAR(6),			@sSucur_Des VARCHAR(60),
