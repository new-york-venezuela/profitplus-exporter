...
-- Description:	<Información Contable Pedido de Venta>
-- =============================================
CREATE PROCEDURE [dbo].[RepInfContablePedidoVenta]
...
BEGIN
 ...
 (Select A.doc_num, PED.fec_emis, PED.co_cli, (select cli_des from saCliente where co_cli = PED.co_cli) as cli_des, PED.co_ven, 
  PED.feccom, PED.numcom, A.num_carp, A.Descripcion, case when ltrim(A.monto) = '' then 0 else cast(A.monto as decimal(18,5)) end as monto, 
 ...
 Select	A.doc_num, A.feccom, '01' as num_carp,
		...
		(select des_cen from scCentro where co_cen=C.N.value
```
