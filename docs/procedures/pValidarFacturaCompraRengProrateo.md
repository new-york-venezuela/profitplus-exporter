# SP: pValidarFacturaCompraRengProrateo
**Tipo**: Validar
**Módulo**: Compras
...
## Código (excerpt)
```sql
CREATE PROCEDURE [dbo].[pValidarFacturaCompraRengProrateo]
    (
                    ...
                    BEGIN
                        ...
                        FOR
                            ...
                            FROM
								...
								left join saDocumentoCompra dv on dv.nro_doc = e.doc_num and dv.co_tipo_doc='FACT' --DN 060522
		                         left join saDocumentoCompraInfoIGTF dvig on dvig.rowguid = dv.rowguid --DN 060522
                            WHERE
