...
```sql
/**************************************************************************
*NOMBRE			: pActualizarTipoImagen
*DESCRIPCIÓN	: Actualiza un Tipo Imagen
*AUTOR			: SOFTECH SISTEMAS
**************************************************************************/

CREATE PROCEDURE [dbo].[pActualizarTipoImagen]
    (
...
AS 
    BEGIN	
        ...
        UPDATE
            saTipoImagen
        SET co_tipo_imag = @sCo_Tipo_Imag, descrip = @sDescrip, campo_adic = @sCampo_Adic, campo1 = @sCampo1,
		...
		-- Insertar Pista
                EXEC [pInsertarPista] @sUsuario_Id = @sCo_Us_Mo, @dtFecha = @dtFe_In, @sCo_Sucu = @sCo_Sucu_Mo,
                    @sTablaOri = 'saTipoImagen', @rowguidOri = @rowGuidOri, @sTipo_Op = 'M', @sMaquina = @sMaquina,
                    @sCampos = @sCampo
```
