# SP: RepInfContableFacturaCompra
**Tipo**: Reporte
**Módulo**: Compras
...
-- Description:	<Información Contable Factura de Compra>
-- =============================================
CREATE PROCEDURE [dbo].[RepInfContableFacturaCompra]
...
BEGIN
  ...
  (Select A.doc_num, COM.fec_emis, COM.co_prov, (select prov_des from saProveedor where co_prov = COM.co_prov) as prov_des, COM.feccom, 
  COM.numcom, A.num_carp, A.Descripcion, case when ltrim(A.monto) = '' then 0 else cast(A.monto as decimal(18,5)) end as monto, 
