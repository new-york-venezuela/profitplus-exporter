# SP: pEliminarChequeDevueltoVenta
**Tipo**: Eliminar
**Módulo**: Tesorería
...
```sql
/**************************************************************************
*NOMBRE			:	pEliminarChequeDevueltoVenta
*DESCRIPCIÓN	:	Elimina un cheque devuelto
*AUTOR			:	SOFTECH SISTEMAS
***************************************************************************/

CREATE PROCEDURE [pEliminarChequeDevueltoVenta]
    (
        ...
        IF @dtFe_De IS NOT NULL 
			...
			-- Insertar Pista
                EXEC [pInsertarPista] @sUsuario_Id = @sCo_Us_Mo, @dtFecha = @dtFe_De, @sCo_Sucu = @sCo_Sucu_Mo,
                    @sTablaOri = 'saChequeDevueltoVenta', @rowguidOri = @rowGuidOri, @sTipo_Op = 'E',
                    @sMaq
```
