# SP: pExportarRegistrosConfigProveedor
**Tipo**: Procedimiento
**Módulo**: Clientes
...
```sql
/**************************************************************************
*NOMBRE			:	pExportarRegistrosConfigProveedor
*DESCRIPCIÓN	:	Inserta una Configuración en la tabla saConfigProveedor
*AUTOR			:	SOFTECH SISTEMAS
***************************************************************************/
CREATE PROCEDURE [dbo].[pExportarRegistrosConfigProveedor]
    (
      @sCo_Config CHAR(6) ,
...
AS 
    BEGIN
		...
		SET @sSql = N'EXEC [' + @sempresa + '].[dbo].[pInsertarConfigProveedor]	
																		@sCo_Config,
																		@sDes_Config,
																		@sCo_Usuario,
																		@sCo_Mapa,
