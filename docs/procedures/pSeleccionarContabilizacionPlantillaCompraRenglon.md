# SP: pSeleccionarContabilizacionPlantillaCompraRenglon
**Tipo**: Seleccionar
**Módulo**: Inventario
...
-- Description:	<pSeleccionarContabilizacionPlantillaCompraRenglon>
-- =============================================
CREATE PROCEDURE [dbo].[pSeleccionarContabilizacionPlantillaCompraRenglon]
    (
...
AS 
    BEGIN
        ...
        SELECT     FV.doc_num AS Co_Doc_Padre, FVR.reng_num AS Co_Doc, FV.fec_emis, MO.relacion AS mone_relacion, CL.co_prov AS Co_Auxiliar, CL.prov_des AS Descrip_Auxiliar, 
                      ...
                      FVR.dis_cen AS dis_cen_saPlantillaCompraRenglon, FVR.co_us_in, FVR.co_sucu_in, FVR.fe_us_in, FVR.co_us_mo, FVR.co_sucu_mo, FVR.fe_us_mo, FVR.revisado, 
                      ...
                      CL.co_prov AS Co_proveedor, FV.tasa, ca.dis_cen AS dis_cen_saCatArticulo, li.dis_cen AS dis_cen_saLineaArticulo
		FROM         dbo.saPlantillaCompraReng AS FVR INNER JOIN
                      dbo.saPlantillaCompra AS FV ON FVR.doc_num = FV.doc_num INNER JOIN
