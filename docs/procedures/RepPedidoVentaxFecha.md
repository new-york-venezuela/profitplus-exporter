...
-- Description:	<Reporte de Pedidos de Ventas por Fecha>
-- =============================================
CREATE PROCEDURE [RepPedidoVentaxFecha] 
...
-------------------------------
        SELECT
            @cAnulado AS Filtro_anulado, @cImprSubTotal AS SubTotales, 'PED' AS tipo_rep, CLI.tip_cli, CLI.cli_des,
