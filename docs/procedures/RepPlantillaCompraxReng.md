...
-- Description:	<Reporte de Plantillas de Compra con sus Renglones>
-- =============================================
CREATE PROCEDURE [dbo].[RepPlantillaCompraxReng]
...
-------------------------------
        ...
        SELECT
            ...
            FVR.tipo_doc, FVR.porc_desc, FVR.nu
```
