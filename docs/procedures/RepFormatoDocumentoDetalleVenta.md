# SP: RepFormatoDocumentoDetalleVenta
**Tipo**: Reporte
**Módulo**: Clientes
...
CREATE PROCEDURE [RepFormatoDocumentoDetalleVenta] 
...
AS 
    ...
    -- Insert statements for procedure here
        ...
        SELECT
            ...
            DV.monto_reca, DV.porc_reca, ( DV.otros1 + DV.otros2 + DV.otros3 ) AS otros, DVR.co_art, DVR.total_art,
            DVR.co_uni, DVR.prec_vta, ( CASE WHEN DVR.porc_desc IS NULL THEN 0.00
