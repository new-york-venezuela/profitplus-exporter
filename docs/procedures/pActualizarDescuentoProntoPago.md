# SP: pActualizarDescuentoProntoPago
**Tipo**: Actualizar
**Módulo**: Tesorería
...
```sql
/**************************************************************************************************************
NOMBRE: pActualizarTablaDppago
DESCRIPCION: Actualiza Tabla Dppago
CREADO POR: SOFTECH SISTEMAS
***************************************************************************************************************/
CREATE PROCEDURE [pActualizarDescuentoProntoPago]
    (
      @sCo_Desc CHAR(6) ,
      @sCo_DescOri CHAR(6) ,
      @sTip_Cli CHAR(6) ,
...
AS 
    BEGIN  
        ...
        UPDATE
            saDescProntoPago
        SET co_desc = @sCo_Desc, tip_cli = @sTip_Cli, des_des = @sDes_Des, hasta1 = @deHasta1, hasta2 = @deHasta2,
