...
```sql
/**************************************************************************
*NOMBRE			: ActualizarConfigProveedor
*DESCRIPCIÓN	: Actualiza la configuracion del proceso Proveedor
*AUTOR			: SOFTECH SISTEMAS.
**************************************************************************/

CREATE PROCEDURE [pActualizarConfigProveedor]
    (
      @sCo_Config CHAR(6) ,
