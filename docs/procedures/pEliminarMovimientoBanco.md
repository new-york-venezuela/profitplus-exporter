...
```sql
/*************************************************************************************************
*NOMBRE			:	pEliminarMovimientoBanco
*DESCRIPCION	:	Elimina un registro de la tabla  saMovimientoBanco
*CREADO			:	SOFTECH SISTEMAS
**************************************************************************************************/
CREATE PROCEDURE [pEliminarMovimientoBanco]
    (
      @sMov_NumOri CHAR(20) ,
        ...
        IF @dtFe_De IS NOT NULL 
			...
			-- Insertar Pista
                EXEC [pInsertarPista] @sUsuario_Id = @sCo_Us_Mo, @dtFecha = @dtFe_De, @sCo_Sucu = @sCo_Sucu_Mo,
                    @sTablaOri = 'saMovimientoBanco', @rowguidOri = @rowGuidOri, @sT
```
