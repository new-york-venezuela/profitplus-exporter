...
CREATE PROCEDURE [dbo].[pExportarRegistrosPais]
    (
      @sCo_Pais				CHAR(6) ,
...
AS 
    BEGIN
		...
		SET @sSql = N'EXEC [' + @sempresa + '].[dbo].[pInsertarPais]	@sCo_Pais,
																		@sPais_Des,
																		@sCo_Mone,
		...
		EXEC sp_executesql @sSql, N'@sCo_Pais CHAR(6) ,			@sPais_Des VARCHAR(60),		@sCo_Mone CHAR(6) ,
