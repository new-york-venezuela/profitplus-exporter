# SP: pSeleccionarContabilizacionCobroFormaPago
**Tipo**: Seleccionar
**Módulo**: Tesorería
...
-- Description:	<pSeleccionarContabilizacionCobroFormaPago>
-- =============================================
CREATE PROCEDURE [dbo].[pSeleccionarContabilizacionCobroFormaPago]
    (
...
AS 
	 ...
	 * NOTA 8: Se debe  colocar el rowguid del renglon y n
```
