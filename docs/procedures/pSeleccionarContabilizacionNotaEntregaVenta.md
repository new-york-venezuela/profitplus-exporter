# SP: pSeleccionarContabilizacionNotaEntregaVenta
**Tipo**: Seleccionar
**Módulo**: Clientes
...
## Código (excerpt)
```sql
CREATE PROCEDURE [dbo].[pSeleccionarContabilizacionNotaEntregaVenta]
    (
...
AS 
	 ...
	 */
        ...
        SELECT
            FV.doc_num AS Co_Doc, FV.Fec_Emis, FV.co_sucu_in AS Co_Sucu_Cont, CL.co_cli AS Co_Auxiliar, CL.cli_des AS
```
