...
```sql
/**************************************************************************************************************
NOMBRE		: pEliminarDocumentoCompra
DESCRIPCION	: Elimina un registro de la tabla saDocumentoCompra
CREADO POR	: SOFTECH SISTEMAS
***************************************************************************************************************/
CREATE PROCEDURE [pEliminarDocumentoCompra]
    (
...
AS 
    BEGIN
		...
		--Eliminar InfoNCFDocCompra
		IF @sNro_DocOri IS NOT NULL AND EXISTS (SELECT nro_doc from saNCFInfoDocCompra  where nro_doc  = @sNro_DocOri and tipo_doc = @sC
```
