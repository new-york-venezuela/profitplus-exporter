# SP: pActualizarContabilizacionNotaDebitoVenta
**Tipo**: Actualizar
**Módulo**: Ventas
...
```sql
/*************************************************************************************************
NOMBRE:	pActualizarContabilizacionNotaDebitoVenta
DESCRIPCION:Actualizar las contabilizaciones de Nota de Debito en Venta
CREADO POR: SOFTECH SISTEMAS
CREADO EL: 14/04/2011
**************************************************************************************************/
CREATE PROCEDURE [pActualizarContabilizacionNotaDebitoVenta]
    (
      @sCo_Doc CHAR(20) ,
      @sCo_Tipo_Doc CHAR (6),
