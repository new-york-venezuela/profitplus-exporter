# SP: pExportarRegistrosConfigOrdenCompra
**Tipo**: Procedimiento
**Módulo**: Compras
...
```sql
/**************************************************************************
*NOMBRE			:	pExportarRegistrosConfigOrdenCompra
*DESCRIPCIÓN	:	Inserta una Configuración en la tabla saConfigOrdenCompra
*AUTOR			:	SOFTECH SISTEMAS
***************************************************************************/
CREATE PROCEDURE [dbo].[pExportarRegistrosConfigOrdenCompra]
    (
      @sCo_Config CHAR(6) ,
...
AS 
    BEGIN
		...
		SET @sSql = N'EXEC [' + @sempresa + '].[dbo].[pInsertarConfigOrdenCompra]	
																		@sCo_Config,
																		@sDes_Config,
																		@sCo_Usuario,
																		@sCo_Mapa,
