...
-- Description:	<Reporte de Plantillas de Ventas por Vendedor>
-- =============================================
CREATE PROCEDURE [RepPlantillaVentaxVendedor] 
...
-------------------------------
        SELECT
            @cAnulado AS Filtro_anulado, 'PLANTI' AS tipo_rep, CLI.tip_cli, CLI.cli_des, CLI.co_zon, VE.ven_des,
