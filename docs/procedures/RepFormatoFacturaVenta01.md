...
-- Description:	<Reporte de Formato de Factura de Ventas>
-- =============================================
CREATE PROCEDURE [dbo].[RepFormatoFacturaVenta01] 
...
AS 
    ...
    -- Insert statements for procedure here
		...
		/*Campos saFacturaVentaReng*/ FVR.reng_num, FVR.doc_num, FVR.co_art, ISNULL(FVR.des_art,ART.art_des) AS des_art, FVR.co_alma, FVR.total_art,
            ...
            FVR.num_doc, FVR.rowguid_doc, FVR.total_dev, FVR.monto_dev, FVR.otros, FVR.comentario, FVR.l
```
