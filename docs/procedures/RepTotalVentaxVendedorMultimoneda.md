# SP: RepTotalVentaxVendedorMultimoneda
**Tipo**: Reporte
**Módulo**: Ventas
...
-- =============================================
CREATE PROCEDURE [dbo].[RepTotalVentaxVendedorMultimoneda]
...
select fact.fec_emis,       Sum(fact.total_neto) as total_neto,
					        ...
					        sum( round((fact.TotalFactura -  fact.TotalDev) /   fact.tasa ,2))as NetoOM, @cCo_Moneda_Rep as co_mone_rep , @MonedaBase as MonedaBase, fact.co_ven,fact.ven_des
