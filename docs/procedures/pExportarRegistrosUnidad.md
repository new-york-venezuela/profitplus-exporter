...
CREATE PROCEDURE [dbo].[pExportarRegistrosUnidad]
    (
      @sCo_Uni				CHAR(6) ,
      @sDes_Uni				VARCHAR(60) ,
...
AS 
    BEGIN
		...
		SET @sSql = N'EXEC [' + @sempresa + '].[dbo].[pInsertarUnidad]	@sCo_Uni,
																		@sDes_Uni,
		...
		EXEC sp_executesql @sSql, N'@sCo_Uni CHAR(6),			@sDes_Uni VARCHAR(60),
