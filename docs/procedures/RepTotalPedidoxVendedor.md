...
-- Description:	<Reporte de Total de Pedidos por Vendedor>
-- =============================================
CREATE PROCEDURE [RepTotalPedidoxVendedor]
...
AS 
    BEGIN
        ...
        SELECT
            ...
            PV.validador, PV.rowguid, V.ven_des, PVR.total_art, PVR.coti, PVR.monto_desc,
