# SP: RepFormatoDevolucionClienteIGTF
**Tipo**: Reporte
**Módulo**: Ventas
...
DESCRIPCION:	OBTIENE LAS DEVOLUCIONES CON IGTF
CREADO POR:		SOFTECH SISTEMAS
CREATE DATE:    2022-05-03
***************************************************************************************************************/
CREATE PROCEDURE [dbo].[RepFormatoDevolucionClienteIGTF] 
...
AS 
    ...
    -- Insert statements for procedure here
		...
		/*Campos saFacturaVentaReng*/ FVR.reng_num, FVR.doc_num, FVR.co_art, ISNULL(FVR.des_art, ART.art_des) as des_art, FVR.co_alma, FVR.total_art,
            ...
            FVR.monto_desc, FVR.tipo_imp, FVR.tipo_imp2, FVR.tipo_imp3, FVR.porc_imp, FVR.porc_imp2, FVR.porc
```
