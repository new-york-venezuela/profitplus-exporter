# SP: RepNotaDespachoVentaxVendedor
**Tipo**: Reporte
**Módulo**: Clientes
...
-- Description:	<Reporte de Notas de Despacho de Ventas por Vendedor>
-- =============================================
CREATE PROCEDURE [dbo].[RepNotaDespachoVentaxVendedor] 
...
-------------------------------
        SELECT
            @cAnulado AS Filtro_anulado, 'NOTA_DES' AS tipo_rep, CLI.tip_cli, CLI.cli_des, CLI.co_zon, VE.ven_des,
		/*Campos saFacturaVenta*/ FV.doc_num, FV.descrip, FV.co_cli, FV.co_mone, FV.co_ven, FV.co_cond,
            ...
            END ) AS saldo, 
			FV.dir_ent,
            FV.comentario, FV.dis_cen, FV.feccom, FV.numcom, FV.contrib, FV.impresa, FV.
```
