...
/*=============================================
 ...
 Description:	<Comision por Viveles de Precio por Articulo>
 =============================================*/
CREATE PROCEDURE [RepComisionPrecioXArticulo]
...
AS 
    BEGIN
        ...
        SELECT
            'art' AS tipo, ART.art_des, C.co_art, C.tipo_ven, 
            (CASE WHEN C.aplica_en = 'C' THEN 'COBROS' ELSE 'VENTAS' END) AS aplica_en,
        ...
        FROM
            saArticulo AS ART
            INNER JOIN saComisionPrecioArticulo AS C ON C.co_art = ART.co_art
