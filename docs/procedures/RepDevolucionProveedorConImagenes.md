# SP: RepDevolucionProveedorConImagenes
**Tipo**: Reporte
**Módulo**: Compras
...
-- Description:	<Reporte de Devolucion de Proveedores con sus Renglones e Imagenes>
-- =============================================
CREATE PROCEDURE [dbo].[RepDevolucionProveedorConImagenes]
...
AS 
    BEGIN
        ...
        SELECT
            @cAnulado AS Filtro_anulado, 'devo' AS tip_rep,
            P.prov_des, CP.cond_des, FC.doc_num, P.co_prov, FC.fec_emis, FC.fec_venc, FC.fec_reg, FC.rowguid, 
			  DI.co_imag, DI.des_imag, DI.picture, TI.co_tipo_imag, TI.descrip as descripImagen, P.co_zon, FC.co_mone, FC.co_mone, FC.co_cond
        FROM
            saDevolucionProveedor AS FC
