# SP: pActualizarRenglonesDocPago
**Tipo**: Actualizar
**Módulo**: Compras
...
```sql
/*********************************************************************
*NOMBRE			:	pActualizarRenglonesDocPago
*DESCRIPCIÓN	:	Modifica un registro en la tabla  saPagoDocReng
*CREADO			:	<2011-12-12>
*MODIFICADO		:	<2021-01-27>
*AUTOR			:	SOFTECH SISTEMAS
*******************************************************************/
CREATE PROCEDURE [dbo].[pActualizarRenglonesDocPago]
    (
      @iReng_Num INT ,
      @sCob_Num CHAR(20) ,
      @iRENG_NUMOri INT ,
      ...
      @deDppago_Porc_Desc DECIMAL(18, 8) ,
