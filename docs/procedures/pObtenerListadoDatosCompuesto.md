# SP: pObtenerListadoDatosCompuesto
**Tipo**: Obtener
**Módulo**: Inventario
    ...
    BEGIN	
		...
		ELSE 
          ...
          SET @SqlString = N'USE ' + CONVERT(NVARCHAR(100), @sDataBase_Name) + ' SELECT TOP(500) *    
					   FROM ' + CONVERT(NVARCHAR(100), 'saArtCompuesto') + ' WHERE '
