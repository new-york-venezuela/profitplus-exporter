# SP: pEliminarDescuentoCategoria
**Tipo**: Eliminar
**Módulo**: General
...
CREATE PROCEDURE [pEliminarDescuentoCategoria]
    (
      @sCo_DescOri CHAR(6) ,
    ...
    BEGIN
		...
		-- Insertar Pista
                EXEC [pInsertarPista] @sUsuario_Id = @sCo_Us_Mo, @dtFecha = @dtFe_De, @sCo_Sucu = @sCo_Sucu_Mo,
                    @sTablaOri = 'saDescCategoria', @rowguidOri = @rowGuidOri, @sTipo_Op = 'E', @sMaquina = @sMaquina,
                    @sCampos = @sCo_DescOri			
            END
