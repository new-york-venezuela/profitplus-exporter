# SP: pValidarDevolucionProveedorRengProrateo
**Tipo**: Validar
**Módulo**: Compras
...
## Código (excerpt)
```sql
CREATE PROCEDURE [dbo].[pValidarDevolucionProveedorRengProrateo]
    (
                    ...
                    BEGIN
                        ...
                        FOR
                            ...
                            FROM
								...
								left join saDocumentoCompra dv on dv.nro_doc = e.nro_doc and dv.co_tipo_doc='N/CR' --DN 130522
								left join saDocumentoCompraInfoIGTF dvig on dvig.rowguid = dv.rowguid --DN 130522
                            WHERE
                                --R.otros1_glob <> ROUND(( E.otros1 * R.reng_neto ) / E.total_bruto, 5)--DN 130522
```
