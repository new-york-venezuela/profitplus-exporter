...
-- Description:	<Reporte de Formato de Pago>
-- =============================================
CREATE PROCEDURE [dbo].[RepFormatoPago]
    ...
    BEGIN
        ...
        FROM
            ( SELECT
                ...
                ISNULL(PR.nro_fact, '') AS nro_fact, PR.mont_cob, '' AS forma_pag, '' AS num_doc, '' AS num_cta,
                '' AS fecha_che, DC.total_neto AS mont_doc, 
				'' AS codigo, '' AS descripcion, '' AS co_ban, '' AS des_ban,
                TP.tipo_mov
              FROM
                saPago AS Pa
              ...
              SELECT
                ...
                PT.mont_doc, CASE WHEN PT.forma_pag = 'CH'
                                       OR PT.forma_pag = 'TR' THEN C.cod_cta
                                  ELSE C
```
