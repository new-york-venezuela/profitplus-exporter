...
/*=============================================
 ...
 Description:	<Conpuesto Generado por Artículos>
 =============================================*/
CREATE PROCEDURE [RepCompuestoGenxArt]
	-- Add the parameters for the stored procedure here
    @sCo_ArtComGen_d CHAR(30) = NULL ,
    @sCo_ArtComGen_h CHAR(30) = NULL ,
...
-------------------------------
        ...
        SELECT
            ARTC.co_art AS Compuesto, ARTC.descrip AS Descri_comp, ARTE.modelo AS Modelo_art,
            ARTE.art_des AS Artículo_des, ARTC.co_uni, A.*
        FROM
