# SP: pActualizarComisionRentabArticulo
**Tipo**: Actualizar
**Módulo**: Inventario
...
```sql
/**************************************************************************************************************
NOMBRE: pActualizarComisionRentabArticulo
DESCRIPCION: 
CREADO POR: SOFTECH SISTEMAS
***************************************************************************************************************/
CREATE PROCEDURE [pActualizarComisionRentabArticulo]
    (
      @sCo_Comir CHAR(6) ,
      @sCo_ComirOri CHAR(6) ,
...
AS 
    BEGIN
        ...
        SET 
            co_comir = @sCo_Comir, des_comir = @sDes_Comir, tipo_ven = @sTipo_Ven, aplica_en = @sAplica_En, 
            co_art = @sCo_Art, hasta1 = @deHasta1, hasta2 = @deHasta2, hasta3 = @deHasta3, hasta4 = @deHasta4, 
