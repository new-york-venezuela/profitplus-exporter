# SP: pActualizarDocumentoVentaInfoIGTF
**Tipo**: Actualizar
**Módulo**: Ventas
...
**************************************************************************/ 
CREATE PROCEDURE [dbo].[pActualizarDocumentoVentaInfoIGTF]
    (
      @sCo_Tipo_Doc CHAR(6) ,
      @sNro_Doc CHAR(20) ,
...
AS 
    BEGIN
     ...
     DECLARE @rowGuidOri UNIQUEIDENTIFIER
        ...
        update saDocumentoVentaInfoIGTF
        ...
        --EXEC [pInsertarPista] @sUsuario_Id = @sCo_Us_In, @dtFecha = @dtFe_In, @sCo_Sucu = @sCo_Sucu_in,
         --   @sTablaOri = 'saDocumentoVentaInfoIGTF', @rowguidOri = @rowGuidOri, @sTipo_Op = 'I', @sMaquina = @sMaquina,
          --  @sCampos = @sNro_Doc
