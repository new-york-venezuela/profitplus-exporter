# SP: RepDevolucionClientexVendedor
**Tipo**: Reporte
**Módulo**: Clientes
...
-- Description:	<Reporte de Devoluciones a Clientes por Vendedor>
-- =============================================
CREATE PROCEDURE [RepDevolucionClientexVendedor] 
...
-------------------------------
        SELECT
            @cAnulado AS Filtro_anulado, 'DEVO' AS tipo_rep, CLI.tip_cli, CLI.cli_des, CLI.co_zon, VE.ven_des,
