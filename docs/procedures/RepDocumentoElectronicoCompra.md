# SP: RepDocumentoElectronicoCompra
**Tipo**: Reporte
**Módulo**: Clientes
...
-- Description:	<RepDocumentoElectronicoCompra>
-- =============================================
CREATE PROCEDURE [dbo].[RepDocumentoElectronicoCompra]
...
AS 
    BEGIN
        ...
        SELECT
			...
			DE.sp_doc_elec, DE.doc_num_desde, DE.doc_num_hasta, DE.fec_emis_desde, DE.fec_emis_hasta, DE.fec_venc_desde, DE.co_prov_desde,
			PRO1.prov_des as prov_des_desde, DE.co_prov_hasta, PRO2.prov_des as prov_des_hasta, DE.procesado
        FROM
            saDocumentoElectronico DE
			LEFT JOIN saProveedor PRO1 ON DE.co_prov_desde = PRO1.co_prov
			LEFT JOIN saProveedor PRO2 ON DE.co_prov_hasta = PRO2.co_prov
            
        WHERE						
            ((@cCo_doc_elec_d IS NULL OR DE.co_doc_e
```
