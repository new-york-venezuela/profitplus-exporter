# SP: pSeleccionarContabilizacionVentasNoAutomaticas
**Tipo**: Seleccionar
**Módulo**: Clientes
...
```sql
/**************************************************************************************************************
NOMBRE: pSeleccionarContabilizacionVentasNoAutomaticas
DESCRIPCION: Selecciona los datos a contabilizar de facturas ventas no automaticas
CREADO POR: SOFTECH SISTEMAS
CREADO EL:15/06/2010
ACTUALIZADO EL: <2019-12-12>
***************************************************************************************************************/
CREATE PROCEDURE [dbo].[pSeleccionarContabilizacionVentasNoAutomaticas]
    (
