# SP: pInsertarRenglonesPedidoVenta
**Tipo**: Insertar
**Módulo**: Ventas
...
```sql
/**************************************************************************************************************
NOMBRE		: pInsertarRenglonesPedidoVenta
DESCRIPCION	: Inserta un registro de la tabla saFacuraVentaReng
CREADO POR	: SOFTECH SISTEMAS
***************************************************************************************************************/
CREATE PROCEDURE [pInsertarRenglonesPedidoVenta]
    (
      @iReng_Num INT ,
      @sDoc_Num CHAR(20) ,
      @sCo_Art CHAR(30) ,
