...
*NOMBRE                    : pInsertarFacturaVenta
*DESCRIPCIÓN : Inserta una factura de venta
*AUTOR              : SOFTECH SISTEMAS
*************************************************************************/
CREATE PROCEDURE [dbo].[pInsertarFacturaVenta]
   (
      @sDoc_Num CHAR(20) ,
      @sDescrip VARCHAR(60) ,
      @sCo_Cli CHAR(16) ,
...
AS 
    BEGIN
        ...
        INSERT  INTO saFacturaVenta
                ( doc_num, descrip, co_cli, co_tran, co_mone, co_cta_ingr_egr, co_ven,
```
