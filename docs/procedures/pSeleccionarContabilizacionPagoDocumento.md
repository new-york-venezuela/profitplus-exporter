# SP: pSeleccionarContabilizacionPagoDocumento
**Tipo**: Seleccionar
**Módulo**: Tesorería
...
-- Description:	<pSeleccionarContabilizacionPagoDocumento>
-- =============================================
CREATE PROCEDURE [dbo].[pSeleccionarContabilizacionPagoDocumento]
    (
