# SP: pSeleccionarContabilizacionNotaDebitoCompra
**Tipo**: Seleccionar
**Módulo**: Compras
...
## Código (excerpt)
```sql
CREATE PROCEDURE [dbo].[pSeleccionarContabilizacionNotaDebitoCompra]
    (
...
AS 
	 ...
	 */
        ...
        SELECT     RTRIM(DV.nro_doc) AS Co_Doc, CL.co_prov AS Co_Auxiliar, CL.prov_des AS Descrip_Auxiliar, DV.nro_doc, DV.co_p
```
