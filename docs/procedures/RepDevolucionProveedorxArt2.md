# SP: RepDevolucionProveedorxArt2
**Tipo**: Reporte
**Módulo**: Inventario
...
-- Description:	<Reporte de Devoluciones de Proveedor por Artículos 2>
-- =============================================
CREATE PROCEDURE [dbo].[RepDevolucionProveedorxArt2]
