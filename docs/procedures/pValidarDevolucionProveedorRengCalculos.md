# SP: pValidarDevolucionProveedorRengCalculos
**Tipo**: Validar
**Módulo**: Compras
...
## Código (excerpt)
```sql
CREATE PROCEDURE [dbo].[pValidarDevolucionProveedorRengCalculos]
    (
                ...
                IF ( @i = 1 ) 
                    BEGIN
                        ...
                        FOR
                            ...
                            WHERE
                                R.monto_desc <> ROUND(dbo.CalcularMontoPorcentaje(R.porc_desc, R.cost_unit * R.total_art,
                                                                                  1), 5)
                    END
```
