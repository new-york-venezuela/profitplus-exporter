# SP: pActualizarRenglonesRetenPago
**Tipo**: Actualizar
**Módulo**: Fiscal
...
```sql
/**************************************************************************
*NOMBRE			:	pActualizarRenglonesRetenPago
*DESCRIPCIÓN	:	Actualiza un registro de retencion relacionado a un documento de pago
*AUTOR			:	SOFTECH SISTEMAS
*MODIFICADO		:	SOFTECH SISTEMAS
***************************************************************************/

CREATE PROCEDURE [pActualizarRenglonesRetenPago]
    (
