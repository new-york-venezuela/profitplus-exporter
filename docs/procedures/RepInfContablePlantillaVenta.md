# SP: RepInfContablePlantillaVenta
**Tipo**: Reporte
**Módulo**: Inventario
...
-- Description:	<Información Contable Plantilla de Venta>
-- =============================================
CREATE PROCEDURE [dbo].[RepInfContablePlantillaVenta]
...
BEGIN
 ...
 Select	A.doc_num, A.feccom, '01' as num_carp,
		...
		(select des_cen from scCentro where co_cen=C.
```
