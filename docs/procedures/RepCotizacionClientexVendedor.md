# SP: RepCotizacionClientexVendedor
**Tipo**: Reporte
**Módulo**: Clientes
...
-- Description:	<Reporte de Cotizaciones de Clientes por Vendedor>
-- =============================================
CREATE PROCEDURE [RepCotizacionClientexVendedor] 
...
-------------------------------
        SELECT
            @cAnulado AS Filtro_anulado, 'COTI' AS tipo_rep, CLI.tip_cli, CLI.cli_des, CLI.co_zon, VE.ven_des,
