# SP: RepDevolucionClienteConImagenes
**Tipo**: Reporte
**Módulo**: Clientes
...
-- Description:	<Reporte de Devoluciones a Clientes con sus Imagenes>
-- =============================================
CREATE PROCEDURE [dbo].[RepDevolucionClienteConImagenes] 
...
-------------------------------
        ...
        SELECT
            @cAnulado AS Filtro_anulado, 'devo' AS tip_rep, CL.cli_des, VE.ven_des, TR.des_tran, CP.cond_des,
