...
-- Description:	<Reporte de Notas de Recepcion de Compra por Artículos>
-- =============================================
CREATE PROCEDURE [dbo].[RepNotaRecepcionCompraxArt]
...
-------------------------------
        ...
        SELECT
			...
			FC.saldo / ( CASE WHEN @cCo_Moneda IS NULL THEN 1
                                                                     ELSE FC.tasa
                                                                END ) AS saldo,
			FC.total_bruto, 
            ...
            FC.dir_ent, FC.comentario, FC.campo
```
