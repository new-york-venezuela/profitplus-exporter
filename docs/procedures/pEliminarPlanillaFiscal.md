...
```sql
/************************************************************************
*NOMBRE			: pEliminarPlanillasFiscalesPagadas
*DESCRIPCIÓN	: Elimina una configuracion realizada en la tabla saPlanillasFiscalesPagadas
*AUTOR			: SOFTECH SISTEMAS.
*************************************************************************/

CREATE PROCEDURE [dbo].[pEliminarPlanillaFiscal]
    (
      @sCod_PlanOri CHAR(6) ,
    ...
    BEGIN
        ...
        FROM
            @TableTimestamp
             ...
             --Eliminar Imagen Planilla Fiscal
                    ...
                    BEGIN        
                           ...
                           FOR
                                  ...
                                  WHILE @@FETCH_STATUS = 0
                                        BEGIN
                                               EXEC [dbo].[pEliminarDocumentoImagen]
```
