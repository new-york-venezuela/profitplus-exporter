...
-- Description:	<Reporte de Notas de Despacho de Venta por Renglones>
-- =============================================
CREATE PROCEDURE [RepNotaDespachoVentaxReng] 
...
-------------------------------
        ...
        SELECT
            @cAnulado AS Filtro_anulado, 'nota' AS tip_rep, ART.art_des, ART.modelo, ART.co_lin, ART.co_subl, ART.co_cat,
		...
		/*Campos saFacturaVenta*/ FV.doc_num, FV.descrip, FV.co_cli, FV.co_tran, FV.co_mone, FV.co_ven, FV.co_cond,
            ...
            END ) AS saldo, 
			FV.dir_ent,
            FV.comentario, FV.dis_cen, FV.feccom, FV.numcom, FV.contrib, FV.impresa, FV.s
```
