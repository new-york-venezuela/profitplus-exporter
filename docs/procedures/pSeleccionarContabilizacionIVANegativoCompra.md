# SP: pSeleccionarContabilizacionIVANegativoCompra
**Tipo**: Seleccionar
**Módulo**: Compras
...
```sql
/**************************************************************************************************************
NOMBRE		:pSeleccionarContabilizacionIVANegativoCompra
DESCRIPCION	:Selecciona los documentos de contabilización de IVA negativo de compras NO contabilizados
CREADO POR	:SOFTECH SISTEMAS
CREADO EL	:2019/11/21
***************************************************************************************************************/
CREATE PROCEDURE [dbo].[pSeleccionarContabilizacionIVANegativoCompra]
       (
