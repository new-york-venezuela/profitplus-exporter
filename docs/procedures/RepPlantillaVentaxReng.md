...
-- Description:	<Reporte de Plantillas de Venta por Renglones>
-- =============================================
CREATE PROCEDURE [RepPlantillaVentaxReng] 
...
-------------------------------
        ...
        SELECT
            @cAnulado AS Filtro_anulado, 'planti' AS tip_rep, ART.art_des, ART.modelo, ART.co_lin, ART.co_subl,
