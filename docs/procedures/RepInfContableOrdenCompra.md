...
-- Description:	<Información Contable Orden de Compra>
-- =============================================
CREATE PROCEDURE [dbo].[RepInfContableOrdenCompra]
...
BEGIN
  ...
  (Select A.doc_num, ORD.fec_emis, ORD.co_prov, (select prov_des from saProveedor where co_prov = ORD.co_prov) as prov_des, ORD.feccom, 
  ORD.numcom, A.num_carp, A.Descripcion, case when ltrim(A.monto) = '' then 0 else cast(A.monto as decimal(18,5)) end as monto, 
