# SP: pValidarRengImportadoFacturaCompraReng
**Tipo**: Validar
**Módulo**: Compras
...
## Código (excerpt)
```sql
CREATE PROCEDURE [pValidarRengImportadoFacturaCompraReng]
    (
    ...
    BEGIN	
        ...
        FOR
            ...
            FROM
                ...
                LEFT JOIN saFacturaCompraReng R2 ON R1.rowguid_doc = R2.rowguid
            WHERE
