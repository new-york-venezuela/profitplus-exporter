# SP: pActualizarContabilizacionNotaCreditoCompra
**Tipo**: Actualizar
**Módulo**: Compras
...
```sql
/*************************************************************************************************
NOMBRE:	pActualizarContabilizacionNotaCreditoCompra
DESCRIPCION:Actualizar las contabilizaciones de Nota De Credito en Compras 
CREADO POR: SOFTECH SISTEMAS
CREADO EL: 18/04/2011
**************************************************************************************************/
CREATE PROCEDURE [pActualizarContabilizacionNotaCreditoCompra]
    (
      @sCo_Doc CHAR(20) ,
      @sCo_Tipo_Doc CHAR(6),
