# SP: RepFormatoCotizacionProveedorOM
**Tipo**: Reporte
**Módulo**: Inventario
...
-- Description:	<Reporte de Formato de Cotización de Proveedor (OM)>
-- <Réplica de SP RepFormatoCompraOM>
-- =============================================
CREATE PROCEDURE [RepFormatoCotizacionProveedorOM]
