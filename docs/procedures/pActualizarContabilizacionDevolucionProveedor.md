# SP: pActualizarContabilizacionDevolucionProveedor
**Tipo**: Actualizar
**Módulo**: Compras
...
```sql
/*************************************************************************************************
NOMBRE:	pActualizarContabilizacionDevolucionCliente
DESCRIPCION: Actualizar la contabilizacion de Devolucion de Cliente
CREADO POR: SOFTECH SISTEMAS
CREADO EL: 09/03/2011
**************************************************************************************************/
CREATE PROCEDURE [pActualizarContabilizacionDevolucionProveedor]
    (
      @sCo_Doc CHAR(20) ,
...
AS 
	...
	-- Insertar Pista
        EXEC [pInsertarPista] @sUsuario_Id = @sCo_Us_Mo, @dtFecha = @dtFe_In, @sCo_Sucu = @sCo_Sucu_Mo,
            @sTablaOri = 'saDevolucionProveedor', @rowguidOri = @rowGuidOri, @sTipo_Op = 'M', @sMaquina = @sMaquina,
            @sCampos = @campo
