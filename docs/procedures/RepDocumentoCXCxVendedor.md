...
-- Description:	<Documentos de Compra por Proveedor>
-- =============================================
CREATE PROCEDURE [dbo].[RepDocumentoCXCxVendedor]
...
AS 
    BEGIN
        ...
        SELECT
			...
			DC.anulado,
            DC.total_neto * 
							  ( CASE WHEN DC.anulado = 1 THEN 0
                                             ELSE 1
                                        END ) AS total_neto,
										
										DC.saldo  * ( CASE WHEN DC.anulado = 1 THEN 0
                                                                                         ELSE 1
                                                                                    END ) AS saldo, 
