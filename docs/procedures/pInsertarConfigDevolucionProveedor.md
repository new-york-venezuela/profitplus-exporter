# SP: pInsertarConfigDevolucionProveedor
**Tipo**: Insertar
**Módulo**: Compras
...
```sql
/************************************************************************
*NOMBRE			:pInsertarConfigDevolucionProveedor
*DESCRIPCIÓN	: Inserta una Configuración en la tabla saConfigDevolucionProveedor
*AUTOR			: SOFTECH SISTEMAS
*************************************************************************/

CREATE PROCEDURE [pInsertarConfigDevolucionProveedor]
    (
      @sCo_Config CHAR(6) ,
...
AS 
    BEGIN
        ...
        INSERT  INTO saConfigDevolucionProveedor
        ...
        EXEC [pInsertarPista] @sUsuario_Id = @sCo_Us_In, @dtFecha = @dtFe_In, @sCo_Sucu = @sCo_Sucu_in,
            @sTablaOri = 'saConfigDevolucionProveedor', @rowguidOri
```
