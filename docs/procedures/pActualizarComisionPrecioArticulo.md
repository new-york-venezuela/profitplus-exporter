# SP: pActualizarComisionPrecioArticulo
**Tipo**: Actualizar
**Módulo**: Inventario
...
```sql
/**************************************************************************************************************
NOMBRE: pActualizarComisionNivelPrecio
DESCRIPCION: 
CREADO POR: SOFTECH SISTEMAS
***************************************************************************************************************/
CREATE PROCEDURE [pActualizarComisionPrecioArticulo]
    (
      @sCo_Comip CHAR(6) ,
      @sCo_ComipOri CHAR(6) ,
...
AS 
    BEGIN
        ...
        SET co_comip = @sCo_Comip, des_comip = @sDes_Comip, tipo_ven = @sTipo_Ven, aplica_en = @sAplica_En, 
            co_art = @sCo_Art, co_precio = @sCo_Precio, hasta1 = @deHasta1, hasta2 = @deHasta2, hasta3 = @deHasta3, 
