# SP: pInsertarConfigCotizacionProveedor
**Tipo**: Insertar
**Módulo**: Clientes
...
```sql
/************************************************************************
*NOMBRE			:pInsertarConfigCotizacionProveedor
*DESCRIPCIÓN	: Inserta una Configuración en la tabla saConfigCotizacionProveedor
*AUTOR			: SOFTECH SISTEMAS
*************************************************************************/

CREATE PROCEDURE [pInsertarConfigCotizacionProveedor]
    (
      @sCo_Config CHAR(6) ,
...
AS 
    BEGIN
        ...
        INSERT  INTO saConfigCotizacionProveedor
        ...
        EXEC [pInsertarPista] @sUsuario_Id = @sCo_Us_In, @dtFecha = @dtFe_In, @sCo_Sucu = @sCo_Sucu_in,
            @sTablaOri = 'saConfigCotizacionProveedor', @rowguidOri
```
