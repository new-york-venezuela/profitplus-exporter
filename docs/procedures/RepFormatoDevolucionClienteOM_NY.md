# SP: RepFormatoDevolucionClienteOM_NY
**Tipo**: Reporte
**Módulo**: Ventas
...
-- Description:	<Reporte de Formato de Devolucion a Cliente (OM)>
-- <Réplica de SP RepFormatoCompraOM>
-- =============================================
CREATE PROCEDURE [dbo].[RepFormatoDevolucionClienteOM_NY] 
...
AS 
    ...
    -- Insert statements for procedure here
		...
		/*Campos saDevolucionCliente*/ FV.doc_num, FV.descrip, FV.co_cli, FV.co_tran, FV.co_mone, FV.co_ven,
            ...
            FV.porc_desc_glob, FV.monto_desc_glob  AS monto_desc_glob, FV.porc_reca,
            FV.monto_reca  AS monto_reca, FV.total_bruto  AS total_bruto,
            FV.monto_imp  AS monto_imp, FV.monto_imp2  AS monto_imp2, FV.monto_imp3,
            FV.otros1  AS otros1, FV.otros2  AS otros2, FV.otros3  AS otros3, FV.total_neto,
		...
		/*Campos saDevolucionClienteReng*/ FVR.reng_num, FVR.doc_num, FVR.co_art,
            ...
            FVR.prec_vta  AS prec_vta, FVR.prec_vta_om, FVR.porc_desc, FVR.monto_desc  AS monto_desc,
            FVR.tipo_im
```
