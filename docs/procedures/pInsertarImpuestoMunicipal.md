...
***************************************************************************************************************/
CREATE PROCEDURE [pInsertarImpuestoMunicipal]
    (
      @sCo_Imun CHAR(15) ,
      @sCo_Sucur CHAR(6) ,
      @sImp_Des VARCHAR(60) ,
...
AS 
    BEGIN
        ...
        INSERT  INTO saImpMun
                ( co_imun, co_sucur, imp_des, n_act, alicuota, m_trib, campo1, campo2, campo3, campo4, campo5, campo6,
                  campo7, campo8, co_us_in, co_sucu_in, fe_us_in, co_us_mo, co_sucu_mo, fe_us_mo, revisado, trasnfe )
        OUTPUT  Inserted.validador, inserted.fe_us_in, inserted.fe_us_mo, Inserted.rowguid
                INTO @TableTimestamp
        VALUES
                ( @sCo_Imun, @sCo_Sucur, @sImp_Des, @sN_Act, @deAlicuota, @deM_Trib, @sCampo1, @sCampo2, @sCampo3,
	...
	-- Insertar Pista
        EXEC [pInsertarPista] @sUsuario_Id = @sCo_Us_In, @dtFecha = @dtFe_In, @sCo_Sucu = @sCo_Sucu_in,
            @sTablaOri = 'saImpMun', @rowguidOri = @rowGuidOri, @sTipo_Op = 'I', @sMaquina = @sMaquina,
            @sCampos = @sCo_Imun
