# SP: pActualizarContabilizacionPlantillaVenta
**Tipo**: Actualizar
**Módulo**: General
...
```sql
/*************************************************************************************************
NOMBRE:	pActualizarContabilizacionPlantilla
DESCRIPCION: Actualizar la contabilizacion de Plantilla
CREADO POR: SOFTECH SISTEMAS
CREADO EL: 02/03/2011
**************************************************************************************************/
CREATE PROCEDURE [pActualizarContabilizacionPlantillaVenta]
    (
      @sCo_Doc CHAR(20) ,
...
AS 
	...
	-- Insertar Pista
        EXEC [pInsertarPista] @sUsuario_Id = @sCo_Us_Mo, @dtFecha = @dtFe_In, @sCo_Sucu = @sCo_Sucu_Mo,
            @sTablaOri = 'saPlantillaVenta', @rowguidOri = @rowGuidOri, @sTipo_Op = 'M', @sMaquina = @sMaquina,
            @sCampos = @campo
