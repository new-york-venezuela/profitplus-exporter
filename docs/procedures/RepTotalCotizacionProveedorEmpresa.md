# SP: RepTotalCotizacionProveedorEmpresa
**Tipo**: Reporte
**Módulo**: Compras
...
-- =============================================
CREATE PROCEDURE [RepTotalCotizacionProveedorEmpresa]
...
AS 
    BEGIN
        ...
        SELECT
            ...
            CP.impresa, CP.seriales_e, CP.salestax, CP.campo1, CP.campo2, CP.campo3, CP.campo4, CP.campo5, CP.campo6,
            CP.campo7, CP.campo8, CP.co_us_in, CP.co_sucu_in, CP.fe_us_in, CP.co_us_mo, CP.co_sucu_mo, CP.fe_us_mo,
            CP.revisad
```
