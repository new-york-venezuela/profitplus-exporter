# SP: RepNotaRecepcionCompraxArt2
**Tipo**: Reporte
**Módulo**: Inventario
...
-- Description:	<Reporte de Notas de Recepcion de Compra por Artículos 2>
-- =============================================
CREATE PROCEDURE [RepNotaRecepcionCompraxArt2]
...
-------------------------------
        ...
        /*ROUND((dbo.ArtUnidadBase(FVR.co_art,FVR.co_uni,FVR.total_art)) * (CASE WHEN FC.anulado = 1 THEN 0 ELSE 1 END),5)*/
                ...
                ROUND(( ( FVR.cost_unit * FVR.total_art ) - FVR.monto_desc - FVR.monto_desc_glob + FVR.mon
```
