...
/*=============================================
 ...
 Description:	<Comision por Niveles de Precio por Linea>
 =============================================*/
CREATE PROCEDURE [RepComisionPrecioXLinea]
...
AS 
    BEGIN
        ...
        FROM
            ...
            INNER JOIN saComisionPrecioLinea AS C ON C.co_lin = LIN.co_lin
        WHERE
            ( ( @sCo_Lin_d IS NULL
