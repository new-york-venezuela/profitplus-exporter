# SP: pSeleccionarRenglonesDevolucionClienteDF
**Tipo**: Seleccionar
**Módulo**: Inventario
...
***************************************************************************************************************/
CREATE PROCEDURE [dbo].[pSeleccionarRenglonesDevolucionClienteDF] ( @sDoc_Num CHAR(20) )
AS 
    BEGIN 
        SELECT
            f.*, E.tasa, 
			CASE 
				...
				ELSE dbo.DevoArtDescCustomIF(a.art_des , f.rowguid) 
			END
