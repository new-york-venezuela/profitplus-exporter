# SP: pValidarPedidoVentaCalculos
**Tipo**: Validar
**Módulo**: Ventas
...
## Código (excerpt)
```sql
CREATE PROCEDURE [dbo].[pValidarPedidoVentaCalculos]
    (
...
AS 
	...
	-- Total Bruto (Versus renglones)
        ...
        FOR
            ...
            FROM
                saPedidoVenta E
                INNER JOIN saPedidoVentaReng R ON e.doc_num = R.doc_num
            GROUP BY
        ...
        WHILE @@FETCH_STATUS = 0 
            BEGIN
                SET @PistaMensaje = 'El pedido de venta nro. "' + RTRIM(@pDoc_Num) + '" tiene como valor total bruto "'
