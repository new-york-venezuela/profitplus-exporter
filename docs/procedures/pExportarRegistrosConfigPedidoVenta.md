# SP: pExportarRegistrosConfigPedidoVenta
**Tipo**: Procedimiento
**Módulo**: Ventas
...
```sql
/**************************************************************************
*NOMBRE			:	pExportarRegistrosConfigPedidoVenta
*DESCRIPCIÓN	:	Inserta una Configuración en la tabla saConfigPedidoVenta
*AUTOR			:	SOFTECH SISTEMAS
***************************************************************************/
CREATE PROCEDURE [dbo].[pExportarRegistrosConfigPedidoVenta]
    (
      @sCo_Config CHAR(6) ,
...
AS 
    BEGIN
		...
		SET @sSql = N'EXEC [' + @sempresa + '].[dbo].[pInsertarConfigPedidoVenta]	
																		@sCo_Config,
																		@sDes_Config,
																		@sCo_Usuario,
																		@sCo_Mapa,
