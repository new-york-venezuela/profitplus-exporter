# SP: pSeleccionarContabilizacionAjusteNegativoCompra
**Tipo**: Seleccionar
**Módulo**: Compras
...
```sql
/**************************************************************************************************************
NOMBRE		:pSeleccionarContabilizacionAjusteNegativoCompra
DESCRIPCION	:Selecciona los documentos de ajustes negativos en compras no contabilizados
CREADO POR	:SOFTECH SISTEMAS
CREADO EL	:2019/11/21
***************************************************************************************************************/
CREATE PROCEDURE [dbo].[pSeleccionarContabilizacionAjusteNegativoCompra]
       (
