# SP: RepCotizacionProveedorxReng
**Tipo**: Reporte
**Módulo**: Inventario
...
-- Description:	<Reporte de Cotizaciones de Proveedores con sus Renglones>
-- =============================================
CREATE PROCEDURE [RepCotizacionProveedorxReng]
...
-------------------------------
        ...
        SELECT
            ...
            FVR.tipo_doc, FVR.porc_desc, FVR.n
```
