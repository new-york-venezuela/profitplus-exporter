# SP: RepNotaSerialesDevolucionProveedor
**Tipo**: Reporte
**Módulo**: Inventario
...
-- Description:	<Reporte de Seriales en Devoluciones a proveedor>
-- =============================================
CREATE PROCEDURE [dbo].[RepNotaSerialesDevolucionProveedor]
...
AS 
    BEGIN
        ...
        SELECT
            ...
            FVR.porc_imp, FVR.porc_imp2, FVR.porc_imp3, FVR.monto_i
```
