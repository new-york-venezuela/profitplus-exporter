# SP: pActualizarContabilizacionNotaEntregaVenta
**Tipo**: Actualizar
**Módulo**: Ventas
...
```sql
/*************************************************************************************************
NOMBRE:	pActualizarContabilizacionNotaEntregaVenta
DESCRIPCION: Actualizar la contabilizacion de Nota Entrega de Venta
CREADO POR: SOFTECH SISTEMAS
CREADO EL: 09/03/2010
**************************************************************************************************/
CREATE PROCEDURE [pActualizarContabilizacionNotaEntregaVenta]
    (
      @sCo_Doc CHAR(20) ,
...
AS 
	...
	-- Insertar Pista
        EXEC [pInsertarPista] @sUsuario_Id = @sCo_Us_Mo, @dtFecha = @dtFe_In, @sCo_Sucu = @sCo_Sucu_Mo,
            @sTablaOri = 'saNotaEntrega', @rowguidOri = @rowGuidOri, @sTipo_Op = 'M', @sMaquina = @sMaquina,
            @sCampos = @campo
