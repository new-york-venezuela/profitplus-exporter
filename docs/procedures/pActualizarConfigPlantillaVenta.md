# SP: pActualizarConfigPlantillaVenta
**Tipo**: Actualizar
**Módulo**: General
...
```sql
/**************************************************************************
*NOMBRE			: pActualizarConfigPlantillaVenta
*DESCRIPCIÓN	: Actualiza la configuracion del proceso Plantilla Venta
*AUTOR			: SOFTECH SISTEMAS
**************************************************************************/

CREATE PROCEDURE [pActualizarConfigPlantillaVenta]
    (
      @sCo_Config CHAR(6) ,
