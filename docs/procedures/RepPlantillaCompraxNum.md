...
-- Description:	<Reporte de Plantillas de Compra por Número>
-- =============================================
CREATE PROCEDURE [RepPlantillaCompraxNum] 
...
-------------------------------
        SELECT
            ...
            PC.total_bruto, PC.monto_imp / ( CASE WHEN @cCo_Moneda IS NULL THEN 1
                                   ELSE PC.tasa
                              END ) AS monto_imp, PC.monto_imp2, PC.monto_imp3, PC.otros1, PC.otros2, PC.otros3,
            ...
            PC.campo6, PC.campo7, PC.campo8, P
```
