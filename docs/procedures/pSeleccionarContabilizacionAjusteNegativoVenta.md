# SP: pSeleccionarContabilizacionAjusteNegativoVenta
**Tipo**: Seleccionar
**Módulo**: Ventas
...
```sql
/**************************************************************************************************************
NOMBRE		: pSeleccionarContabilizacionAjusteNegativoVenta
DESCRIPCION	: Seleccionar Contabilización Ajuste negativo documentos de ventas No Contabilizados.
CREADO POR	: SOFTECH SISTEMAS
FECHA CREACIÓN: <2019-11-21>
***************************************************************************************************************/
CREATE PROCEDURE [dbo].[pSeleccionarContabilizacionAjusteNegativoVenta]
    (
