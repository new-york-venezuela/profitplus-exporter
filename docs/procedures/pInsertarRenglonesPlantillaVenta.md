# SP: pInsertarRenglonesPlantillaVenta
**Tipo**: Insertar
**Módulo**: General
...
```sql
/**************************************************************************************************************
NOMBRE		: pInsertarRenglonesPlantillaVenta
DESCRIPCION	: Inserta un registro de la tabla saFacuraVentaReng
CREADO POR	: SOFTECH SISTEMAS
***************************************************************************************************************/
CREATE PROCEDURE [pInsertarRenglonesPlantillaVenta]
    (
      @iReng_Num INT ,
      @sDoc_Num CHAR(20) ,
      @sCo_Art CHAR(30) ,
...
AS 
    BEGIN
        ...
        INSERT  INTO saPlantillaVentaReng
                ( reng_num, doc_num, co_art, des_art, co_uni,
```
