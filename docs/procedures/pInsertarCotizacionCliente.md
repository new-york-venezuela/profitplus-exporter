...
```sql
/************************************************************************
*NOMBRE			: pInsertarCotizacionCliente
*DESCRIPCIÓN	: Inserta una Cotizacion de venta
*CREATE DATE    : 2011-12-12
*LASTUPDATE DATE: 2020-07-27
*AUTOR			: SOFTECH SISTEMAS
*************************************************************************/

CREATE PROCEDURE [dbo].[pInsertarCotizacionCliente]
    (
      @sDoc_Num CHAR(20) ,
      @sDescrip VARCHAR(60) ,
      @sCo_Cli CHAR(16) ,
...
AS 
    BEGIN
        ...
        INSERT  INTO saCotizacionCliente
                ( doc_num, descrip, co_cli, co_cta_ingr_egr, co_tran, co_mone, co_ve
```
