# SP: RepFormatoCotizacioncliente
**Tipo**: Reporte
**Módulo**: Ventas
...
```sql
-- =============================================
-- Author:		SOFTECH SISTEMASm 
-- Create date: <25/08/2010>
-- Description:	<Formato de Cotizaciones de cliente >
-- =============================================
CREATE PROCEDURE [dbo].[RepFormatoCotizacioncliente] 
   ...
   BEGIN
    ...
    -- Insert statements for procedure here
		...
		/*Campos saFacturaVentaReng*/ FVR.reng_num, FVR.doc_num, FVR.co_art, ISNULL(FVR.des_art, ART.art_des) as des_art, FVR.co_alma, FVR.total_art,
            ...
            FVR.monto_desc, FVR.tipo_imp, FVR.tipo_imp2, FVR.tipo_
```
