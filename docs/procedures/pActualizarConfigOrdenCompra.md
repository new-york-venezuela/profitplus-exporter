# SP: pActualizarConfigOrdenCompra
**Tipo**: Actualizar
**Módulo**: Compras
...
```sql
/**************************************************************************
*NOMBRE			: pActualizarConfigOrdenCompra
*DESCRIPCIÓN	: Actualiza la configuracion del proceso Nota Recepcion Compra
*AUTOR			: SOFTECH SISTEMAS
**************************************************************************/

CREATE PROCEDURE [pActualizarConfigOrdenCompra]
    (
      @sCo_Config CHAR(6) ,
