...
```sql
/************************************************************************
*NOMBRE : pEliminarResInventario
*DESCRIPCIÓN : Elimina un Resultado de Inventario
*AUTOR : SOFTECH SISTEMAS
*************************************************************************/

CREATE PROCEDURE [pEliminarResInventario]
    (
...
AS 
	...
	--Eliminar Imagen de Resultado de Inventario
        ...
        IF @dtFe_De IS NOT NULL 
			...
			-- Insertar Pista
                EXEC [pInsertarPista] @sUsuario_Id = @sCo_Us_Mo, @dtFecha = @dtFe_De, @sCo_Sucu = @sCo_Sucu_Mo,
                    @sTablaOri = 'saResInventario', @rowguidOri = @rowGuidOri, @sTipo_Op = 'E', @sMaquina = @sMaqui
```
