# SP: pActualizarContabilizacionAjusteNegativoVenta
**Tipo**: Actualizar
**Módulo**: Ventas
...
```sql
/*************************************************************************************************
NOMBRE:	pActualizarContabilizacionAjusteNegativoPositivoVenta
DESCRIPCION:Actualizar las contabilizaciones de Ajuste Negativo Positivo en Venta
CREADO POR: SOFTECH SISTEMAS
CREADO EL: 14/04/2011
**************************************************************************************************/
CREATE PROCEDURE [pActualizarContabilizacionAjusteNegativoVenta]
    (
      @sCo_Doc CHAR(20) ,
      @sCo_Tipo_Doc CHAR(6),
