...
-- Description:	<Reporte de Factura de Ventas por Fecha>
-- =============================================
CREATE PROCEDURE [dbo].[RepFacturaVentaxFecha] 
...
-------------------------------
        SELECT
            @cAnulado AS Filtro_anulado, @cImprSubTotal AS SubTotales, 'FACT' AS tipo_rep, CLI.tip_cli, CLI.cli_des,
