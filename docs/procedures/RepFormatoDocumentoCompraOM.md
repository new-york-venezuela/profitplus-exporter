# SP: RepFormatoDocumentoCompraOM
**Tipo**: Reporte
**Módulo**: Compras
...
-- Description:	<Reporte de Formato de Documentos de Compras OM>
-- =============================================


CREATE PROCEDURE [dbo].[RepFormatoDocumentoCompraOM] 
...
AS 
    ...
    -- Insert statements for procedure here
        ...
        SELECT
          ...
          --  null fec_emis_ori, null total_bruto_ori, null monto_imp_ori, null total_neto_ori se comenta por sit 120762
