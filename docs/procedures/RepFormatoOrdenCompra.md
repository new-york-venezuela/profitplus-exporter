...
-- Description:	<Reporte de Formato de Orden de Compra>
-- =============================================
CREATE PROCEDURE [dbo].[RepFormatoOrdenCompra]
...
AS 
    BEGIN
        ...
        SELECT
            ...
            FVR.fe_us_in, FVR.co_sucu_mo, FVR.co_us_mo, FVR.fe_us_mo, FVR.revisado, FVR.trasnfe, FVR.rowguid
```
