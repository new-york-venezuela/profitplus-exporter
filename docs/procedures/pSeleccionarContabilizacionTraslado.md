# SP: pSeleccionarContabilizacionTraslado
**Tipo**: Seleccionar
**Módulo**: General
...
## Código (excerpt)
```sql
CREATE PROCEDURE [pSeleccionarContabilizacionTraslado]
    (
...
AS 
	 ...
	 */
        ...
        SELECT
            TR.tras_num AS Co_Doc, TR.fec_conf AS Fec_Emis, TR.co_sucu_in AS Co_Sucu_Cont, '' AS Co_Auxiliar,
            '' AS De
```
