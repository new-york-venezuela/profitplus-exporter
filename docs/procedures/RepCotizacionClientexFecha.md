...
-- Description:	<Reporte de Cotizaciones a Clientes por Fecha>
-- =============================================
CREATE PROCEDURE [RepCotizacionClientexFecha] 
...
-------------------------------
        SELECT
            @cAnulado AS Filtro_anulado, 'COTI' AS tipo_rep, @cImprSubTotal AS SubTotales, CLI.tip_cli, CLI.cli_des,
