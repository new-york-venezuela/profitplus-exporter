...
```sql
/**************************************************************************
*NOMBRE			:	pEliminarBeneficios
*DESCRIPCIÓN	:	Elimina un beneficio
*AUTOR			:	SOFTECH SISTEMAS
***************************************************************************/

CREATE PROCEDURE [pEliminarBeneficiario]
    (
      @sCod_BenOri CHAR(10) ,
        ...
        IF @dtFe_De IS NOT NULL 
			...
			-- Insertar Pista
                EXEC [pInsertarPista] @sUsuario_Id = @sCo_Us_Mo, @dtFecha = @dtFe_De, @sCo_Sucu = @sCo_Sucu_Mo,
                    @sTablaOri = 'saBeneficiario', @rowguidOri = @rowGuidOri, @sTipo_Op = 'E', @sMaquina = @sMaquina,
                    @sCampos = @sC
```
