# SP: pActualizarEncabezadoCotizacionProveedor
**Tipo**: Actualizar
**Módulo**: Compras
...
```sql
/***********************************************************************
*NOMBRE			:	pActualizarEncabezadosCotizacionProveedor
*DESCRIPCIÓN	:	Actualiza el Encabezado del Renglon para Indicar que cambio
*AUTOR			:	SOFTECH SISTEMAS
************************************************************************/

CREATE PROCEDURE [dbo].[pActualizarEncabezadoCotizacionProveedor]
    (
        ...
        IF @dtFe_In IS NOT NULL 
			...
			-- Insertar Pista
                EXEC [pInsertarPista] @sUsuario_Id = @sCo_Us_Mo, @dtFecha = @dtFe_In, @sCo_Sucu = @sCo_Sucu_Mo,
                    @sTablaOri = 'saCotizacionProveedor', @rowguidOri = @rowGuidOri, @sTipo_Op = 'M', @sMaquina = @sMaquina,
