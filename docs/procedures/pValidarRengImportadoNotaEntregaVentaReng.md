# SP: pValidarRengImportadoNotaEntregaVentaReng
**Tipo**: Validar
**Módulo**: Ventas
...
## Código (excerpt)
```sql
CREATE PROCEDURE [pValidarRengImportadoNotaEntregaVentaReng]
    (
    ...
    BEGIN	
        ...
        FOR
            ...
            FROM
                ...
                LEFT JOIN saNotaEntregaVentaReng R2 ON R1.rowguid_doc = R2.rowguid
            WHERE
            ...
            BEGIN
                ...
                IF @pR2Reng_num IS NULL 
                    BEGIN
                        ...
                        SET @PuedeCorregir = @PuedeCorregirZo
```
