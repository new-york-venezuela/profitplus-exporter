# SP: pActualizarContabilizacionGiroCompra
**Tipo**: Actualizar
**Módulo**: Compras
...
```sql
/*************************************************************************************************
NOMBRE:	pActualizarContabilizacionGiroCompra
DESCRIPCION:Actualizar las contabilizaciones de Giro en Compra
CREADO POR: SOFTECH SISTEMAS
CREADO EL: 20/04/2011
**************************************************************************************************/
CREATE PROCEDURE [pActualizarContabilizacionGiroCompra]
    (
      @sCo_Doc CHAR(20) ,
      @sCo_Tipo_Doc CHAR (6),
