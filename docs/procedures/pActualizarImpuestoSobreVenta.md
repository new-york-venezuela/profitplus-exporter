# SP: pActualizarImpuestoSobreVenta
**Tipo**: Actualizar
**Módulo**: Fiscal
...
```sql
/**********************************************************************
*NOMBRE: pActualizarImpuestoSobreVenta
*DESCRIPCIÓN : Actualiza un Impuesto sobre la Venta
*AUTOR: SOFTECH SISTEMAS
***********************************************************************/

CREATE PROCEDURE [pActualizarImpuestoSobreVenta]
    (
...
AS 
    BEGIN		
        ...
        SET fecha = @sdFecha, campo1 = @sCampo1, campo2 = @sCampo2, campo3 = @sCampo3, campo4 = @sCampo4,
        ...
        IF @dtFe_In IS NOT NULL 
			...
			-- Insertar Pista
                EXEC [pInsertarPista] @sUsuario_Id = @sCo_Us_Mo, @dtFecha = @dtFe_In, @sCo_Sucu = @sCo_Sucu_Mo,
                    @sTablaOri = 'saImpuestoSobreVenta', @rowguidOri = @rowGuidOri, @sTipo_Op = 'M',
