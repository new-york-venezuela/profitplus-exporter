# SP: RepNotaRecepcionCompraxReng
**Tipo**: Reporte
**Módulo**: Inventario
...
-- Description:	<Reporte de Notas de Recepcion de Compra con sus Renglones>
-- =============================================
CREATE PROCEDURE [RepNotaRecepcionCompraxReng]
...
-------------------------------
        ...
        SELECT
            ...
            FVR.tipo_doc, FVR.porc_desc, FVR.
```
