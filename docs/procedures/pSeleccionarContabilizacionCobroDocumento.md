# SP: pSeleccionarContabilizacionCobroDocumento
**Tipo**: Seleccionar
**Módulo**: Tesorería
...
-- Description:	<pSeleccionarContabilizacionCobroDocumento>
-- =============================================
CREATE PROCEDURE [dbo].[pSeleccionarContabilizacionCobroDocumento]
    (
