# SP: RepInfContableNotaRecepcionCompra
**Tipo**: Reporte
**Módulo**: Inventario
...
-- Description:	<Información Contable Nota de Recepción de Compra>
-- =============================================
CREATE PROCEDURE [dbo].[RepInfContableNotaRecepcionCompra]
...
(Select A.doc_num, REC.fec_emis, REC.co_prov, (select prov_des from saProveedor where co_prov = REC.co_prov) as prov_des, REC.feccom, 
  REC.numcom, A.num_carp, A.Descripcion, case when ltrim(A.monto) = '' then 0 else cast(A.monto as decimal(18,5)) end as monto, 
