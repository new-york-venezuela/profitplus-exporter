...
```sql
/**************************************************************************
*NOMBRE			: pActualizarImpuesto
*DESCRIPCIÓN	: Actualiza un Impuesto
*AUTOR			: SOFTECH SISTEMAS
**************************************************************************/

CREATE PROCEDURE [pActualizarImpuesto]
    (
...
AS 
    BEGIN	
        ...
        UPDATE
            saImpuesto
        SET cod_impuesto = @sCod_Impuesto, des_impuesto = @sDes_Impuesto, registro_sist = @bRegistro_Sist,
