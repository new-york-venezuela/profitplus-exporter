# SP: pActualizarConfigCotizacionCliente
**Tipo**: Actualizar
**Módulo**: Ventas
...
```sql
/**************************************************************************
*NOMBRE			: pActualizarConfigCotizacionCliente
*DESCRIPCIÓN	: Actualiza la configuracion del proceso Cotizacion Cliente
*AUTOR			: SOFTECH SISTEMAS
**************************************************************************/

CREATE PROCEDURE [pActualizarConfigCotizacionCliente]
    (
      @sCo_Config CHAR(6) ,
