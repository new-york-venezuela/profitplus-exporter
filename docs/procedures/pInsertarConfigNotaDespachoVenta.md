# SP: pInsertarConfigNotaDespachoVenta
**Tipo**: Insertar
**Módulo**: Ventas
...
```sql
/************************************************************************
*NOMBRE			:pInsertarConfigNotaDespachoVenta
*DESCRIPCIÓN	: Inserta una Configuración en la tabla saConfigNotaDespachoVenta
*AUTOR			: SOFTECH SISTEMAS
*************************************************************************/

CREATE PROCEDURE [pInsertarConfigNotaDespachoVenta]
    (
      @sCo_Config CHAR(6) ,
...
AS 
    BEGIN
        ...
        INSERT  INTO saConfigNotaDespachoVenta
        ...
        EXEC [pInsertarPista] @sUsuario_Id = @sCo_Us_In, @dtFecha = @dtFe_In, @sCo_Sucu = @sCo_Sucu_in,
            @sTablaOri = 'saConfigNotaDespachoVenta', @rowguidOri = @rowGui
```
