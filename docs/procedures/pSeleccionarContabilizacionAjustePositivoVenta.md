# SP: pSeleccionarContabilizacionAjustePositivoVenta
**Tipo**: Seleccionar
**Módulo**: Ventas
...
```sql
/**************************************************************************************************************
NOMBRE		: pSeleccionarContabilizacionAjustePositivoVenta
DESCRIPCION	: Seleccionar Contabilización Ajuste Positivo documentos de ventas No Contabilizados.
CREADO POR	: SOFTECH SISTEMAS
FECHA CREACIÓN: <2019-11-21>
***************************************************************************************************************/
CREATE PROCEDURE [dbo].[pSeleccionarContabilizacionAjustePositivoVenta]
    (
