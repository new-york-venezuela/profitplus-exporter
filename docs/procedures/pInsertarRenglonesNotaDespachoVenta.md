# SP: pInsertarRenglonesNotaDespachoVenta
**Tipo**: Insertar
**Módulo**: Ventas
...
***************************************************************************************************************/
CREATE PROCEDURE [pInsertarRenglonesNotaDespachoVenta]
    (
      @iReng_Num INT ,
      @sDoc_Num CHAR(20) ,
      @sCo_Art CHAR(30) ,
...
AS 
    BEGIN
        ...
        INSERT  INTO saNotaDespachoVentaReng
                ( reng_num, doc_num, co_art, des_art, co_
```
