# SP: pInsertarRenglonesRetenIvaPago
**Tipo**: Insertar
**Módulo**: Fiscal
...
```sql
/***********************************************************************************************
*NOMBRE			:	pInsertarRenglonesRetenIvaPago
*DESCRIPCIÓN	:	Inserta un registro de retencion de IVA relacionado a un documento de pago
*AUTOR			:	SOFTECH SISTEMAS
***********************************************************************************************/

CREATE PROCEDURE [pInsertarRenglonesRetenIvaPago]
    (
    ...
    BEGIN
        ...
        VALUES
                ( @iRENG_NUM, @gRowguid_Reng_Cob, @sRif_Contribuyente, @dePeriodo_Impositivo, @sdFecha_Documento,
                  ...
                  @deMonto_Documento, @deBase_Imponible, @deMonto_Ret_Im
```
