# SP: RepNotaEntregaVentaxVendedor
**Tipo**: Reporte
**Módulo**: Clientes
...
-- Description:	<Reporte de Notas de Entrega de Ventas por Vendedor>
-- =============================================
CREATE PROCEDURE [RepNotaEntregaVentaxVendedor] 
...
-------------------------------
        SELECT
            @cAnulado AS Filtro_anulado, 'NOTA_ENT' AS tipo_rep, CLI.tip_cli, CLI.cli_des, CLI.co_zon, VE.ven_des,
