...
-- Description:	<Reporte de Nota de Plantillas de Venta por Artículos 2>
-- =============================================
CREATE PROCEDURE [RepPlantillaVentaxArt2] 
...
-------------------------------
        ...
        /*ROUND((dbo.ArtUnidadBase(FVR.co_art,FVR.co_uni,FVR.total_art)) * (CASE WHEN FC.anulado = 1 THEN 0 ELSE 1
```
