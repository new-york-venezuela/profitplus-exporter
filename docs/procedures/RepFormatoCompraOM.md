...
-- Description:	<Reporte de Formato de Factura de Compra OM>
-- =============================================
CREATE PROCEDURE [RepFormatoCompraOM]
...
AS 
    BEGIN
        ...
        SELECT
            ...
            FVR.porc_imp, FVR.porc_imp2, FVR.porc_imp3, FVR.monto_imp / FC.tasa AS monto_imp,
```
