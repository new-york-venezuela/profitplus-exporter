# SP: pSeleccionarContabilizacionMovimientoBanco
**Tipo**: Seleccionar
**Módulo**: Tesorería
...
## Código (excerpt)
```sql
CREATE PROCEDURE [pSeleccionarContabilizacionMovimientoBanco]
    (
...
AS 
	 ...
	 */
        ...
        SELECT
            MB.mov_num AS Co_Doc, MB.fecha AS Fec_Emis, MB.co_sucu_in AS Co_Sucu_Cont, '' AS Co_Auxiliar,
            '' AS
```
