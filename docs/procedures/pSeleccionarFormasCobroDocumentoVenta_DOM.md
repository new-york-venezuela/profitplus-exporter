# SP: pSeleccionarFormasCobroDocumentoVenta_DOM
**Tipo**: Seleccionar
**Módulo**: Tesorería
...
CREATE PROCEDURE [dbo].[pSeleccionarFormasCobroDocumentoVenta_DOM]
...
SELECT D.fec_emis AS fecha--CONVERT(char,D.fec_emis,103) AS fecha
       , D.nro_doc
       , D.co_cli
       , CL.cli_des
       , D.tip
