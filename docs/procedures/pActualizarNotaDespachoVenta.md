# SP: pActualizarNotaDespachoVenta
**Tipo**: Actualizar
**Módulo**: Ventas
...
```sql
/************************************************************************
*NOMBRE			: pActualizarNotaDespachoVenta
*DESCRIPCIÓN	: actualiza una nota de despacho de venta
*CREATE DATE    : 2011-12-12
*LASTUPDATE DATE: 2020-07-27 
*AUTOR			: Softech
*************************************************************************/

CREATE PROCEDURE [dbo].[pActualizarNotaDespachoVenta]
    (
      @sDoc_Num CHAR(20) ,
      @sDoc_NumOri CHAR(20) ,
      @sDescrip VARCHAR(60) ,
