# SP: pExportarRegistrosConfigNotaRecepcionCompra
**Tipo**: Procedimiento
**Módulo**: Compras
...
```sql
/**************************************************************************
*NOMBRE			:	pExportarRegistrosConfigNotaRecepcionCompra
*DESCRIPCIÓN	:	Inserta una Configuración en la tabla saConfigNotaRecepcionCompra
*AUTOR			:	SOFTECH SISTEMAS
***************************************************************************/
CREATE PROCEDURE [dbo].[pExportarRegistrosConfigNotaRecepcionCompra]
    (
      @sCo_Config CHAR(6) ,
...
AS 
    BEGIN
		...
		SET @sSql = N'EXEC [' + @sempresa + '].[dbo].[pInsertarConfigNotaRecepcionCompra]	
																		@sCo_Config,
																		@sDes_Config,
																		@sCo_Usuario,
																		@sCo_Mapa,
