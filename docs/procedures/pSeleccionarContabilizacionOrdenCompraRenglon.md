# SP: pSeleccionarContabilizacionOrdenCompraRenglon
**Tipo**: Seleccionar
**Módulo**: Inventario
...
-- Description:	<pSeleccionarContabilizacionOrdenCompraRenglon>
-- =============================================
CREATE PROCEDURE [dbo].[pSeleccionarContabilizacionOrdenCompraRenglon]
    (
...
AS 
    BEGIN
		...
		SELECT     FV.doc_num AS Co_Doc_Padre, FVR.reng_num AS Co_Doc, FV.fec_emis, MO.relacion AS mone_relacion, CL.co_prov AS Co_Auxiliar, CL.prov_des AS Descrip_Auxiliar, 
                      ...
                      FVR.dis_cen AS dis_cen_saOrdenCompraRenglon, FVR.co_us_in, FVR.co_sucu_in, FVR.fe_us_in, FVR.co_us_mo, FVR.co_sucu_mo, FVR.fe_us_mo, FVR.revisado, 
                      ...
                      CL.co_prov AS Co_proveedor, FV.tasa, dbo.saLineaArticulo.dis_cen AS dis_cen_saLineaArticulo, dbo.saCatArticulo.dis_cen AS dis_cen_saCatArticulo, ISNULL(FV.nro_fact,'') AS nro_fact
		FROM         dbo.saOrdenCompraReng AS FVR INNER JOIN
                      dbo.saOrdenCompra AS FV ON FVR.doc_num = FV.doc_num INNER JOIN
                      ...
                      dbo.saLineaArticulo ON AR.co_lin = dbo.saLineaArticulo.co_lin INNER JOIN
                      dbo.saCatArticulo ON AR.co_cat = dbo.saCatArticulo.co_cat        
        WHERE
