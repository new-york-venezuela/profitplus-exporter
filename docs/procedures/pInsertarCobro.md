...
*NOMBRE			: [pInsertarCobro]
*DESCRIPCIÓN	: Inserta un cobro
*AUTOR			: SOFTECH SISTEMAS
*************************************************************************/

CREATE PROCEDURE [pInsertarCobro]
    (
      @sCob_Num CHAR(20) ,
      @sRecibo CHAR(15) ,
      @sCo_cli CHAR(16) ,
...
AS 
    BEGIN
        ...
        INSERT  INTO [saCobro]
                ( [cob_num], [recibo], [descrip], [co_cli], [co_mone], [co_ven], [tasa], [fecha], [anulado], [monto],
        ...
        OUTPUT  Inserted.validador, inserted.fe_us_in, inserted.fe_us_mo, Inserted.rowguid
                INTO @TableTimestamp
        VALUES
                ( @sCob_Num, @sRecibo, @sDescrip, @sCo_cli, @sCo_Mone, @sCo_ven, @deTasa, @sdFecha, @bAnulado, @deMonto,
