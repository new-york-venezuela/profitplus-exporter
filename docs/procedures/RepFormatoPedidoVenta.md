...
-- Description:	<Reporte de Formato de Pedido de Ventas>
-- =============================================
CREATE PROCEDURE [dbo].[RepFormatoPedidoVenta] 
...
AS 
    ...
    -- Insert statements for procedure here
		...
		/*Campos saFacturaVentaReng*/ FVR.reng_num, FVR.doc_num, FVR.co_art,
            ...
            FVR.prec_vta, FVR.prec_vta_om, FVR.p
```
