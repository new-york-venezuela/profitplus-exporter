# SP: pActualizarRenglonesPlantillaVenta
**Tipo**: Actualizar
**Módulo**: General
...
DESCRIPCION	: Actualiza un registro de la tabla saPlantillaVentaReng
CREADO POR	: SOFTECH SISTEMAS
***************************************************************************************************************/
CREATE PROCEDURE [dbo].[pActualizarRenglonesPlantillaVenta]
    (
      @iReng_Num INT ,
      @sDoc_Num CHAR(20) ,
      @iReng_NumOri INT ,
