# SP: pSeleccionarContabilizacionFacturaCompra
**Tipo**: Seleccionar
**Módulo**: Compras
...
## Código (excerpt)
```sql
CREATE PROCEDURE [dbo].[pSeleccionarContabilizacionFacturaCompra]
    (
...
AS 
	 ...
	 */
		...
		SELECT     FV.doc_num AS Co_Doc, CASE WHEN FV.fec_emis > FV.fec_reg THEN FV.fec_emis ELSE FV.fec_reg END as fec_Emis, FV.co_s
```
