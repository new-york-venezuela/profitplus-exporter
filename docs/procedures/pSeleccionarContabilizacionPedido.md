# SP: pSeleccionarContabilizacionPedido
**Tipo**: Seleccionar
**Módulo**: Clientes
...
## Código (excerpt)
```sql
CREATE PROCEDURE [dbo].[pSeleccionarContabilizacionPedido]
    (
...
AS 
	 ...
	 */
		...
		SELECT     FV.doc_num AS Co_Doc, FV.fec_emis, FV.co_sucu_in AS Co_Sucu_Cont, CL.co_cli AS Co_Auxiliar, CL.cli_des AS Descrip_Auxiliar, FV.des
```
