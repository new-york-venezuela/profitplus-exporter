...
```sql
/**************************************************************************
*NOMBRE			:	pExportarRegistrosConISLR
*DESCRIPCIÓN	:	Inserta un concepto de ISLR
*AUTOR			:	SOFTECH SISTEMAS
***************************************************************************/

CREATE PROCEDURE [dbo].[pExportarRegistrosConISLR]
    (
      @sCo_Islr				CHAR(6) ,
...
AS 
    BEGIN
		...
		SET @sSql = N'EXEC [' + @sempresa + '].[dbo].[pInsertarConceptoISLR]	
																		@sCo_Islr,
																		@sIslr_Des,
																		@sIslr_DesLarga,
																		@sNumeral,
		...
		EXEC sp_executesql @sSql, N'@sCo_Islr CHAR(6) ,			@sIslr_Des VARCHAR(60) ,	@sIslr_DesLarga VARCHAR(MAX) ,
									@sNumeral CHAR(6),			@sLiteral CHAR(6),
									...
									@sCo_Islr,					@sIslr_Des,					@sIslr_DesLarga, 
									@sNumeral,					@sLiteral,					
