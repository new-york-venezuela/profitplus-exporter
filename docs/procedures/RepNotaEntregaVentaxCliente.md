# SP: RepNotaEntregaVentaxCliente
**Tipo**: Reporte
**Módulo**: Ventas
...
-- Description:	<Reporte de Notas de Entrega por Cliente>
-- =============================================
CREATE PROCEDURE [RepNotaEntregaVentaxCliente] 
...
-------------------------------
        ...
        SELECT
            @cAnulado AS Filtro_anulado, 'NOTA_ENT' AS tipo_rep, CLI.tip_cli, CLI.cli_des, CLI.co_zon, CLI.co_seg,
