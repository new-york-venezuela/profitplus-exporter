# SP: pActualizarCotizacionCliente
**Tipo**: Actualizar
**Módulo**: Ventas
...
*NOMBRE			: pActualizarCotizacionCliente
*DESCRIPCIÓN	: actualiza una Cotizacion de venta
*AUTOR			: Softech
*************************************************************************/

CREATE PROCEDURE [dbo].[pActualizarCotizacionCliente]
    (
      @sDoc_Num CHAR(20) ,
      @sDoc_NumOri CHAR(20) ,
      @sDescrip VARCHAR(60) ,
