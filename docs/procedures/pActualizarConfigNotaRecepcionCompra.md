# SP: pActualizarConfigNotaRecepcionCompra
**Tipo**: Actualizar
**Módulo**: Compras
...
```sql
/**************************************************************************
*NOMBRE			: pActualizarConfigNotaRecepcionCompra
*DESCRIPCIÓN	: Actualiza la configuracion del proceso Nota de Recepcion
*AUTOR			: SOFTECH SISTEMAS
**************************************************************************/

CREATE PROCEDURE [pActualizarConfigNotaRecepcionCompra]
    (
      @sCo_Config CHAR(6) ,
