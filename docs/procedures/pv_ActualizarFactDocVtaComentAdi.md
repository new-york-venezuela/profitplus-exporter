# SP: pv_ActualizarFactDocVtaComentAdi
**Tipo**: PV-Actualizar
**Módulo**: Ventas
...
*DESCRIPCIÓN	: ACTUALIZA EL COMENTARIO ADICIONAL, VENDEDOR Y DIRECCION DE ENTREGA DE UN
				  DOCUMENTO DADO
*AUTOR			: SOFTECH SISTEMAS
**************************************************************************/ 
CREATE PROCEDURE [dbo].[pv_ActualizarFactDocVtaComentAdi]
(		
		@sDoc_num			CHAR(20),
        @sCo_ven			CHAR(6)				=   NULL,
