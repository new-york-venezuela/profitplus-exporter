# SP: pValidarRengImportadoFacturaVentaReng
**Tipo**: Validar
**Módulo**: Ventas
...
## Código (excerpt)
```sql
CREATE PROCEDURE [pValidarRengImportadoFacturaVentaReng]
    (
    ...
    BEGIN	
        ...
        FOR
            SELECT
                ...
                R1.co_alma, R2.co_alma, R1.co_uni, R2.co_uni, 0 AS PuedeCorregir
            FROM
                saNotaDespachoVentaReng R1
                LEFT JOIN saFacturaVentaReng R2 ON R1.rowguid_doc = R2.rowguid
            WHERE
        ...
        WHILE @@FETCH_STATUS = 0 
            BEGIN
                ...
                IF @pR2Reng_num IS NULL 
                    BEGIN
                        SET @PistaMensaje = 'La nota de despacho nro. "' + RTRIM(@pR1Doc_Num) + '" renglon "'
