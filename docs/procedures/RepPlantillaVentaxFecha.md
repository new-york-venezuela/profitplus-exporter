...
-- Description:	<Reporte de Plantillas de Venta por Fecha>
-- =============================================
CREATE PROCEDURE [RepPlantillaVentaxFecha] 
...
-------------------------------
        SELECT
            @cAnulado AS Filtro_anulado, @cImprSubTotal AS SubTotales, 'PLANTI' AS tipo_rep, CLI.tip_cli, CLI.cli_des,
