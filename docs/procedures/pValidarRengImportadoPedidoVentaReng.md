# SP: pValidarRengImportadoPedidoVentaReng
**Tipo**: Validar
**Módulo**: Ventas
...
## Código (excerpt)
```sql
CREATE PROCEDURE [pValidarRengImportadoPedidoVentaReng]
    (
...
AS 
    BEGIN	
        ...
        FOR
            ...
            FROM
                saNotaEntregaVentaReng R1
                LEFT JOIN saPedidoVentaReng R2 ON R1.rowguid_doc = R2.rowguid
            WHERE
        ...
        WHILE @@FETCH_STATUS = 0 
            BEGIN
                ...
                IF @pR2Reng_num IS NULL 
                    BEGIN
                        SET @PistaMensaje = 'La nota de entrega nro. "' + RTRIM(@pR1Doc_Num) + '" renglon "'
