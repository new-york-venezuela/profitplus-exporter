# SP: pSeleccionarContabilizacionAjustePositivoCompra
**Tipo**: Seleccionar
**Módulo**: Compras
...
```sql
/**************************************************************************************************************
NOMBRE		:pSeleccionarContabilizacionAjustePositivoCompra
DESCRIPCION	:Selecciona los documentos de ajustes positivos en compra no contabilizados
CREADO POR	:SOFTECH SISTEMAS
CREADO EL	:2019/11/21
***************************************************************************************************************/
CREATE PROCEDURE [dbo].[pSeleccionarContabilizacionAjustePositivoCompra]
       (
