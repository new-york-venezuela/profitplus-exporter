# SP: RepRelacionDeISLRRetenidoPorProveedor
**Tipo**: Reporte
**Módulo**: Tesorería
...
-- Description:   <Relación de ISLR Retenido por Proveedor>
-- =============================================
CREATE PROCEDURE [dbo].[RepRelacionDeISLRRetenidoPorProveedor]
    ...
    BEGIN
        ...
        IF @dFecha_h IS NOT NULL 
			...
			BEGIN 
				...
				SELECT
					P.rif, P.co_prov, P.prov_des, SUM(PR.monto_obj) AS monto_obj, SUM(PR.monto_reten) AS monto_reten, 'Tipo'=@tipo
				FROM
					saProveedor P
			...
			BEGIN
				...
				SELECT
					B.rif, B.cod_ben AS co_prov, B.ben_des AS prov_des, SUM(OPR.monto_obj) AS
```
