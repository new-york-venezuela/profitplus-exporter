...
-- Description:   <Articulos sin Ventas>
-- =============================================
CREATE PROCEDURE [dbo].[RepArticulosSinVentas]
    ...
    BEGIN
        ...
        SELECT
           ...
           --( dbo.ConsultarStockActualxAlmacenxFechaxTipoDoc(AR.co_art, @sCo_Alma,  @dFecha_d - 1,  NULL, NULL) ) AS Stockart,
		    ( dbo.ConsultarStockActualxAlmacenxFechaxTipoDoc(AR.co_art, @sCo_Alma,  @dFecha_h,  NULL, NULL) ) AS Stockart,
            U.co_uni
        FROM
            saArticulo AS AR
        ...
        WHERE
            AR.co_art NOT IN ( SELECT
                                FR.co_art
                               FROM
                                saFacturaVentaReng FR
                                INNER JOIN saFacturaVenta F ON F.doc_num = FR.doc_num
                               WHERE
                                ( ( @dFecha_d IS NULL
