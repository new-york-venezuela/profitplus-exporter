# SP: RepRelacionIGTFxPagosSinMediacFinanc
**Tipo**: Reporte
**Módulo**: Tesorería
...
-- Description:	<RepRelacionIGTFxPagosSinMediacFinanc>
-- =============================================
CREATE PROCEDURE [dbo].[RepRelacionIGTFxPagosSinMediacFinanc]
...
AS 
	...
	SELECT
		  ...
		  MC.anulado,[dbo].[fObtenerImpuestoTransacciones]('ITF',MC.fecha) as por_IGTF,
