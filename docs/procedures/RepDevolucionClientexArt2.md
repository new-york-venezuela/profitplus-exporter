...
-- Description:	<Reporte de Devolucion de Clientes por Artículos 2>
-- =============================================
CREATE PROCEDURE [RepDevolucionClientexArt2] 
...
-------------------------------
        ...
        FROM
            ( SELECT
                ...
                FVR.monto_reca_glob, FVR.prec_vta, ROUND(( FVR.
```
