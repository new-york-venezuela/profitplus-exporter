# SP: pActualizarContabilizacionComprasNoAutomaticas
**Tipo**: Actualizar
**Módulo**: Compras
...
```sql
/*************************************************************************************************
NOMBRE:	pActualizarContabilizacionComprasNoAutomaticas
DESCRIPCION:Actualizar las contabilizaciones de Facturas compras no automaticas
CREADO POR: SOFTECH SISTEMAS
CREADO EL: 15/06/2010
**************************************************************************************************/
CREATE PROCEDURE [pActualizarContabilizacionComprasNoAutomaticas]
    (
      @sCo_Doc CHAR(20) ,
      @sCo_Tipo_Doc CHAR(6),
...
AS 
    BEGIN
        ...
        OUTPUT
			...
			@TableTimestamp
        WHERE
            (RTRIM(nro_doc) = @sCo_Doc)
            AND (RTRIM(co_tipo_doc) = @sCo_Tipo_Doc)
