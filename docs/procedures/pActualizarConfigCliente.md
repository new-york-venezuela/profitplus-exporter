...
```sql
/**************************************************************************
*NOMBRE			: ActualizarConfigcliente
*DESCRIPCIÓN	: Actualiza la configuracion del proceso Cliente
*AUTOR			: Softech Sistemas.
**************************************************************************/

CREATE PROCEDURE [pActualizarConfigCliente]
    (
      @sCo_Config CHAR(6) ,
