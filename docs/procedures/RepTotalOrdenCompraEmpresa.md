...
-- Description:	<Reporte de Total de Ordenes de Compra de la Empresa>
-- =============================================
CREATE PROCEDURE [RepTotalOrdenCompraEmpresa]
...
AS 
    BEGIN
        ...
        SELECT
            ...
            OC.trasnfe, OC.validador, OC.rowguid, OCR.coti,
        ...
        FROM
            ...
            INNER JOIN ( SELECT DISTINCT
                            ...
                            SUM(( ( total_art - pendiente ) * ( ( ( cost_unit * total_art ) - ( monto_desc
```
