...
-- Description:	<Reporte de Factura de Ventas por Vendedor>
-- =============================================
CREATE PROCEDURE [RepFacturaVentaxVendedor] 
...
-------------------------------
        SELECT
            @cAnulado AS Filtro_anulado, 'FACT' AS tipo_rep, CLI.tip_cli, CLI.cli_des, CLI.co_zon, VE.ven_des,
		/*Campos saFacturaVenta*/ FV.doc_num, FV.descrip, FV.co_cli, FV.co_tran, FV.co_mone, FV.co_ven, FV.co_cond,
            ...
            FV.feccom, FV.numcom, FV.contrib
```
