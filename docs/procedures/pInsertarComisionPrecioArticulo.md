# SP: pInsertarComisionPrecioArticulo
**Tipo**: Insertar
**Módulo**: Inventario
...
```sql
/**************************************************************************************************************
NOMBRE: pInsertarComisionPrecioArticulo
DESCRIPCION: 
CREADO POR: SOFTECH SISTEMAS
***************************************************************************************************************/
CREATE PROCEDURE [pInsertarComisionPrecioArticulo]
    (
      @sCo_Comip CHAR(6) ,
...
AS 
    BEGIN
        ...
        INSERT  INTO saComisionPrecioArticulo
                ( co_comip, des_comip, co_art, tipo_ven, aplica_en, co_precio, hasta1, hasta2, hasta3, hasta4, hasta5, porc1, porc2,
        ...
        OUTPUT  inserted.validador, inserted.fe_us_in, inserted.fe_us_mo, Inserted.rowguid
                INTO @TableTimestamp
        VALUES
                ( @sCo_Comip, @sDes_Comip, @sCo_Art, @sTipo_Ven, @sAplica_En, @sCo_Precio, @deHasta1, @deHasta2, @deHasta3, @deHasta4,
