# SP: pInsertarRenglonesRetenPago
**Tipo**: Insertar
**Módulo**: Fiscal
...
```sql
/**************************************************************************
*NOMBRE			:	pInsertarRenglonesRetenPago
*DESCRIPCIÓN	:	Inserta un registro de retencion relacionado a un documento de pago
*AUTOR			:	SOFTECH SISTEMAS
*MODIFICADO		:	SOFTECH SISTEMAS
***************************************************************************/

CREATE PROCEDURE [pInsertarRenglonesRetenPago]
    (
...
AS 
    BEGIN
        ...
        EXEC pInsertarPista @sUsuario_Id = @sCo_Us_In, @dtFecha = @dtFe_In, @sCo_Sucu = @sCo_Sucu_in,
            @sTablaOri = 'saPagoRentenReng', @rowguidOri = @rowGuidOri, @sTipo_Op = 'I', @sMaquina = @sMaquina,
