...
-- Description:	<Reporte de Notas de Entrega de Venta por Fecha>
-- =============================================
CREATE PROCEDURE [RepNotaEntregaVentaxFecha] 
...
-------------------------------
        SELECT
            @cAnulado AS Filtro_anulado, 'NOTA_ENT' AS tipo_rep, @cImprSubTotal AS SubTotales, CLI.tip_cli, CLI.cli_des,
