# SP: pValidarFacturaVentaRengCalculos
**Tipo**: Validar
**Módulo**: Ventas
...
-- Description:	<Validador Renglon de Facturas de Ventas con valores calculados.>
-- =============================================
CREATE PROCEDURE [dbo].[pValidarFacturaVentaRengCalculos]
    (
...
AS 
    BEGIN	
        ...
        DECLARE @HoraCorrida DATETIME
		 DECLARE @MontoDescPV DECIMAL (18,5) 
