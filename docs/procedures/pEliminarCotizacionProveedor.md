# SP: pEliminarCotizacionProveedor
**Tipo**: Eliminar
**Módulo**: Compras
...
```sql
/************************************************************************
*NOMBRE			:	pEliminarCotizacionProveedor
*DESCRIPCIÓN	:	Elimina una Cotizacion de compra segun su primary key
*AUTOR			:	SOFTECH SISTEMAS
*MODIFICADO POR	:	SOFTECH SISTEMAS
*************************************************************************/

CREATE PROCEDURE [pEliminarCotizacionProveedor]
    (
      @sDoc_NumOri CHAR(20) ,
...
AS 
	...
	--Eliminar Imagen de Cotización de Proveedor
        ...
        IF @dtFe_De IS NOT NULL 
			...
			-- Insertar Pista
                EXEC pInsertarPista @sUsuario_Id = @sCo_Us_Mo, @dtFecha = @dtFe_De, @sCo_Sucu = @sCo_Sucu_Mo,
                    @sTablaOri = 'saCotizacionProveedor',
```
