# SP: pInsertarRenglonesDocumentoVenta
**Tipo**: Insertar
**Módulo**: Ventas
...
***************************************************************************************************************/
CREATE PROCEDURE [dbo].[pInsertarRenglonesDocumentoVenta]
    (
      @iReng_Num INT ,
      @sCo_Tipo_Doc CHAR(6) ,
      @sNro_Doc CHAR(20) ,
...
AS 
    BEGIN
        ...
        INSERT  INTO saDocumentoVentaReng
                ( reng_num, co_tipo_doc, nro_doc, co_art, des_art, co_alma, co_uni, co_precio, total_art, prec_vta,
                  tipo_imp, tipo_imp2, tipo_imp3, monto_imp_afec_glob, monto_imp2_afec_glob, monto_imp3_afec_glob,
                  porc_imp, porc_imp2, porc_imp3, monto_i
```
