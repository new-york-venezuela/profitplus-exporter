# SP: pSeleccionarContabilizacionPlantillaVentaRenglon
**Tipo**: Seleccionar
**Módulo**: Inventario
...
-- Description:	<pSeleccionarContabilizacionPlantillaVentaRenglon>
-- =============================================
CREATE PROCEDURE [dbo].[pSeleccionarContabilizacionPlantillaVentaRenglon]
    (
...
AS 
    BEGIN
		...
		SELECT     FV.doc_num AS Co_Doc_Padre, FVR.reng_num AS Co_Doc, FV.fec_emis, MO.relacion AS mone_relacion,CL.co_cli AS Co_Auxiliar, CL.cli_des AS Descrip_Auxiliar, 
                      ...
                      FVR.lote_asignado, FVR.dis_cen AS dis_cen_saPlantillaVentaRenglon, FVR.co_us_in, FVR.co_sucu_in, FVR.fe_us_in, FVR.co_us_mo, FVR.co_sucu_mo, 
                      ...
                      CL.cli_des AS des_cliente, CL.co_cli AS Co_cliente, FV.tasa, li.dis_cen AS dis_cen_saLineaArticulo, ca.dis_cen AS dis_cen_saCatArticulo
		FROM         dbo.saPlantillaVentaReng AS FVR INNER JOIN
                      dbo.saPlantillaVenta AS FV ON FVR.doc_num = FV.doc_num INNER JOIN
