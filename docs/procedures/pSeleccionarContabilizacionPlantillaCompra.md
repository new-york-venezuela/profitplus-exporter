# SP: pSeleccionarContabilizacionPlantillaCompra
**Tipo**: Seleccionar
**Módulo**: Clientes
...
## Código (excerpt)
```sql
CREATE PROCEDURE [pSeleccionarContabilizacionPlantillaCompra]
    (
...
AS 
	 ...
	 */
        ...
        SELECT
            FV.doc_num AS Co_Doc, FV.Fec_Emis, FV.co_sucu_in AS Co_Sucu_Cont, CL.co_prov AS Co_Auxiliar, CL.prov_des AS Descr
```
