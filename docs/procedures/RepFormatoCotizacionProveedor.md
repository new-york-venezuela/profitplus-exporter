# SP: RepFormatoCotizacionProveedor
**Tipo**: Reporte
**Módulo**: Inventario
...
-- Description:	<Reporte de Formato de Cotizacion de Proveedor>
-- =============================================
CREATE PROCEDURE [dbo].[RepFormatoCotizacionProveedor]
...
AS 
    BEGIN
        ...
        SELECT
            ...
            FVR.fe_us_in, FVR.co_sucu_mo, FVR.co_us_mo, FVR.fe_us_mo, FVR.revisado, FVR.trasnfe,
```
