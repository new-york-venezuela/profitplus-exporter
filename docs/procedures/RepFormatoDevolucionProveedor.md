# SP: RepFormatoDevolucionProveedor
**Tipo**: Reporte
**Módulo**: Inventario
...
-- Description:	<Reporte de Formato de Devolucion de Proveedor>
-- =============================================
CREATE PROCEDURE [dbo].[RepFormatoDevolucionProveedor]
...
AS 
   BEGIN
        ...
        SELECT
            ...
            FVR.fe_us_in, FVR.co_sucu_mo, FVR.co_us_mo, FVR.fe_us_mo, FVR.revisado, FVR.trasn
```
