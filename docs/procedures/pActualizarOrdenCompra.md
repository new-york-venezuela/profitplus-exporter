...
*NOMBRE			:	pActualizarOrdenCompra
*DESCRIPCIÓN	:	Actualiza compra
*AUTOR			:	Softech
**************************************************************************/

CREATE PROCEDURE [dbo].[pActualizarOrdenCompra]
     (
      @sDoc_Num CHAR(20) ,
      @sDoc_NumOri CHAR(20) ,
      @sNro_Fact CHAR(20) ,
...
AS 
    BEGIN	
        ...
        UPDATE
            saOrdenCompra
        SET doc_num = @sDoc_Num, nro_fact = @sNro_Fact, descrip = @sDescrip, co_prov = @sCo
```
