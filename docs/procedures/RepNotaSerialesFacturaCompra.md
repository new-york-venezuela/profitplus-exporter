# SP: RepNotaSerialesFacturaCompra
**Tipo**: Reporte
**Módulo**: Inventario
...
-- Description:	<Reporte de Formato de Seriales en Factura de Compra>
-- =============================================
CREATE PROCEDURE [dbo].[RepNotaSerialesFacturaCompra]
...
AS 
    BEGIN
        ...
        SELECT
            ...
            FVR.porc_desc, FVR.num_doc, FVR.rowguid_doc, 
            FVR.total_art, FVR.stotal_art, 
			FVR.lote_asignado, FVR.monto_desc, FVR.pendiente, FVR.pendiente2, FVR.comentario,
            FVR.costo_adi1, FVR.costo_adi2, FVR.costo_adi3, FVR.dis_cen, FVR.co_sucu
```
