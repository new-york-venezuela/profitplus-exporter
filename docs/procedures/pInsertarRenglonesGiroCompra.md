# SP: pInsertarRenglonesGiroCompra
**Tipo**: Insertar
**Módulo**: General
...
```sql
/**************************************************************************************************************
NOMBRE		:pInsertarRenglonesGiroCompra
DESCRIPCION	: Inserta un registro de la tabla saGiroCompraReng
CREADO POR	: SOFTECH SISTEMAS

***************************************************************************************************************/
CREATE PROCEDURE [pInsertarRenglonesGiroCompra]
    (
      @iReng_Num INT ,
      @sco_Giro CHAR(20) ,
      @sCo_Tipo_Doc CHAR(6) ,
...
AS 
    BEGIN
        ...
        EXEC pInsertarPista @sUsuario_Id = @sCo_Us_In, @dtFecha = @dtFe_In, @sCo_Sucu = @sCo_Sucu_in,
            @sTablaOri = 'saGiroCompraReng', @rowguidOri = @rowGuidOri, @sTipo_Op = 'I', @sMaquina = @sMaquina,
            @sCampos = @sCo_Giro
