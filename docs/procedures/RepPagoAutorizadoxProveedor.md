# SP: RepPagoAutorizadoxProveedor
**Tipo**: Reporte
**Módulo**: Compras
...
-- Description:	<Pagos Autorizados por Proveedor>
-- =============================================
CREATE PROCEDURE [dbo].[RepPagoAutorizadoxProveedor]
...
AS 
    BEGIN
        ...
        WHERE
            ...
            AND ( DC.pagar = 1 ) --ORDER BY DATEDIFF(dd, 00, DC.fec_emis), DC.co_tipo_doc, DC.nro_doc
        ORDER BY
            P.co_prov, CASE @sDir
                         WHEN 'DESC' THEN CASE @sCampOrderBy
                                            WHEN 'num_doc' THEN DC.nro_doc
                                          END
                       END DESC, CASE @sDir
                                   WHEN 'DESC' THEN CASE @sCampOrde
```
