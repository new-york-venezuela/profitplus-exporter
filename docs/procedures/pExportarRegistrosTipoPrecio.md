# SP: pExportarRegistrosTipoPrecio
**Tipo**: Procedimiento
**Módulo**: General
...
CREATE PROCEDURE [dbo].[pExportarRegistrosTipoPrecio]
    (
	  @sCo_Precio			CHAR(6) ,
...
AS 
    BEGIN
		...
		SET @sSql = N'EXEC [' + @sempresa + '].[dbo].[pInsertarTipoPrecio]	
																		@sCo_Precio,
																		@sDes_Precio,
																		@bIncluye_Imp,
		...
		EXEC sp_executesql @sSql, N'@sCo_Precio CHAR(6),		@sDes_Precio VARCHAR(60),	@bIncluye_Imp BIT,
									...
									@sCo_Precio,				@sDes_Precio,				@bIncluye_Imp , 			
