...
-- Description:	<Formato de Plantillas de Venta >
-- =============================================
CREATE PROCEDURE [dbo].[RepFormatoPlantillaVenta] 
...
AS 
    ...
    -- Insert statements for procedure here
		...
		/*Campos saFacturaVentaReng*/ FVR.reng_num, FVR.doc_num, FVR.co_art, ISNULL(FVR.des_art, ART.art_des) as des_art, FVR.co_alma, FVR.total_art,
            ...
            FVR.monto_desc, FVR.tipo_imp, FVR.tipo_imp2, FVR.tipo_im
```
