...
-- Description:	<Reporte de Formato de Pedido de Venta (OM)>
-- =============================================
CREATE PROCEDURE [RepFormatoPedidoVentaOM] 
...
AS 
    ...
    -- Insert statements for procedure here
		...
		/*Campos saPedidoVenta*/ FV.doc_num, FV.descrip, FV.co_cli, FV.co_tran, FV.co_mone, FV.co_ven, FV.co_cond,
		...
		/*Campos saPedidoVentaReng*/ FVR.reng_num, FVR.doc_num, FVR.co_art,
