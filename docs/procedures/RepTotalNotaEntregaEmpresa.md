...
-- Description:	<Reporte de Total de Notas de Entrega de la Empresa>
-- =============================================
CREATE PROCEDURE [RepTotalNotaEntregaEmpresa]
...
AS 
    BEGIN
        ...
        SELECT
            ...
            NE.validador, NE.rowguid, NER.total_art, NER.coti, NER.monto_desc, NER.monto_desc_glob,
            NER.pendiente,
        ...
        FROM
            ...
            INNER JOIN ( SELECT DISTINCT
                            ...
                            SUM(pendiente) AS pendiente, SUM(otros1_glob) AS o
```
