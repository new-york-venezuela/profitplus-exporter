# SP: RepFormatoPlantillaCompraOM
**Tipo**: Reporte
**Módulo**: Inventario
...
-- Description:	<Reporte de Formato de Plantilla de Compra (OM)>
-- <Réplica de SP RepFormatoCompraOM>
-- =============================================
CREATE PROCEDURE [RepFormatoPlantillaCompraOM]
