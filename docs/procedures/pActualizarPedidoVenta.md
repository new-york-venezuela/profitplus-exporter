...
```sql
/************************************************************************
*NOMBRE			: pActualizarPedidoVenta
*DESCRIPCIÓN	: actualiza un Pedido de venta
*CREATE DATE    : 2011-12-12
*LASTUPDATE DATE: 2020-07-21
*AUTOR			: Softech
*************************************************************************/

CREATE PROCEDURE [dbo].[pActualizarPedidoVenta]
    (
      @sDoc_Num CHAR(20) ,
      @sDoc_NumOri CHAR(20) ,
      @sDescrip VARCHAR(60) ,
