# SP: pExportarRegistrosConfigArticulo
**Tipo**: Procedimiento
**Módulo**: Inventario
...
```sql
/**************************************************************************
*NOMBRE			:	pExportarRegistrosConfigArticulo
*DESCRIPCIÓN	:	Inserta una Configuración en la tabla saConfigArticulo
*AUTOR			:	SOFTECH SISTEMAS
***************************************************************************/
CREATE PROCEDURE [dbo].[pExportarRegistrosConfigArticulo]
    (
      @sCo_Config CHAR(6) ,
...
AS 
    BEGIN
		...
		SET @sSql = N'EXEC [' + @sempresa + '].[dbo].[pInsertarConfigArticulo]	
																		@sCo_Config,
																		@sDes_Config,
																		@sCo_Usuario,
																		@sCo_Mapa,
