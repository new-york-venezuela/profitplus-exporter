# SP: pActualizarComisionPrecioCategoria
**Tipo**: Actualizar
**Módulo**: General
...
```sql
/**************************************************************************************************************
NOMBRE: pActualizarComisionNivelCategoria
DESCRIPCION: 
CREADO POR: SOFTECH SISTEMAS
***************************************************************************************************************/
CREATE PROCEDURE [pActualizarComisionPrecioCategoria]
    (
      @sCo_Comip CHAR(6) ,
      @sCo_ComipOri CHAR(6) ,
...
AS 
    BEGIN
        ...
        SET co_comip = @sCo_Comip, des_comip = @sDes_Comip, tipo_ven = @sTipo_Ven, aplica_en = @sAplica_En, 
            co_precio = @sCo_Precio, co_cat = @sCo_Cat, hasta1 = @deHasta1, hasta2 = @deHasta2, hasta3 = @deHasta3, 
