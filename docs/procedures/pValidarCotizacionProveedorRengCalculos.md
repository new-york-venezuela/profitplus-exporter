# SP: pValidarCotizacionProveedorRengCalculos
**Tipo**: Validar
**Módulo**: Compras
...
-- Description:	Valida Consistencia en los renglones de Cotización Proveedores
-- =============================================
CREATE PROCEDURE [dbo].[pValidarCotizacionProveedorRengCalculos]
    (
                    ...
                    BEGIN
                        ...
                        FOR
                            ...
                            FROM
                                ...
                                INNER JOIN saCotizacionProveedor E ON E.doc_num = R.doc_num
```
