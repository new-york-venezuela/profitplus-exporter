# SP: pObtenerListadoDatosComisionRentCat
**Tipo**: Obtener
**Módulo**: General
...
AS 
    BEGIN	
		...
		ELSE 
          ...
          SET @SqlString = N'USE ' + CONVERT(NVARCHAR(100), @sDataBase_Name) + ' SELECT TOP(500) * FROM saComisionRentabCategoria
																				 WHERE '
