# SP: RepInfContableDevolucionProveedor
**Tipo**: Reporte
**Módulo**: Inventario
...
-- Description:	<Información Contable Devolución de Proveedor>
-- =============================================
CREATE PROCEDURE [dbo].[RepInfContableDevolucionProveedor]
...
BEGIN
  ...
  (Select A.doc_num, DEV.fec_emis, DEV.co_prov, (select prov_des from saProveedor where co_prov = DEV.co_prov) as prov_des, DEV.feccom, 
  DEV.numcom, A.num_carp, A.Descripcion, case when ltrim(A.monto) = '' then 0 else cast(A.monto as decimal(18,5)) end as monto, 
