# SP: pObtenerListadoDatosTransferenciaEntreCuentas
**Tipo**: Obtener
**Módulo**: Tesorería
...
```sql
/**************************************************************************************************************
NOMBRE: [pObtenerListadoDatosTransferenciaEntreCuentas]
DESCRIPCION: Obtiene la lista de documentos segun los parametros de entrada
CREADO POR: SOFTECH SISTEMAS
***************************************************************************************************************/
CREATE PROCEDURE [dbo].[pObtenerListadoDatosTransferenciaEntreCuentas]
    (
      ...
      @bAplica_CuentaOrigen			BIT					= NULL,
      @sCuentaOrigen				CHAR(6)				= NULL,
      
      @bAplica_CuentaDestino		BIT					= NULL,
      @sCuentaDestino				CHAR(6)				= NULL,
    ...
    BEGIN	
		...
		ELSE 
          ...
          SET @SqlString = N'USE ' + CONVERT(NVARCHAR(100), @sDataBase_Name) + ' SELECT TOP(500) *    
					   FROM ' + CONVERT(NVARCHAR(100), 'saTransferenciaEntreCuentas') + ' WHERE '
