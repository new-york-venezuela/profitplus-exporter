...
-- Description:	<Reporte de Notas de Despacho de Venta por Artículos 2>
-- =============================================
CREATE PROCEDURE [dbo].[RepNotaDespachoVentaxArt2] 
