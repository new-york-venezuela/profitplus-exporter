# SP: pInsertarComisionPrecioLinea
**Tipo**: Insertar
**Módulo**: General
...
```sql
/**************************************************************************************************************
NOMBRE: pInsertarComisionPrecioLinea
DESCRIPCION: 
CREADO POR: SOFTECH SISTEMAS
***************************************************************************************************************/
CREATE PROCEDURE [pInsertarComisionPrecioLinea]
    (
      @sCo_Comip CHAR(6) ,
...
AS 
    BEGIN
        ...
        INSERT  INTO saComisionPrecioLinea
                ( co_comip, des_comip, tipo_ven, aplica_en, co_precio, co_lin, hasta1, hasta2, hasta3, hasta4, hasta5, porc1, porc2,
        ...
        OUTPUT  inserted.validador, inserted.fe_us_in, inserted.fe_us_mo, Inserted.rowguid
                INTO @TableTimestamp
        VALUES
                ( @sCo_Comip, @sDes_Comip, @sTipo_Ven, @sAplica_En, @sCo_Precio, @sCo_Lin, @deHasta1, @deHasta2, @deHasta3, @deHasta4,
                  @deHasta5, @dePorc1, @dePorc2, @dePorc3, @dePorc4, @dePorc5, @dePorc6, @sCampo1, @sCampo2, @sCampo3,
                  @sCampo4, @sCampo5, @sCampo6, @sCampo7, @sCampo8, @sCo_Us_In, GETDATE(), @sCo_Us_In
```
