# SP: RepDevolucionProveedorxReng
**Tipo**: Reporte
**Módulo**: Inventario
...
-- Description:	<Reporte de Devolucion de Proveedores con sus Renglones>
-- =============================================
CREATE PROCEDURE [dbo].[RepDevolucionProveedorxReng]
...
-------------------------------
        ...
        SELECT
            @cAnulado AS Filtro_anulado, 'devo' AS tip_rep, ART.art_des, ART.modelo, ART.co_lin, ART.co_subl, ART.co_cat,
            ...
            FC.co_sucu_mo, FC.fe_us_mo, FC.revisado, FC.trasnfe, FC.validador, FC.rowguid, FVR.reng_num, FVR.do
```
