# SP: pActualizarEncabezadoImpuestoSobreVenta
**Tipo**: Actualizar
**Módulo**: Fiscal
...
-- =============================================
CREATE PROCEDURE [dbo].[pActualizarEncabezadoImpuestoSobreVenta]
    (
      --@iajue_num int,
...
AS 
	...
	--WHERE ajue_num = @iajue_num AND validador = @tsValidador
        WHERE
            rowguid = @gRowguid
        ...
        IF @dtFe_In IS NOT NULL 
			...
			-- Insertar Pista
                EXEC [pInsertarPista] @sUsuario_Id = @sCo_Us_Mo, @dtFecha = @dtFe_In, @sCo_Sucu = @sCo_Sucu_Mo,
                    @sTablaOri = '', @rowguidOri = @rowGuidOri, @sTipo_Op = 'M', @sMaquina = @sMaquina,
