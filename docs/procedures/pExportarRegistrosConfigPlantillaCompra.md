# SP: pExportarRegistrosConfigPlantillaCompra
**Tipo**: Procedimiento
**Módulo**: General
...
```sql
/**************************************************************************
*NOMBRE			:	pExportarRegistrosConfigPlantillaCompra
*DESCRIPCIÓN	:	Inserta una Configuración en la tabla saConfigPlantillaCompra
*AUTOR			:	SOFTECH SISTEMAS
***************************************************************************/
CREATE PROCEDURE [dbo].[pExportarRegistrosConfigPlantillaCompra]
    (
      @sCo_Config CHAR(6) ,
...
AS 
    BEGIN
		...
		SET @sSql = N'EXEC [' + @sempresa + '].[dbo].[pInsertarConfigPlantillaCompra]	
																		@sCo_Config,
																		@sDes_Config,
																		@sCo_Usuario,
																		@sCo_Mapa,
