# SP: pActualizarRenglonesDevolucionCliente
**Tipo**: Actualizar
**Módulo**: Ventas
...
DESCRIPCION	: Actualiza un registro de la tabla saDevolucionClienteReng
CREADO POR	: SOFTECH SISTEMAS
***************************************************************************************************************/
CREATE PROCEDURE [dbo].[pActualizarRenglonesDevolucionCliente]
    (
      @iReng_Num INT ,
      @sDoc_Num CHAR(20) ,
      @iReng_NumOri INT ,
