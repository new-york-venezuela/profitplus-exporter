# SP: pSeleccionarContabilizacionOrdenCompra
**Tipo**: Seleccionar
**Módulo**: Compras
...
## Código (excerpt)
```sql
CREATE PROCEDURE [pSeleccionarContabilizacionOrdenCompra]
    (
...
AS 
	 ...
	 * NOTA 1.1: Lo que vaya a ser la descripcion del auxiliar se le debe poner el alias Descrip_Auxiliar
	 ...
	 */
		...
		SELECT     FV.doc_num AS Co_Doc, FV.fec_emis, FV.co_sucu_in AS Co_Sucu_Cont, CL.co_prov AS Co_Auxiliar, CL.prov_des AS Descrip_Auxiliar, FV.des
```
