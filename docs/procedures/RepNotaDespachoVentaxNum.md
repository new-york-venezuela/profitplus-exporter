...
-- Description:	<Reporte de Notas de Despacho de Ventas por Número>
-- =============================================
CREATE PROCEDURE [dbo].[RepNotaDespachoVentaxNum] 
...
-------------------------------
        SELECT
            @cAnulado AS Filtro_anulado, 'NOTA_DES' AS tipo_rep, CLI.tip_cli, CLI.cli_des, CLI.co_zon,
