# SP: pInsertarConfigPlantillaCompra
**Tipo**: Insertar
**Módulo**: General
...
```sql
/************************************************************************
*NOMBRE			:pInsertarConfigPlanillaCompra
*DESCRIPCIÓN	: Inserta una Configuración en la tabla saConfigPlanillaCompra
*AUTOR			: SOFTECH SISTEMAS
*************************************************************************/
CREATE PROCEDURE [pInsertarConfigPlantillaCompra]
    (
      @sCo_Config CHAR(6) ,
...
AS 
    BEGIN
        ...
        INSERT  INTO saConfigPlantillaCompra
        ...
        EXEC [pInsertarPista] @sUsuario_Id = @sCo_Us_In, @dtFecha = @dtFe_In, @sCo_Sucu = @sCo_Sucu_in,
            @sTablaOri = 'saConfigPlantillaCompra', @rowguidOri = @rowGuidOri, @sTipo_O
```
