...
-- Description:	<Reporte de Factura de Ventas con sus Imagenes>
-- =============================================
CREATE PROCEDURE [dbo].[RepFacturaVentaConImagenes] 
	...
	@cCo_Vend_d CHAR(6) = NULL ,
    @cCo_Vend_h CHAR(6) = NULL ,
...
-------------------------------
        ...
        SELECT
            @cAnulado AS Filtro_anulado, 'fact' AS tip_rep, FV.doc_num, FV.descrip, FV.co_cli, FV.co_tran, FV.co_mone, FV.co_ven, FV.co_cond,
            FV.fec_emis, FV.fec_venc, FV.rowguid, CL.cli_des, VE.ven_des, TR.des_tran, CP.cond_des,
