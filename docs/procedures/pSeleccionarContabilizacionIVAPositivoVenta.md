# SP: pSeleccionarContabilizacionIVAPositivoVenta
**Tipo**: Seleccionar
**Módulo**: Ventas
...
```sql
/**************************************************************************************************************
NOMBRE		: pSeleccionarContabilizacionIVAPositivoVenta
DESCRIPCION	: Seleccionar los Documentos IVA Positivo para Contabilización No Contabilizados.
CREADO POR	: SOFTECH SISTEMAS
FECHA CREACIÓN: <2019-11-21>
***************************************************************************************************************/
CREATE PROCEDURE [dbo].[pSeleccionarContabilizacionIVAPositivoVenta]
    (
