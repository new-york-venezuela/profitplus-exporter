# SP: pObtenerListadoDatosCampoAdicional
**Tipo**: Obtener
**Módulo**: General
...
```sql
/**************************************************************************************************************
NOMBRE: [pObtenerListadoDatosCampoAdicional]
DESCRIPCION: Obtiene la lista de documentos segun los parametros de entrada
CREADO POR: SOFTECH SISTEMAS
***************************************************************************************************************/
CREATE PROCEDURE [dbo].[pObtenerListadoDatosCampoAdicional]
    (
      ...
      @bReg_Sistema					BIT					= NULL,
      
      @bAplica_Grupo				BIT					= NULL,
      @sGrupo						VARCHAR(8)			= NULL,
      
	  @bAplica_Tipo_Dato			BIT					= NULL,
      @sTipo_Dato					CHAR(1)				= NULL,
    ...
    BEGIN	
		...
		ELSE 
          ...
          SET @SqlString = N'USE ' + CONVERT(NVARCHAR(100), @sDataBase_Name) + ' SELECT TOP(500) *    
					   FROM ' + CONVERT(NVARCHAR(100), 'saAdiCampo') + ' WHERE '
