# SP: RepFormatoDevolucionProvCaracteristica
**Tipo**: Reporte
**Módulo**: Inventario
...
/*=============================================
 ...
 Description:	<Formato de Devolucion de Prov. con su Caracteristica>
 =============================================*/ 
CREATE PROCEDURE [dbo].[RepFormatoDevolucionProvCaracteristica]
...
AS 
    BEGIN
       ...
       select 
		e.co_prov, prov.prov_des, prov.rif, prov.telefonos, prov.direc1, 
		...
		r.co_uni, r.cost_unit, r.porc_desc, r.monto_desc, r.porc_imp, r.monto_imp, r.reng_neto, v.cantidad*-1 as 'CantidadCaracteristica',
		...
		e.total_bruto, e.monto_imp, e.monto_desc_glob, e.monto_reca, e.otros1, e.otros2, e.otros3, e.total_neto, E.porc_reca,E.porc_desc_glob, r.reng_num
	   from saDevolucionProveedor E
	   inner join saDevolucionProveedorReng R on e.doc_num = r.doc_num 
	   left join savArtCaracteristicaDPRO V on r.doc_num = v.num_doc and r.reng_num = v.reng_num 
