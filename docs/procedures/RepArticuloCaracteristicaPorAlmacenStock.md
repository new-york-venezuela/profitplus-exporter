# SP: RepArticuloCaracteristicaPorAlmacenStock
**Tipo**: Reporte
**Módulo**: Inventario
...
```sql
/**************************************************************************************************************
NOMBRE: RepArticuloCaracteristicaPorAlmacenStock
DESCRIPCION: Articulos con sus Caracteristicas por Almacen por sus Stocks
CREADO POR: SOFTECH SISTEMAS
LAST DATE:2017-06-27
***************************************************************************************************************/ 
CREATE PROCEDURE [dbo].[RepArticuloCaracteristicaPorAlmacenStock]
...
Select  ALM.co_alma as co_almacen, ALM.des_alma as des_almacen,
              P.co_art, P.art_des,
              AU.co_uni, U.des_uni, 
  ...
  From 
  saAlmacen ALM
  CROSS JOIN [dbo].[saArtCaracteristica] A 
