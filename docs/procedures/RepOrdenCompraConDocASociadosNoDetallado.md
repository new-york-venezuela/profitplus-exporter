# SP: RepOrdenCompraConDocASociadosNoDetallado
**Tipo**: Reporte
**Módulo**: Compras
...
-- Create date: <17-08-16>
-- Description:	<Ordenes de compra con sus Documentos Asociados (No Detallado)>
-- =============================================
CREATE PROCEDURE [dbo].[RepOrdenCompraConDocASociadosNoDetallado]
        ...
        FROM
            ( SELECT 
              ...
              FROM
                ...
                INNER JOIN saProveedor AS PV ON C.co_prov = PV.co
```
