...
-- Description:	<Reporte de Notas de Pedidos de Venta por Renglones>
-- =============================================
CREATE PROCEDURE [dbo].[RepPedidoVentaxReng] 
...
-------------------------------
        ...
        SELECT
            @cAnulado AS Filtro_anulado, 'pedi' AS tip_rep, ART.art_des, ART.modelo, ART.co_lin, ART.co_subl, ART.co_cat,
