...
/*=============================================
 ...
 Description:	<Reporte Ordenes de Pago por Beneficiario>
 =============================================*/
CREATE PROCEDURE [RepOrdenPagoxBeneficiario]
...
AS 
    BEGIN
        ...
        SELECT
            OP.pagar, OP.*, OPR.*, BE.cod_ben, BE.ben_des
        FROM
            saOrdenPago AS OP
