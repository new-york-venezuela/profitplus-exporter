# SP: pActualizarRenglonesNotaEntregaVenta
**Tipo**: Actualizar
**Módulo**: Ventas
...
DESCRIPCION	: Actualiza un registro de la tabla saNotaEntregaVentaReng
CREADO POR	: SOFTECH SISTEMAS
***************************************************************************************************************/
CREATE PROCEDURE [dbo].[pActualizarRenglonesNotaEntregaVenta]
    (
      @iReng_Num INT ,
      @sDoc_Num CHAR(20) ,
      @iReng_NumOri INT ,
