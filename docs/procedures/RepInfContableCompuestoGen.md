...
-- Description:	<Información Contable Generación de Compuesto>
-- =============================================
CREATE PROCEDURE [dbo].[RepInfContableCompuestoGen]
	@sGene_Num_d CHAR(20) = NULL,
	@sGene_Num_h CHAR(20) = NULL,
...
BEGIN
 ...
 (Select A.gene_num, COM.fecha, COM.feccom, COM.numcom, A.num_carp, A.Descripcion, 
  case when ltrim(A.monto) = '' then 0 else cast(A.monto as decimal(18,5)) end as monto, A.co_cue, A.co_gas, A.co_cen, A.des_cen, 
  case when ltrim(A.porc) = '' then 0 else cast(A.porc as decimal(18,5)) end as porc, 
 ...
 Select	A.gene_num, A.feccom, '01' as num_carp,
