# SP: pActualizarConfigPlantillaCompra
**Tipo**: Actualizar
**Módulo**: General
...
```sql
/**************************************************************************
*NOMBRE			: pActualizarConfigPlantillaCompra
*DESCRIPCIÓN	: Actualiza la configuracion del proceso Plantilla Compra
*AUTOR			: SOFTECH SISTEMAS
**************************************************************************/

CREATE PROCEDURE [pActualizarConfigPlantillaCompra]
    (
      @sCo_Config CHAR(6) ,
