# SP: pExportarRegistrosConfigCliente
**Tipo**: Procedimiento
**Módulo**: Clientes
...
```sql
/**************************************************************************
*NOMBRE			:	pExportarRegistrosConfigCliente
*DESCRIPCIÓN	:	Inserta una Configuración en la tabla saConfigCliente
*AUTOR			:	SOFTECH SISTEMAS
***************************************************************************/
CREATE PROCEDURE [dbo].[pExportarRegistrosConfigCliente]
    (
      @sCo_Config CHAR(6) ,
...
AS 
    BEGIN
		...
		SET @sSql = N'EXEC [' + @sempresa + '].[dbo].[pInsertarConfigCliente]	
																		@sCo_Config,
																		@sDes_Config,
																		@sCo_Usuario,
																		@sCo_Mapa,
