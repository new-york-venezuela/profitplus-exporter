...
```sql
/************************************************************************
*NOMBRE			: pInsertarConfigPedidoVenta
*DESCRIPCIÓN	: Inserta una Configuración en la tabla saConfigPedidoVenta
*AUTOR			: SOFTECH SISTEMAS
*************************************************************************/

CREATE PROCEDURE [pInsertarConfigPedidoVenta]
    (
      @sCo_Config CHAR(6) ,
...
AS 
    BEGIN
        ...
        INSERT  INTO saConfigPedidoVenta
        ...
        EXEC [pInsertarPista] @sUsuario_Id = @sCo_Us_In, @dtFecha = @dtFe_In, @sCo_Sucu = @sCo_Sucu_in,
            @sTablaOri = 'saConfigPedidoVenta', @rowguidOri = @rowGuidOri, @sTipo_Op = 'I', @sMaqu
```
