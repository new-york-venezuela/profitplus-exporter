...
DESCRIPCION	: Elimina un registro de la tabla saDepositoBanco
CREADO POR	: SOFTECH SISTEMAS
***************************************************************************************************************/
CREATE PROCEDURE [pEliminarDepositoBanco]
    (
      @sDep_NumOri CHAR(20) ,
        ...
        IF @dtFe_De IS NOT NULL 
			...
			-- Insertar Pista
                EXEC [pInsertarPista] @sUsuario_Id = @sCo_Us_Mo, @dtFecha = @dtFe_De, @sCo_Sucu = @sCo_Sucu_Mo,
                    @sTablaOri = 'saDepositoBanco', @rowguidOri
```
