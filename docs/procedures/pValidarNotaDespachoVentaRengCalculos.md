# SP: pValidarNotaDespachoVentaRengCalculos
**Tipo**: Validar
**Módulo**: Ventas
...
-- Description:	<Valida la consistencia de las Notas de Despacho de los renglones de venta>
-- =============================================
CREATE PROCEDURE [dbo].[pValidarNotaDespachoVentaRengCalculos]
    (
