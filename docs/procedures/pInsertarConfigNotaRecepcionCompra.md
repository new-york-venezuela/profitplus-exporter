# SP: pInsertarConfigNotaRecepcionCompra
**Tipo**: Insertar
**Módulo**: Compras
...
```sql
/************************************************************************
*NOMBRE			:pInsertarConfigNotaRecepcionCompra
*DESCRIPCIÓN	: Inserta una Configuración en la tabla saConfigNotaRecepcionCompra
*AUTOR			: SOFTECH SISTEMAS
*************************************************************************/
CREATE PROCEDURE [pInsertarConfigNotaRecepcionCompra]
    (
      @sCo_Config CHAR(6) ,
...
AS 
    BEGIN
        ...
        INSERT  INTO saConfigNotaRecepcionCompra
        ...
        EXEC [pInsertarPista] @sUsuario_Id = @sCo_Us_In, @dtFecha = @dtFe_In, @sCo_Sucu = @sCo_Sucu_in,
            @sTablaOri = 'saConfigNotaRecepcionCompra', @rowguidOri =
```
