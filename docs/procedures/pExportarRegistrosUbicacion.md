# SP: pExportarRegistrosUbicacion
**Tipo**: Procedimiento
**Módulo**: General
...
***************************************************************************/
CREATE PROCEDURE [dbo].[pExportarRegistrosUbicacion]
    (
...
AS 
    BEGIN
		...
		SET @sSql = N'EXEC [' + @sempresa + '].[dbo].[pInsertarUbicacion]	
																		@sCo_Ubicacion,
																		@sDes_Ubicacion,
		...
		EXEC sp_executesql @sSql, N'@sCo_Ubicacion CHAR(6),		@sDes_Ubicacion VARCHAR(60),	
