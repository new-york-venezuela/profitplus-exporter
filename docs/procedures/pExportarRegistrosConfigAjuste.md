# SP: pExportarRegistrosConfigAjuste
**Tipo**: Procedimiento
**Módulo**: Inventario
...
```sql
/**************************************************************************
*NOMBRE			:	pExportarRegistrosConfigAjuste
*DESCRIPCIÓN	:	Inserta una Configuración en la tabla saConfigAjuste
*AUTOR			:	SOFTECH SISTEMAS
***************************************************************************/

CREATE PROCEDURE [dbo].[pExportarRegistrosConfigAjuste]
    (
      @sCo_Config CHAR(6) ,
...
AS 
    BEGIN
		...
		SET @sSql = N'EXEC [' + @sempresa + '].[dbo].[pInsertarConfigAjuste]	
																		@sCo_Config,
																		@sDes_Config,
																		@sCo_Usuario,
																		@sCo_Mapa,
