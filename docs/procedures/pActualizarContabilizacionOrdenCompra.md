# SP: pActualizarContabilizacionOrdenCompra
**Tipo**: Actualizar
**Módulo**: Compras
...
DESCRIPCION: Actualizar la contabilizacion de Orden de compra
CREADO POR: SOFTECH SISTEMAS
CREADO EL: 11/06/2010
**************************************************************************************************/
CREATE PROCEDURE [pActualizarContabilizacionOrdenCompra]
    (
      @sCo_Doc CHAR(20) ,
...
AS 
	...
	-- Insertar Pista
        EXEC [pInsertarPista] @sUsuario_Id = @sCo_Us_Mo, @dtFecha = @dtFe_In, @sCo_Sucu = @sCo_Sucu_Mo,
            @sTablaOri = 'saOrdenCompra', @rowguidOri = @rowGuidOri, @sTipo_Op = 'M', @sMaquina = @sMaquina,
            @sCampos = @campo
