# SP: pValidarPendienteFacturaVentaReng
**Tipo**: Validar
**Módulo**: Ventas
...
## Código (excerpt)
```sql
CREATE PROCEDURE [pValidarPendienteFacturaVentaReng]
    (
                ...
                ( SELECT
                  ...
                  FROM
                    ...
                    LEFT JOIN ( SELECT
                                ...
                                FROM
                                    ( SELECT
                                        SUM(R.pendiente) AS total_art, R.rowguid_doc
                                      FROM
