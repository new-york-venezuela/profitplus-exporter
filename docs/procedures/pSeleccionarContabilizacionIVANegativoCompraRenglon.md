# SP: pSeleccionarContabilizacionIVANegativoCompraRenglon
**Tipo**: Seleccionar
**Módulo**: Inventario
...
```sql
/**************************************************************************************************************
NOMBRE		pSeleccionarContabilizacionIVANegativoCompraRenglon
DESCRIPCION	:Selecciona los documentos de IVA negativo en compras por renglon no contabilizados
CREADO POR	:SOFTECH SISTEMAS
CREADO EL	:2019/11/21
***************************************************************************************************************/
CREATE PROCEDURE [dbo].[pSeleccionarContabilizacionIVANegativoCompraRenglon]
    (
