# SP: pValidarPedidoVentaRengCalculos
**Tipo**: Validar
**Módulo**: Ventas
...
-- Description:	Validar Consistencia en los renglones del Pedido de Venta
-- =============================================
CREATE PROCEDURE [dbo].[pValidarPedidoVentaRengCalculos]
    (
...
AS 
    BEGIN	
        ...
        DECLARE @pMontoOri DECIMAL(18, 2)
