# SP: pSeleccionarContabilizacionNotaDebitoVentaRenglon
**Tipo**: Seleccionar
**Módulo**: Inventario
...
-- Description:	<pSeleccionarContabilizacionNotaDebitoVentaRenglon>
-- =============================================
CREATE PROCEDURE [dbo].[pSeleccionarContabilizacionNotaDebitoVentaRenglon]
    (
...
AS 
    BEGIN
        SELECT     DV.nro_doc AS Co_Doc_Padre, DVR.reng_num AS Co_Doc, CASE WHEN DV.fec_emis > DV.fec_reg THEN DV.fec_emis ELSE DV.fec_reg END as fec_Emis, MO.relacion AS mone_relacion, CL.co_cli AS Co_Auxiliar, CL.cli_des AS Descrip_Auxiliar, 
                      ...
                      DV.tasa, li.dis_cen AS dis_cen_saLineaArticulo, ca.dis_cen AS dis_cen_saCatArticulo
