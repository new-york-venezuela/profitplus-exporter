...
```sql
/**************************************************************************
*NOMBRE			: pActualizarUbicacion
*DESCRIPCIÓN	: Actualiza una Ubicacion
*AUTOR			: Softech Sistemas
**************************************************************************/

CREATE PROCEDURE [pActualizarUbicacion]
    (
...
AS 
    BEGIN	
        ...
        UPDATE
            saUbicacion
        SET co_ubicacion = @sCo_Ubicacion, des_ubicacion = @sDes_Ubicacion, campo1 = @sCampo1, campo2 = @sCampo2,
        ...
        IF @dtFe_In IS NOT NULL 
			...
			-- Insertar Pista
                EXEC [pInsertarPista] @sUsuario_Id = @sCo_Us_Mo, @dtFecha = @dtFe_In, @sCo_Sucu = @sCo_Sucu_Mo,
                    @sTablaOri = 'saUbicacion', @rowguidOri = @rowGuidOri, @sTipo_Op = 'M', @sMaquina = @sMaquina,
                    @sCampos = @sCampos
            END
