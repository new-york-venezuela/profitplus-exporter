# SP: pInsertarDevolucionProveedor
**Tipo**: Insertar
**Módulo**: Compras
...
*NOMBRE			: pInsertarDevolucionProveedor
*DESCRIPCIÓN	: Inserta una devolucion
*AUTOR			: SOFTECH SISTEMAS
*************************************************************************/
CREATE PROCEDURE [dbo].[pInsertarDevolucionProveedor]
    (
      @sDoc_Num CHAR(20) ,
      @sNro_Fact CHAR(20) ,
...
AS 
    BEGIN
        ...
        INSERT  INTO saDevolucionProveedor
                ( doc_num, nro_fact, descrip, co_prov, co_mone, co_cond, n_control, porc_desc_g
```
