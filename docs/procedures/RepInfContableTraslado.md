...
-- Description:	<Información Contable de Traslado>
-- =============================================
CREATE PROCEDURE [dbo].[RepInfContableTraslado]
...
BEGIN
  ...
  (Select A.tras_num, TRAS.fecha, TRAS.feccom, TRAS.numcom, A.num_carp, A.Descripcion, 
 ...
 Select	A.tras_num, A.feccom, '01' as num_carp,
...
from	saTraslado A
		outer apply A.dis_cen.nodes('InformacionContable/Carpeta01/DistribucionCentros/C
```
