# SP: RepNotaSerialesNotaRecepcion
**Tipo**: Reporte
**Módulo**: Inventario
...
-- =============================================
CREATE PROCEDURE [dbo].[RepNotaSerialesNotaRecepcion]
...
AS 
   BEGIN
        ...
        SELECT
            ...
            FVR.fe_us_in, FVR.co_sucu_mo, FVR.co_us_mo, FVR.fe_us_mo, FVR.revisado, FVR.
```
