# SP: RepFormatoNotaRecepcionCompra
**Tipo**: Reporte
**Módulo**: Inventario
...
-- Description:	<Reporte de Formato de Nota de Recepcion de Compra>
-- =============================================
CREATE PROCEDURE [dbo].[RepFormatoNotaRecepcionCompra]
...
AS 
   BEGIN
        ...
        SELECT
            ...
            FVR.fe_us_in, FVR.co_sucu_mo, FVR.co_us_mo, FVR.fe_us_mo, FVR.revisado, FVR.t
```
