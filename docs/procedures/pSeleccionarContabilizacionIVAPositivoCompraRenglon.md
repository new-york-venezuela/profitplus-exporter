# SP: pSeleccionarContabilizacionIVAPositivoCompraRenglon
**Tipo**: Seleccionar
**Módulo**: Inventario
...
```sql
/**************************************************************************************************************
NOMBRE		:pSeleccionarContabilizacionIVAPositivoCompraRenglon
DESCRIPCION	:Selecciona los documentos de IVA positivo en compras por renglon no contabilizados
CREADO POR	:SOFTECH SISTEMAS
CREADO EL	:2019/11/21
***************************************************************************************************************/
CREATE PROCEDURE [dbo].[pSeleccionarContabilizacionIVAPositivoCompraRenglon]
    (
...
AS 
    BEGIN
		...
		FROM         dbo.saArticulo AS AR INNER JOIN
                      ...
                      dbo.saMoneda AS MO ON DV.co_mone = MO.co_mone LEFT OUTER
```
