...
-- Description:	<Reporte de Notas de Entrega de Ventas por Número>
-- =============================================
CREATE PROCEDURE [dbo].[RepNotaEntregaVentaxNum] 
...
-------------------------------
        SELECT
            @cAnulado AS Filtro_anulado, 'NOTA_ENT' AS tipo_rep, CLI.tip_cli, CLI.cli_des, CLI.co_zon,
