# SP: pValidarFacturaVentaCalculos
**Tipo**: Validar
**Módulo**: Ventas
...
## Código (excerpt)
```sql
CREATE PROCEDURE [dbo].[pValidarFacturaVentaCalculos]
    (
...
AS 
	...
	-- Total Bruto (Versus renglones)
        ...
        WHILE @@FETCH_STATUS = 0 
            BEGIN
                SET @PistaMensaje = 'La factura de venta nro. "' + RTRIM(@pDoc_Num) + '" tiene como valor total bruto "'
