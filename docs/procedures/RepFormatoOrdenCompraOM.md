...
-- Description:	<Reporte de Formato de Órden de Compra (OM)>
-- <Réplica de SP RepFormatoCompraOM>
-- =============================================
CREATE PROCEDURE [dbo].[RepFormatoOrdenCompraOM]
...
AS 
    BEGIN
        ...
        SELECT
            ...
            FC.monto_imp3 / FC.tasa AS monto_imp3, FC.anulado, FC.impresa, /*FC.seriales_e,*/ FC.salestax, FC.dis_cen,
