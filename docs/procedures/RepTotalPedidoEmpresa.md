...
-- Description:	<Reporte de Total de Pedidos de la Empresa>
-- =============================================
CREATE PROCEDURE [RepTotalPedidoEmpresa]
...
AS 
    BEGIN
        ...
        SELECT
            ...
            PV.validador, PV.rowguid, PVR.total_art, PVR.coti, PVR.monto_desc, PVR.monto_desc_glob,
            PVR.pendiente,
