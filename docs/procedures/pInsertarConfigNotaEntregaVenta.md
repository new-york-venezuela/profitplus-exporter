# SP: pInsertarConfigNotaEntregaVenta
**Tipo**: Insertar
**Módulo**: Ventas
...
```sql
/************************************************************************
*NOMBRE			:pInsertarConfigNotaEntregaVenta
*DESCRIPCIÓN	: Inserta una Configuración en la tabla saConfigNotaEntregaVenta
*AUTOR			: SOFTECH SISTEMAS
*************************************************************************/

CREATE PROCEDURE [pInsertarConfigNotaEntregaVenta]
    (
      @sCo_Config CHAR(6) ,
...
AS 
    BEGIN
        ...
        INSERT  INTO saConfigNotaEntregaVenta
        ...
        EXEC [pInsertarPista] @sUsuario_Id = @sCo_Us_In, @dtFecha = @dtFe_In, @sCo_Sucu = @sCo_Sucu_in,
            @sTablaOri = 'saConfigNotaEntregaVenta', @rowguidOri = @rowGuidOri,
```
