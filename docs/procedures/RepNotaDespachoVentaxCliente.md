# SP: RepNotaDespachoVentaxCliente
**Tipo**: Reporte
**Módulo**: Ventas
...
-- Description:	<Reporte de Notas de Despacho de Venta por Cliente>
-- =============================================
CREATE PROCEDURE [dbo].[RepNotaDespachoVentaxCliente] 
...
-------------------------------
        ...
        SELECT
            @cAnulado AS Filtro_anulado, 'NOTA_DES' AS tipo_rep, CLI.tip_cli, CLI.cli_des, CLI.co_zon, CLI.co_seg,
		/*Campos saFacturaVenta*/ FV.doc_num, FV.descrip, FV.co_cli, FV.co_tran, FV.co_mone, FV.co_ven,
