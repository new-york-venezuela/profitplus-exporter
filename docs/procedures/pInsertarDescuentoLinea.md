...
***************************************************************************************************************/
CREATE PROCEDURE [dbo].[pInsertarDescuentoLinea]
    (
      @sCo_Desc CHAR(6) ,
...
AS 
    BEGIN
        ...
        INSERT  INTO saDescLinea
                ( co_desc, des_des, tip_cli, co_lin, hasta1, hasta2, hasta3, hasta4, hasta5, porc1, porc2, porc3, porc4,
        ...
        OUTPUT  inserted.validador, inserted.fe_us_in, inserted.fe_us_mo, Inserted.rowguid uniqueidentifier
                INTO @TableTimestamp
        VALUES
                ( @sCo_Desc, @sDes_Des, @sTip_Cli, @sCo_Lin, @deHasta1, @deHasta2, @deHasta3, @deHasta4, @deHasta5,
                  @dePorc1, @dePorc2, @dePorc3, @dePorc4, @dePorc5, @dePorc6
```
