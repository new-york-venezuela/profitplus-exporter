# SP: pActualizarSaldoFacturaCompra
**Tipo**: Actualizar
**Módulo**: Compras
...
```sql
/*********************************************************************
*NOMBRE			:	pActualizarSaldoFacturaCompra
*DESCRIPCIÓN	:	Actualizar el Saldo de una Factura de Compra
*AUTOR			:	SOFTECH SISTEMAS
*********************************************************************/

CREATE PROCEDURE [pActualizarSaldoFacturaCompra]
    (
      @sNro_Doc CHAR(20) ,
...
AS 
	...
	-- Insertar Pista
        EXEC pInsertarPista @sUsuario_Id = @sCo_Us_Mo, @dtFecha = @dtFe_In, @sCo_Sucu = @sCo_Sucu_Mo,
            @sTablaOri = 'saFacturaCompra', @rowguidOri = @rowGuidOri, @sTipo_Op = 'M', @sMaquina = @sMaquina,
            @sCampos = @campo
