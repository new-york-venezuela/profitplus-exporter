...
-- Description:	<Reporte de Factura de Compras por Artículos 2>
-- =============================================
CREATE PROCEDURE [RepCompraxArt2]
...
-------------------------------
        ...
        FROM
            ( SELECT
                ...
                ROUND(dbo.ArtUnidadBase(FVR.co_art, FVR.co_uni, FVR.total_art), 2) AS total_art,
                ROUND(( FVR.otros1_glob + FVR.otros2_glob + FVR.otros3_glob ), 2) AS otros,
                ROUND(( ( FVR.cost_unit * FVR.total_art ) - FVR.monto_desc - FVR.monto_desc_glob + FVR.monto_reca_glob ),
                      2) AS monto_base, ART.art_d
```
