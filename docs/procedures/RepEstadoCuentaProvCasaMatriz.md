# SP: RepEstadoCuentaProvCasaMatriz
**Tipo**: Reporte
**Módulo**: Tesorería
...
-- =============================================
CREATE  PROCEDURE [dbo].[RepEstadoCuentaProvCasaMatriz]
            ...
            FROM
                ( SELECT   DISTINCT
                    ...
                    END AS tot_debe, ( CASE WHEN TD.tipo_mov = 'CR' THEN DC.total_neto
                                            ELSE 0.00
                                       END ) AS tot_haber, ISNULL(P.matriz, P.co_prov) AS co_prov, P.prov_des,
                    DC.co_mone, DC.anulado, '' AS ORIG, DC.observa, '' AS n_pago
                  FROM
                    saDocumentoCompra AS dc
                    INNER JOIN ( SELECT DISTINCT
                                    DC.co_tipo_doc, DC.nro_doc, E.co_prov,
                                    ISNULL
```
