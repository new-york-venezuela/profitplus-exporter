# SP: pActualizarFactDocVentaTasaMoneda
**Tipo**: Actualizar
**Módulo**: Ventas
...
```sql
/**************************************************************************
*NOMBRE			: [pActualizarFactDocVentaTasaMoneda]
*DESCRIPCIÓN	: 
*AUTOR			: SOFTECH SISTEMAS
**************************************************************************/ 
CREATE PROCEDURE [dbo].[pActualizarFactDocVentaTasaMoneda]
(		
		@sDoc_num			CHAR(20),
		@sCo_tipo_doc       CHAR(6),
        @sCo_mone			CHAR(6),
...
BEGIN
		...
		SELECT
            @dtFe_In = fe_us_mo, @rowGuidOriFACT = rowgui
```
