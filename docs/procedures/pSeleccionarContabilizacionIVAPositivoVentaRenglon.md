# SP: pSeleccionarContabilizacionIVAPositivoVentaRenglon
**Tipo**: Seleccionar
**Módulo**: Inventario
...
```sql
/**************************************************************************************************************
NOMBRE		: pSeleccionarContabilizacionIVAPositivoVentaRenglon
DESCRIPCION	: Seleccionar Contabilización IVA positivo documentos de ventas renglon No Contabilizados.
CREADO POR	: SOFTECH SISTEMAS
FECHA CREACIÓN: <2019-11-21>
***************************************************************************************************************/
CREATE PROCEDURE [dbo].[pSeleccionarContabilizacionIVAPositivoVentaRenglon]
    (
