# SP: pInsertarConfigPlantillaVenta
**Tipo**: Insertar
**Módulo**: General
...
```sql
/************************************************************************
*NOMBRE			:pInsertarConfigPlanillaVenta
*DESCRIPCIÓN	: Inserta una Configuración en la tabla saConfigPlanillaVenta
*AUTOR			: SOFTECH SISTEMAS
*************************************************************************/
CREATE PROCEDURE [pInsertarConfigPlantillaVenta]
    (
      @sCo_Config CHAR(6) ,
...
AS 
    BEGIN
        ...
        INSERT  INTO saConfigPlantillaVenta
        ...
        EXEC [pInsertarPista] @sUsuario_Id = @sCo_Us_In, @dtFecha = @dtFe_In, @sCo_Sucu = @sCo_Sucu_in,
            @sTablaOri = 'saConfigPlantillaVenta', @rowguidOri = @rowGuidOri, @sTipo_Op = '
```
