...
-- Last Date Update 2017-10-27
-- Description:	<Cobros por su Fecha>
-- =============================================
CREATE PROCEDURE [dbo].[RepCobrosxNumero]
...
AS 
    BEGIN
        ...
        SELECT
            P.cob_num, P.fecha, P.co_cli, PV.cli_des, PT.forma_pag, PT.reng_num, P.anulado, p.co_mone, PT.num_doc,
			...
			CASE	
				...
				ELSE [dbo].[TasaAUnaFecha](@sCo_Moneda_Rep, 1, P.fecha)
			END AS tasa,
