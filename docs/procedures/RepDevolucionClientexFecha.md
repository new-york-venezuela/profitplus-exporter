...
-- Description:	<Reporte de Devoluciones a Clientes por Fecha>
-- =============================================
CREATE PROCEDURE [RepDevolucionClientexFecha] 
...
-------------------------------
        SELECT
            @cAnulado AS Filtro_anulado, 'DEVO' AS tipo_rep, @cImprSubTotal AS SubTotales, CLI.tip_cli, CLI.cli_des,
