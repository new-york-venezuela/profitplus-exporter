# SP: pActualizarConfigFacturaCompra
**Tipo**: Actualizar
**Módulo**: Compras
...
```sql
/**************************************************************************
*NOMBRE			: pActualizarConfigFacturaCompra
*DESCRIPCIÓN	: Actualiza la configuracion del proceso Factura Compra
*AUTOR			: SOFTECH SISTEMAS
**************************************************************************/

CREATE PROCEDURE [pActualizarConfigFacturaCompra]
    (
      @sCo_Config CHAR(6) ,
