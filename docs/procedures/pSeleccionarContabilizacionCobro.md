# SP: pSeleccionarContabilizacionCobro
**Tipo**: Seleccionar
**Módulo**: Tesorería
...
```sql
/**************************************************************************************************************
NOMBRE: pSeleccionarContabilizacionCobro
DESCRIPCION: Selecciona los datos a contabilizar de Cobro
CREADO POR: SOFTECH SISTEMAS
CREADO EL: 11/06/2010
MODIFICADO EL: 2018-03-09
***************************************************************************************************************/
CREATE PROCEDURE [dbo].[pSeleccionarContabilizacionCobro]
    (
...
AS 
    BEGIN
       ...
       * NOTA 7: IMPORTANTE, todos los montos que se tomen de mo
```
