...
-- Description:	<Reporte de Pedidos de Ventas por Vendedor>
-- =============================================
CREATE PROCEDURE [RepPedidoVentaxVendedor] 
...
-------------------------------
        SELECT
            @cAnulado AS Filtro_anulado, 'PED' AS tipo_rep, CLI.tip_cli, CLI.cli_des, CLI.co_zon, VE.ven_des,
