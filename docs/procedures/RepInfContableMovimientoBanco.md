# SP: RepInfContableMovimientoBanco
**Tipo**: Reporte
**Módulo**: Tesorería
...
-- Description:	<Información Contable Movimiento de Banco>
-- =============================================
CREATE PROCEDURE [dbo].[RepInfContableMovimientoBanco]
...
BEGIN
  ...
  Select A.mov_num, MOV.fecha, MOV.feccom, MOV.numcom, A.num_carp, A.Descripcion,
 ...
 Select	A.mov_num, A.feccom, '01' as num_carp,
...
from	saMovimientoBanco A
		outer apply A.dis_cen.nodes('Informa
```
