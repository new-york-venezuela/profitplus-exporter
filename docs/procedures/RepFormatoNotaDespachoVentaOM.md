# SP: RepFormatoNotaDespachoVentaOM
**Tipo**: Reporte
**Módulo**: Clientes
...
-- Description:	<Reporte de Formato de Nota de Despacho Venta (OM)>
-- =============================================
CREATE PROCEDURE [RepFormatoNotaDespachoVentaOM] 
...
AS 
    ...
    -- Insert statements for procedure here
		...
		/*Campos saNotaDespachoVenta*/ FV.doc_num, FV.descrip, FV.co_cli, FV.co_tran, FV.co_mone, FV.co_ven,
		...
		/*Campos saNotaDespachoVentaReng*/ FVR.reng_num, FVR.doc_num, FVR.co_art,
            ...
            FVR.prec_vta / FV.tasa AS prec_vta, FVR.prec_vta_om, FVR.porc_desc, FVR.monto_desc / FV.tasa A
```
