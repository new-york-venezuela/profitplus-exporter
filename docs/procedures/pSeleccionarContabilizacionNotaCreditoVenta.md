# SP: pSeleccionarContabilizacionNotaCreditoVenta
**Tipo**: Seleccionar
**Módulo**: Ventas
...
## Código (excerpt)
```sql
CREATE PROCEDURE [dbo].[pSeleccionarContabilizacionNotaCreditoVenta]
    (
...
AS 
	 ...
	 */
		...
		SELECT     RTRIM(DV.nro_doc) AS Co_Doc,CL.co_cli AS Co_Auxiliar, CL.cli_Des AS Descrip_Auxiliar, DV.nro_doc, DV.co_cli, DV.co_ven,
```
