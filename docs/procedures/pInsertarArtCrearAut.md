...
```sql
/**************************************************************************
*NOMBRE			: pInsertarArtCrearAut
*DESCRIPCIÓN	: Inserta una plantilla de generación de Artículos
*AUTOR			: SOFTECH SISTEMAS
**************************************************************************/ 

CREATE PROCEDURE [dbo].[pInsertarArtCrearAut]
    (
