# SP: pActualizarConfigPedidoVenta
**Tipo**: Actualizar
**Módulo**: Ventas
...
```sql
/**************************************************************************
*NOMBRE			: pActualizarConfigPedidoVenta
*DESCRIPCIÓN	: Actualiza la configuracion del proceso Pedido Venta
*AUTOR			: SOFTECH SISTEMAS
**************************************************************************/
CREATE PROCEDURE [pActualizarConfigPedidoVenta]
    (
      @sCo_Config CHAR(6) ,
