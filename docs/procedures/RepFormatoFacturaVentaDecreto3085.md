# SP: RepFormatoFacturaVentaDecreto3085
**Tipo**: Reporte
**Módulo**: Clientes
...
-- =============================================
CREATE PROCEDURE [dbo].[RepFormatoFacturaVentaDecreto3085] 
...
AS 
    ...
    -- Insert statements for procedure here
		...
		/*Campos saFacturaVentaReng*/ FVR.reng_num, FVR.doc_num, FVR.co_art, FVR.des_art, FVR.co_alma, FVR.total_art,
            ...
            FVR.dis_cen, FVR.co_us_in, FVR.c
```
