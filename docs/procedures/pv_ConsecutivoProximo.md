...
CREATE PROCEDURE [dbo].[pv_ConsecutivoProximo]
    (
...
AS 
    BEGIN    
        ...
        SELECT
            ...
            @coSerie = saSerie.co_serie, @strTabla = saConsecutivoTipo.Tabla, @strPrefijo = saSerieTipo.prefijo,
        ...
        WHERE
                    saConsecutivo.co_consecutivo = @sCo_Consecutivo and
                    (saConsecutivo.co_sucur is null or saConsecutivo.co_sucur = '' or saConsecutivo.co_sucur = @sCo_Sucur) and 
                    saSerie.co_serie = @sCoSerie
