# SP: pInsertarAjustePrecioCostoAutomatico
**Tipo**: Insertar
**Módulo**: Inventario
...
LASTDATE UPDATE: 2020-07-01
NOMBRE :		 [pInsertarAjustePrecioCostoAutomatico]
DESCRIPCIÓN :	 Inserta un ajuste de precio/costo automatico
*********************************************************************/
CREATE PROCEDURE [dbo].[pInsertarAjustePrecioCostoAutomatico]
    (
      @sCod_Ajuste CHAR(20) ,
      @sDes_Ajuste CHAR(50) ,
