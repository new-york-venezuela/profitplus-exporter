# SP: pValidarDevolucionProveedorCalculos
**Tipo**: Validar
**Módulo**: Compras
...
## Código (excerpt)
```sql
CREATE PROCEDURE [dbo].[pValidarDevolucionProveedorCalculos]
    (
...
AS 
	...
	-- Total Bruto (Versus renglones)
        ...
        WHILE @@FETCH_STATUS = 0 
            BEGIN
                SET @PistaMensaje = 'La devolución a proveedor nro. "' + RTRIM(@pDoc_Num)
