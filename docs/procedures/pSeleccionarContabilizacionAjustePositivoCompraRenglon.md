# SP: pSeleccionarContabilizacionAjustePositivoCompraRenglon
**Tipo**: Seleccionar
**Módulo**: Inventario
...
```sql
/**************************************************************************************************************
NOMBRE		pSeleccionarContabilizacionAjustePositivoCompraRenglon
DESCRIPCION	:Selecciona los documentos de ajuste positivo en compras por renglon no contabilizados
CREADO POR	:SOFTECH SISTEMAS
CREADO EL	:2019/11/21
***************************************************************************************************************/
CREATE PROCEDURE [dbo].[pSeleccionarContabilizacionAjustePositivoCompraRenglon]
    (
