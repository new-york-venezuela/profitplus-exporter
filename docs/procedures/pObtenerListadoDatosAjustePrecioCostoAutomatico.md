# SP: pObtenerListadoDatosAjustePrecioCostoAutomatico
**Tipo**: Obtener
**Módulo**: Inventario
...
```sql
/**************************************************************************************************************
NOMBRE:		 [pObtenerListadoDatosAjustePrecioCostoAutomatico]
DESCRIPCION: Obtiene la lista de los registros de ajustes automatco de precios y/o costos dado un rango de 
...
***************************************************************************************************************/
CREATE PROCEDURE [dbo].[pObtenerListadoDatosAjustePrecioCostoAutomatico]
    (
	  ...
	  @bAplica_Redondeo				BIT					= NULL,
	  @sTipoRedondeo				CHAR(1)				= NULL,

	  @bAplica_Metodo				BIT					= NULL,
	  @sTipoMetodo					CHAR(1)				= NULL,
    ...
    BEGIN	
		...
		ELSE 
          ...
          SET @SqlString = N'USE ' + CONVERT(NVARCHAR(100), @sDataBase_Name) + ' SELECT TOP(500) *    
					   FROM ' + CONVERT(NVARCHAR(100), 'saAjPrecioCostoAuto') + ' WHERE '
