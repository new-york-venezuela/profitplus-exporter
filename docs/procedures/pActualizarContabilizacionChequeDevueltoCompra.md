# SP: pActualizarContabilizacionChequeDevueltoCompra
**Tipo**: Actualizar
**Módulo**: Compras
...
```sql
/*************************************************************************************************
NOMBRE:	pActualizarContabilizacionChequeDevueltoCompra
DESCRIPCION:Actualizar las contabilizaciones de Cheque Devuelto en Compra
CREADO POR: SOFTECH SISTEMAS
CREADO EL: 18/04/2011
**************************************************************************************************/
CREATE PROCEDURE [pActualizarContabilizacionChequeDevueltoCompra]
    (
      @sCo_Doc CHAR(20) ,
      @sCo_Tipo_Doc CHAR (6),
