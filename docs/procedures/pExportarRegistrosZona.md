...
*DESCRIPCIÓN	:	Inserta un Zona
*AUTOR			:	SOFTECH SISTEMAS
***************************************************************************/

CREATE PROCEDURE [dbo].[pExportarRegistrosZona]
    (
      @sCo_Zon				CHAR(6) ,
      @sZon_Des				VARCHAR(60) ,
...
AS 
    BEGIN
		...
		SET @sSql = N'EXEC [' + @sempresa + '].[dbo].[pInsertarZona]	@sCo_Zon,
																		@sZon_Des,
																		@sDis_Cen,
		...
		EXEC sp_executesql @sSql, N'@sCo_Zon CHAR(6),			@sZon_Des VARCHAR(60),		@sDis_Cen VARCHAR(MAX),
