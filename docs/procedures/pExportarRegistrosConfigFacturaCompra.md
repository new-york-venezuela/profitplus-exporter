# SP: pExportarRegistrosConfigFacturaCompra
**Tipo**: Procedimiento
**Módulo**: Compras
...
```sql
/**************************************************************************
*NOMBRE			:	pExportarRegistrosConfigFacturaCompra
*DESCRIPCIÓN	:	Inserta una Configuración en la tabla saConfigFacturaCompra
*AUTOR			:	SOFTECH SISTEMAS
***************************************************************************/
CREATE PROCEDURE [dbo].[pExportarRegistrosConfigFacturaCompra]
    (
      @sCo_Config CHAR(6) ,
...
AS 
    BEGIN
		...
		SET @sSql = N'EXEC [' + @sempresa + '].[dbo].[pInsertarConfigFacturaCompra]	
																		@sCo_Config,
																		@sDes_Config,
																		@sCo_Usuario,
																		@sCo_Mapa,
