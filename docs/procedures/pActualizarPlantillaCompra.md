...
*NOMBRE			:	pActualizarPlantillaCompra
*DESCRIPCIÓN	:	Actualiza una Plantilla de compra
*AUTOR			:	Softech
**************************************************************************/

CREATE PROCEDURE [dbo].[pActualizarPlantillaCompra]
   (
      @sDoc_Num CHAR(20) ,
      @sDoc_NumOri CHAR(20) ,
      @sNro_Fact CHAR(20) ,
...
AS 
    BEGIN	
        ...
        UPDATE
            saPlantillaCompra
        SET doc_num = @sDoc_Num, nro_fact = @sNro_Fact, descrip = @sDescrip, co_prov = @sCo_Prov, co_mone = @sCo_Mone,
```
