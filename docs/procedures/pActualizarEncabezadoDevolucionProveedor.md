# SP: pActualizarEncabezadoDevolucionProveedor
**Tipo**: Actualizar
**Módulo**: Compras
...
```sql
/***********************************************************************
*NOMBRE			:	pActualizarEncabezadoDevolucionProveedor
*DESCRIPCIÓN	:	Actualiza el Encabezado del Renglon para Indicar que cambio
*AUTOR			:	SOFTECH SISTEMAS
************************************************************************/
CREATE PROCEDURE [dbo].[pActualizarEncabezadoDevolucionProveedor]
    (
