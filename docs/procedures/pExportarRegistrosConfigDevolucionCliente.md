# SP: pExportarRegistrosConfigDevolucionCliente
**Tipo**: Procedimiento
**Módulo**: Ventas
...
```sql
/**************************************************************************
*NOMBRE			:	pExportarRegistrosConfigDevolucionCliente
*DESCRIPCIÓN	:	Inserta una Configuración en la tabla saConfigDevolucionCliente
*AUTOR			:	SOFTECH SISTEMAS
***************************************************************************/
CREATE PROCEDURE [dbo].[pExportarRegistrosConfigDevolucionCliente]
    (
      @sCo_Config CHAR(6) ,
...
AS 
    BEGIN
		...
		SET @sSql = N'EXEC [' + @sempresa + '].[dbo].[pInsertarConfigDevolucionCliente]	
																		@sCo_Config,
																		@sDes_Config,
																		@sCo_Usuario,
																		@sCo_Mapa,
