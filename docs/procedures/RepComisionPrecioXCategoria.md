# SP: RepComisionPrecioXCategoria
**Tipo**: Reporte
**Módulo**: Inventario
...
/*=============================================
 ...
 Description:	<Comision por Niveles de Precio por Categoria>
 =============================================*/
CREATE PROCEDURE [RepComisionPrecioXCategoria]
...
AS 
    BEGIN
        ...
        SELECT
            ...
            (CASE WHEN C.aplica_en = 'C' THEN 'COBROS' ELSE 'VENTAS' END) AS aplica_en, C.hasta1, 
            C.hasta2, C.hasta3, C.hasta4, C.hasta5, C.porc1, C.porc2, C.porc3, C.porc4, C.porc5, C.porc6,
        ...
        FROM
            ...
            INNER JOIN saComisionPrecioCategoria AS C ON C.co_cat = CAT.co_cat
        WHERE
            ( ( @sCo_Cat_d IS NULL
