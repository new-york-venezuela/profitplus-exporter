# SP: pValidarRengImportadoOrdenCompraReng
**Tipo**: Validar
**Módulo**: Compras
...
## Código (excerpt)
```sql
CREATE PROCEDURE [pValidarRengImportadoOrdenCompraReng]
    (
...
AS 
    BEGIN	
        ...
        FOR
            ...
            FROM
                saNotaRecepcionCompraReng R1
                LEFT JOIN saOrdenCompraReng R2 ON R1.rowguid_doc = R2.rowguid
            WHERE
        ...
        WHILE @@FETCH_STATUS = 0 
            BEGIN
                ...
                IF @pR2Reng_num IS NULL 
                    BEGIN
                        SET @PistaMensaje = 'La nota de recepcion nro. "' + RTRIM(@pR1Doc_Num) + '" renglon "'
