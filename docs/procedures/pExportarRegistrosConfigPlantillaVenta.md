# SP: pExportarRegistrosConfigPlantillaVenta
**Tipo**: Procedimiento
**Módulo**: General
...
```sql
/**************************************************************************
*NOMBRE			:	pExportarRegistrosConfigPlantillaVenta
*DESCRIPCIÓN	:	Inserta una Configuración en la tabla saConfigPlantillaVenta
*AUTOR			:	SOFTECH SISTEMAS
***************************************************************************/
CREATE PROCEDURE [dbo].[pExportarRegistrosConfigPlantillaVenta]
    (
      @sCo_Config CHAR(6) ,
...
AS 
    BEGIN
		...
		SET @sSql = N'EXEC [' + @sempresa + '].[dbo].[pInsertarConfigPlantillaVenta]	
																		@sCo_Config,
																		@sDes_Config,
																		@sCo_Usuario,
																		@sCo_Mapa,
