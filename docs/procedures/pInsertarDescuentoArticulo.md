...
***************************************************************************************************************/
CREATE PROCEDURE [dbo].[pInsertarDescuentoArticulo]
    (
      @sCo_Desc CHAR(6) ,
...
AS 
    BEGIN
        ...
        INSERT  INTO saDescArticulo
                ( co_desc, des_des, co_art, tip_cli, hasta1, hasta2, hasta3, hasta4, hasta5, porc1, porc2, porc3, porc4,
        ...
        OUTPUT  inserted.validador, inserted.fe_us_in, inserted.fe_us_mo, Inserted.rowguid uniqueidentifier
                INTO @TableTimestamp
        VALUES
                ( @sCo_Desc, @sDes_Des, @sCo_Art, @sTip_Cli, @deHasta1, @deHasta2, @deHasta3, @deHasta4, @deHasta5,
                  @dePorc1, @dePorc2, @dePorc3, @dePorc4, @dePorc5, @
```
