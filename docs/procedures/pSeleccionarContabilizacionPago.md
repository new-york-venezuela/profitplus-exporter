# SP: pSeleccionarContabilizacionPago
**Tipo**: Seleccionar
**Módulo**: Tesorería
...
## Código (excerpt)
```sql
CREATE PROCEDURE [pSeleccionarContabilizacionPago]
    (
...
AS 
	 ...
	 */
		...
		SELECT     FV.cob_num AS Co_Doc, FV.fecha AS fec_emis, FV.co_sucu_in AS Co_Sucu_Cont, cl.co_prov AS Co_Auxiliar, cl.prov_des AS Descrip_Auxiliar,
```
