# SP: RepCotizacionClientexCliente
**Tipo**: Reporte
**Módulo**: Clientes
...
-- Description:	<Reporte de Cotizaciones a Clientes por Cliente>
-- =============================================
CREATE PROCEDURE [RepCotizacionClientexCliente] 
...
-------------------------------
        ...
        SELECT
            @cAnulado AS Filtro_anulado, 'COTI' AS tipo_rep, CLI.tip_cli, CLI.cli_des, CLI.co_zon, CLI.co_seg,
            FV.doc_num, FV.descrip, FV.co_cli, FV.co_tran, FV.co_mone, FV.co_ven, FV.co_cond, FV.fec_emis, FV.fec_venc,
            FV.fec_reg, FV.anulado, FV.status, FV.n_control, FV.ven_ter, FV.tasa, FV.porc_desc_glob, FV.monto_desc_glob,
            FV.porc_reca, FV.monto_reca, FV.total_bruto, FV.monto_imp, FV.monto_imp2, FV.monto_imp3, FV.otros1,
            FV.otros2, FV.otros3, FV.total_neto / ( CASE WHEN @cCo_Moneda IS NULL THEN 1
                                                         ELSE FV.tasa
                                                    END ) AS total_neto,
            FV.saldo / ( CASE WHEN @cCo_Moneda IS NULL THEN 1
                              ELSE FV.tasa
                         END ) AS saldo, FV.dir_ent, FV.comentario, FV.dis_cen, FV.feccom,
```
