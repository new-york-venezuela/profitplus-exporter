...
-- Description:	<Reporte de Factura de Ventas por Artículos>
-- =============================================
CREATE PROCEDURE [dbo].[RepFacturaVentaxArt] 
...
-------------------------------
		...
		/*Campos saFacturaVenta*/ FV.doc_num, FV.descrip, FV.co_cli, FV.co_tran, FV.co_mone, FV.co_ven, FV.co_cond,
            ...
            FV.monto_imp2, FV.monto_imp3, FV.otros1, FV.otros2, 
			FV.otros3, 
