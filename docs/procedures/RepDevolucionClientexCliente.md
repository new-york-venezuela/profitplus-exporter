# SP: RepDevolucionClientexCliente
**Tipo**: Reporte
**Módulo**: Ventas
...
-- Description:	<Reporte de Devoluciones a Clientes por Cliente>
-- =============================================
CREATE PROCEDURE [RepDevolucionClientexCliente] 
...
-------------------------------
        ...
        SELECT
            @cAnulado AS Filtro_anulado, 'DEVO' AS tipo_rep, CLI.tip_cli, CLI.cli_des, CLI.co_zon, CLI.co_seg,
