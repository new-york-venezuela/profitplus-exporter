# SP: pInsertarConfigFacturaVenta
**Tipo**: Insertar
**Módulo**: Ventas
...
```sql
/************************************************************************
*NOMBRE			:pInsertarConfigFacturaVenta
*DESCRIPCIÓN	: Inserta una Configuración en la tabla saConfigFacturaVenta
*AUTOR			: SOFTECH SISTEMAS
*************************************************************************/

CREATE PROCEDURE [pInsertarConfigFacturaVenta]
    (
      @sCo_Config CHAR(6) ,
...
AS 
    BEGIN
        ...
        INSERT  INTO saConfigFacturaVenta
        ...
        EXEC [pInsertarPista] @sUsuario_Id = @sCo_Us_In, @dtFecha = @dtFe_In, @sCo_Sucu = @sCo_Sucu_in,
            @sTablaOri = 'saConfigFacturaVenta', @rowguidOri = @rowGuidOri, @sTipo_Op = 'I', @s
```
