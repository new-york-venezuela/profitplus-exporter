# SP: pValidarDevolucionClienteRengProrateo
**Tipo**: Validar
**Módulo**: Ventas
...
## Código (excerpt)
```sql
CREATE PROCEDURE [dbo].[pValidarDevolucionClienteRengProrateo]
    (
                    ...
                    BEGIN
                        ...
                        FOR
                            ...
                            FROM
								...
								left join saDocumentoVenta dv on dv.nro_doc = e.nro_doc and dv.co_tipo_doc='N/CR' --DN 050522
								left join saDocumentoVentaInfoIGTF dvig on dvig.rowguid = dv.rowguid --DN 050522
                            WHERE
                                --R.otros1_glob <> ROUND(( E.otros1 * R.reng_neto ) / E.total_bruto, 5) --DN 050522
								 E.t
```
