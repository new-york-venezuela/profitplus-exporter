# SP: RepAnalisisVencimientoTotalizadoComp
**Tipo**: Reporte
**Módulo**: Tesorería
...
-- =============================================
CREATE PROCEDURE [RepAnalisisVencimientoTotalizadoComp]
...
AS 
    BEGIN
        ...
        DECLARE @saldo_venc120_d AS DECIMAL(18, 2)
        DECLARE @saldo_venc120_h AS DECIMAL(18, 2)
        DECLARE @saldo_venc150_d AS DECIMAL(18, 2)
        DECLARE @saldo_venc150_h AS DECIMAL(18, 2)
        DECLARE @saldo_venc150_mayor AS DECIMAL(18, 2)
        ...
        IF @iDias IS NULL
            ...
            BEGIN
                ...
                SET @saldo_venc150_h = @saldo_venc150
```
