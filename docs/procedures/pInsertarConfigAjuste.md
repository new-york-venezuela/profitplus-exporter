...
*DESCRIPCIÓN	: Inserta una Configuración en la tabla saConfigAjuste
*AUTOR			: SOFTECH SISTEMAS
*************************************************************************/
CREATE PROCEDURE [pInsertarConfigAjuste]
    (
      @sCo_Config CHAR(6) ,
...
AS 
    BEGIN
        ...
        EXEC [pInsertarPista] @sUsuario_Id = @sCo_Us_In, @dtFecha = @dtFe_In, @sCo_Sucu = @sCo_Sucu_in,
            @sTablaOri = 'saConfigAjuste', @rowguidOri = @rowGuidOri, @sTipo_Op = 'I', @sMaquina = @sMaquina,
            @sCam
```
