# SP: pActualizarRenglonesGiroCompra
**Tipo**: Actualizar
**Módulo**: Compras
...
```sql
/**************************************************************************************************************
NOMBRE		: pActualizarRenglonesGiroCompra
DESCRIPCION	: Inserta un registro de la tabla saDocumentoCompraReng
CREADO POR	: SOFTECH SISTEMAS

***************************************************************************************************************/
CREATE PROCEDURE [pActualizarRenglonesGiroCompra]
    (
      @iReng_Num INT ,
      @iReng_NumOri INT ,
      @sco_Giro CHAR(20) ,
...
AS 
    BEGIN
        ...
        EXEC [pInsertarPista] @sUsuario_Id = @sCo_Us_Mo, @dtFecha = @dtFe_In, @sCo_Sucu = @sCo_Sucu_Mo,
            @sTablaOri = 'saGiroCompraReng', @rowguidOri = @rowGuidOri, @sTipo_Op = 'M', @sMaquina = @sMaquina,
            @sCampos = @sco_giro
