# SP: pInsertarRenglonesDevolucionProveedor
**Tipo**: Insertar
**Módulo**: Compras
...
```sql
/***********************************************************************
*NOMBRE			:	pInsertarRenglonesDevolucionProveedor
*DESCRIPCIÓN	:	Inserta un renglon de devolucion
*AUTOR			:	SOFTECH SISTEMAS
************************************************************************/

CREATE PROCEDURE [dbo].[pInsertarRenglonesDevolucionProveedor]
    (
      @iReng_Num INT ,
      @sDoc_Num CHAR(20) ,
      @sCo_Art CHAR(30) ,
...
AS 
    BEGIN
		...
		/*La cantidad de pendiente es ig
```
