...
-- Description:	<Reporte de Notas de Entrega de Venta por Renglones>
-- =============================================
CREATE PROCEDURE [dbo].[RepNotaEntregaVentaxReng] 
...
-------------------------------
        ...
        SELECT
            @cAnulado AS Filtro_anulado, 'nota_en' AS tip_rep, ART.art_des, ART.modelo, ART.co_lin, ART.co_subl,
            ART.co_cat, CL.cli_des, VE.ven_des, TR.des_tran, CP.cond_des,		
