...
*NOMBRE			: [pActualizarCobro]
*DESCRIPCIÓN	: Actualiza Cobro
*AUTOR			: SOFTECH SISTEMAS
**************************************************************************/

CREATE PROCEDURE [pActualizarCobro]
    (
      @sCob_Num CHAR(20) ,
      @sCob_NumOri CHAR(20) ,
      @sRecibo CHAR(15) ,
...
AS 
    BEGIN	
        ...
        UPDATE
            [saCobro]
        SET [cob_num] = @sCob_Num, [recibo] = @sRecibo, [descrip] = @sDescrip, [co_cli] = @sCo_cli, [co_ven] = @sCo_ven,
