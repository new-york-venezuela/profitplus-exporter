# SP: RepFormatoDevolucionClienteOM_NCF
**Tipo**: Reporte
**Módulo**: Clientes
...
-- Description:	Reporte para Devolución de Cliente NCF (Dominicana) en Otra Moneda.
-- =============================================
CREATE PROCEDURE [dbo].[RepFormatoDevolucionClienteOM_NCF] 
...
AS 
    ...
    -- Insert statements for procedure here
        ...
        SELECT
            @Tipo_doc AS TIPO_DOC, 'tipo' = 1, ART.modelo, CL.cli_des, CL.rif, CL.nit, CL.telefonos, CL.fax, CL.direc1,NCF.ncf,NCFF.ncf AS ncf_afectado,C.co_tipo,C.des_tipo,CONVERT(char,SEXT.fe_venc,103) as fe_venc,
		...
		/*Campos saDevolucionCliente*/ FV.doc_num, FV.descrip, FV.co_cli, FV.co_tran, FV.co_mone, FV.co_ven,
            FV.co_cond, CONVERT(char,FV.fec_emis,103) as fec_emis,CONVERT(char, FV.fec_venc,103) as fec_venc, FV.fec_reg, FV.anulado, FV.status, FV.n_control, FV.ven_ter, FV.tasa,
            ...
            FV.saldo, FV.dir_ent, FV.comentario, FV.dis_cen, FV.feccom, FV.numcom, FV.contrib, FV.impresa,
		--FV.seriales_s,
		...
		/*Campos saDevolucionClienteReng*/ FVR.reng_num, FVR.doc_num, FVR.co_art,
            CASE WHEN FVR.des_art IS NOT NULL THEN FVR.des_art
                 ELSE ART.art_des
            END AS des_art, FVR.co_alma
```
