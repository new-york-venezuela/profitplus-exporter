...
-- Description:	<Reporte de Formato de Factura de Compra>
-- =============================================
CREATE PROCEDURE [dbo].[RepFormatoCompra]
...
AS 
    BEGIN
        ...
        SELECT
            ...
            FC.n_control, FC.fec_emis, FC.fec_venc, FC.fec_reg, FC.tasa, FC.saldo, FC.total_bruto, FC.total_neto,
            ...
            FVR.monto_imp2, FVR.monto_imp3, FVR.porc_gas, FVR.total_dev, FVR.monto_dev, FVR.lote_asignado,
            FVR.monto_desc, FVR.pendiente, FVR.pendiente2, FVR.comentario, FVR.costo_adi1, FVR.costo_adi2,
            FVR.costo_adi3, FVR.dis_cen, FVR.co_sucu_in, FV
```
