# SP: RepInfContableMovimientoCaja
**Tipo**: Reporte
**Módulo**: Tesorería
...
-- Description:	<Información Contable Movimiento de Caja>
-- =============================================
CREATE PROCEDURE [dbo].[RepInfContableMovimientoCaja]
...
from	saMovimientoCaja A
		outer apply A.dis_cen.nodes('Informacio
```
