# SP: pActualizarEncabezadoCompuesto
**Tipo**: Actualizar
**Módulo**: Inventario
...
-- =============================================
CREATE PROCEDURE [dbo].[pActualizarEncabezadoCompuesto]
    (
      @SCo_ArtC CHAR(20) ,
      @sCo_Us_Mo CHAR(6) ,
      @sCo_Sucu_Mo CHAR(6) ,
...
AS 
	...
	-- Insertar Pista
        EXEC [pInsertarPista] @sUsuario_Id = @sCo_Us_Mo, @dtFecha = @dtFe_In, @sCo_Sucu = @sCo_Sucu_Mo,
            @sTablaOri = 'saArtCompuesto', @rowguidOri = @rowGuidOri, @sTipo_Op = 'M', @sMaquina = @sMaquina,
