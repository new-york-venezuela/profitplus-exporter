# SP: pInsertarConfigCotizacionCliente
**Tipo**: Insertar
**Módulo**: Ventas
...
```sql
/************************************************************************
*NOMBRE			:pInsertarConfigCotizacionCliente
*DESCRIPCIÓN	: Inserta una Configuración en la tabla saConfigCotizacionCliente
*AUTOR			: SOFTECH SISTEMAS
*************************************************************************/

CREATE PROCEDURE [pInsertarConfigCotizacionCliente]
    (
      @sCo_Config CHAR(6) ,
...
AS 
    BEGIN
        ...
        INSERT  INTO saConfigCotizacionCliente
        ...
        EXEC [pInsertarPista] @sUsuario_Id = @sCo_Us_In, @dtFecha = @dtFe_In, @sCo_Sucu = @sCo_Sucu_in,
            @sTablaOri = 'saConfigCotizacionCliente', @rowguidOri = @rowGui
```
