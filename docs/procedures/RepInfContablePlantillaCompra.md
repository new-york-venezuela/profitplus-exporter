# SP: RepInfContablePlantillaCompra
**Tipo**: Reporte
**Módulo**: Inventario
...
-- Description:	<Información Contable Plantilla de Compra>
-- =============================================
CREATE PROCEDURE [dbo].[RepInfContablePlantillaCompra]
...
BEGIN
  ...
  (Select A.doc_num, PLA.fec_emis, PLA.co_prov, (select prov_des from saProveedor where co_prov = PLA.co_prov) as prov_des, PLA.feccom, 
  PLA.numcom, A.num_carp, A.Descripcion, case when ltrim(A.monto) = '' then 0 else cast(A.monto as decimal(18,5)) end as monto, 
