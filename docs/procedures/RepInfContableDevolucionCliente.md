# SP: RepInfContableDevolucionCliente
**Tipo**: Reporte
**Módulo**: Inventario
...
-- Description:	<Información Contable Devolución Cliente>
-- =============================================
CREATE PROCEDURE [dbo].[RepInfContableDevolucionCliente]
...
BEGIN
  ...
  (Select A.doc_num, DEV.fec_emis, DEV.co_cli, (select cli_des from saCliente where co_cli = DEV.co_cli) as cli_des, DEV.co_ven, 
  DEV.feccom, DEV.numcom, A.num_carp, A.Descripcion, case when ltrim(A.monto) = '' then 0 else cast(A.monto as decimal(18,5)) end as monto, 
 ...
 Select	A.doc_num, A.feccom, '01' as num_carp,
		...
		(select des_cen from scCentro where co_cen
```
