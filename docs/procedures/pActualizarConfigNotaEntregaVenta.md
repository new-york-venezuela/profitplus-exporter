# SP: pActualizarConfigNotaEntregaVenta
**Tipo**: Actualizar
**Módulo**: Ventas
...
```sql
/**************************************************************************
*NOMBRE			: pActualizarConfigNotaEntregaVenta
*DESCRIPCIÓN	: Actualiza la configuracion del proceso Nota de Entrega
*AUTOR			: SOFTECH SISTEMAS
**************************************************************************/

CREATE PROCEDURE [pActualizarConfigNotaEntregaVenta]
    (
      @sCo_Config CHAR(6) ,
