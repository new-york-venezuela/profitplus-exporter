# SP: RepDocumentoCXCxInformacionFiscal
**Tipo**: Reporte
**Módulo**: Clientes
...
-- Description:	<Documentos de Ventas Con Información Fiscal>
-- =============================================
CREATE PROCEDURE [dbo].[RepDocumentoCXCxInformacionFiscal]
...
AS 
    BEGIN
        ...
        SELECT
            ...
            DC.anulado, ( DC.otros1 + DC.otros2 + DC.otros3 ) AS otros, DC.doc_orig, DC.nro_orig, DC.tipo_imp,
            DC.porc_imp, DC.fec_reg, ISNULL(DC.n_control, '') AS n_control,
            ...
            P.cli_des AS prov_des, TP.descrip, TP.tipo_mov, P.rif
        FROM
```
