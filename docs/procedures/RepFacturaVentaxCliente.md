...
-- Description:	<Reporte de Factura de Ventas por Cliente>
-- =============================================
CREATE PROCEDURE [RepFacturaVentaxCliente] 
...
-------------------------------
        ...
        SELECT
            @cAnulado AS Filtro_anulado, 'FACT' AS tipo_rep, CLI.tip_cli, CLI.cli_des, CLI.co_zon, CLI.co_seg,
