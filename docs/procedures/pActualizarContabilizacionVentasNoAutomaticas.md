# SP: pActualizarContabilizacionVentasNoAutomaticas
**Tipo**: Actualizar
**Módulo**: Ventas
...
```sql
/*************************************************************************************************
NOMBRE:	pActualizarContabilizacionVentasNoAutomaticas
DESCRIPCION:Actualizar las contabilizaciones de Facturas ventas no automaticas
CREADO POR: SOFTECH SISTEMAS
CREADO EL: 15/06/2010
**************************************************************************************************/
CREATE PROCEDURE [pActualizarContabilizacionVentasNoAutomaticas]
    (
      @sCo_Doc CHAR(20) ,
      @sCo_Tipo_Doc CHAR(6),
