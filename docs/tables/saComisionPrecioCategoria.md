# Tabla: saComisionPrecioCategoria
**Módulo**: Ventas
...
- `FK_saComisionPrecioCategoria_saCatArticulo`: `co_cat` → `saCatArticulo.co_cat`
- `FK_saComisionPrecioCategoria_saTipoPrecio`: `co_precio` → `saTipoPrecio.co_precio`
