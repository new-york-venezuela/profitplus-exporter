...
|---|---|---|---|---|
| `co_vale` | char(6) | NOT NULL | b'C\xc3\xb3digo del Vale Alimentaci\xc3\xb3n ' | — |
| `vale_descrip` | varchar(60) | NOT NULL | b'Descripci\xc3\xb3n del Vale Alimentaci\xc3\xb3n' | — |
| `comision` | decimal(18,5) | NOT NULL | b'Porcentaje de Comisi\xc3\xb3n del Vale Alimentacion' | — |
| `impuesto` | decimal(18,5) | NOT NULL | b'Porcentaje de Impuesto del Vale Alimentacion' | — |
| `recargo` | decimal(18,5) | NOT NULL | b'Porcentaje de recargo del Vale Alimentacion' | — |
| `inactivo` | bit(1,0) | NOT NULL | b'Indicativo de registro inactivo' | — |
| `imagen` | varbinary | NULL | b'Imagen' | — |
