...
|---|---|---|---|---|
| `cod_plan` | char(6) | NOT NULL | — | — |
| `des_plan` | varchar(60) | NOT NULL | — | — |
| `tipo` | char(4) | NOT NULL | — | — |
| `ano` | int(10,0) | NOT NULL | — | — |
| `mes` | int(10,0) | NOT NULL | — | — |
| `fecha_pago` | datetime(23,3) | NOT NULL | — | — |
| `numero_plan` | varchar(30) | NOT NULL | — | — |
