...
|---|---|---|---|---|
| `tip_cli` | char(6) | NOT NULL | b'Tipo de Cliente' | — |
| `des_tipo` | varchar(60) | NOT NULL | b'Descripci\xc3\xb3n del tipo de cliente' | — |
...
- `FK_saTipoCliente_saTipoPrecio`: `co_precio` → `saTipoPrecio.co_precio`
