...
|---|---|---|---|---|
| `rowguid_doc_num` | uniqueidentifier | NOT NULL | b'Identificador \xc3\xbanico (Tabla saFacturaVenta)' | FK → `saFacturaVenta.rowguid` |
| `rowguid_num_FactLoteGen` | uniqueidentifier | NOT NULL | b'Identificador \xc3\xbanico (Tabla stgFactLoteGen)' | FK → `stgFactLoteGen.rowguid` |
...
- `FK_stgFacturaVentaExt_stgFactLoteGen`: `rowguid_num_FactLoteGen` → `stgFactLoteGen.rowguid`
- `FK_stgFacturaVentaExt_saFacturaVenta`: `rowguid_doc_num` → `saFacturaVenta.rowguid`
