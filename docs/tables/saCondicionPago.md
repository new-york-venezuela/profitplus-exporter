...
|---|---|---|---|---|
| `co_cond` | char(6) | NOT NULL | b'Codigo de Condicion de Pago' | — |
| `cond_des` | varchar(60) | NOT NULL | b'Descripci\xc3\xb3n de la condici\xc3\xb3n de pago' | — |
| `dias_cred` | int(10,0) | NOT NULL | b'Dias de credito permitido' | — |
