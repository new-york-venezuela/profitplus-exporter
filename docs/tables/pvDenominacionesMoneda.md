...
|---|---|---|---|---|
| `valor` | decimal(18,2) | NOT NULL | b'Valor de la Moneda' | — |
| `inactivo` | char(1) | NOT NULL | b'Identifica si esta Inactivo' | — |
| `co_mone` | char(6) | NOT NULL | b'Codigo de Moneda' | FK Implícita → `saMoneda.co_mone` |
