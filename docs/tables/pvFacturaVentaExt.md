...
| `estado` | char(1) | NOT NULL | b"'E' = En espera, 'N', = No Procesado, 'P' = 'Procesado'" | — |
...
- `FK_pvFacturaVentaExt_pvTurnoExe`: `rowguid_num_turno` → `pvTurnoExe.rowguid`
- `FK_pvFacturaVentaExt_saFacturaVenta`: `rowguid_doc_num` → `saFacturaVenta.rowguid`
