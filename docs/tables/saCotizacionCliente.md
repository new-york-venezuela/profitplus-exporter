...
- `TrigEstado_saCotizacionCliente`

## Foreign Keys (explícitas)
- `FK_saCotizacionCliente_saVendedor`: `co_ven` → `saVendedor.co_ven`
- `FK_saCotizacionCliente_saCuentaIngEgr`: `co_cta_ingr_egr` → `saCuentaIngEgr.co_cta_ingr_egr`
- `FK_saCotizacionCliente_saCliente`: `co_cli` → `saCliente.co_cli`
- `FK_saCotizacionCliente_saCondicionPago`: `co_cond` → `saCondicionPago.co_cond`
- `FK_saCotizacionCliente_saMoneda`: `co_mone` → `saMoneda.co_mone`
- `FK_saCotizacionCliente_saTax`: `salestax` → `saTax.tax_id`
- `FK_saCotizacionCliente_saTransporte`: `co_tran` → `saTransporte.co_tran`
