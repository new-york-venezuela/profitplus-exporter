...
- `TrigEstado_saPlantillaVenta`

## Foreign Keys (explícitas)
- `FK_saPlantillaVenta_saCliente`: `co_cli` → `saCliente.co_cli`
- `FK_saPlantillaVenta_saCondicionPago`: `co_cond` → `saCondicionPago.co_cond`
- `FK_saPlantillaVenta_saMoneda`: `co_mone` → `saMoneda.co_mone`
- `FK_saPlantillaVenta_saTax`: `salestax` → `saTax.tax_id`
- `FK_saPlantillaVenta_saTransporte`: `co_tran` → `saTransporte.co_tran`
- `FK_saPlantillaVenta_saVendedor`: `co_ven` → `saVendedor.co_ven`
- `FK_saPlantillaVenta_saCuentaIngEgr`: `co_cta_ingr_egr` → `saCuentaIngEgr.co_cta_ingr_egr`
