# Tabla: saComisionPrecioArticulo
**Módulo**: Ventas
...
- `FK_saComisionPrecioArticulo_saArticulo`: `co_art` → `saArticulo.co_art`
- `FK_saComisionPrecioArticulo_saTipoPrecio`: `co_precio` → `saTipoPrecio.co_precio`
