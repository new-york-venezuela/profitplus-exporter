...
- `TrigEstado_saCotizacionProveedor`

## Foreign Keys (explícitas)
- `FK_saCotizacionProveedor_saCondicionPago`: `co_cond` → `saCondicionPago.co_cond`
- `FK_saCotizacionProveedor_saMoneda`: `co_mone` → `saMoneda.co_mone`
- `FK_saCotizacionProveedor_saProveedor`: `co_prov` → `saProveedor.co_prov`
- `FK_saCotizacionProveedor_saTax`: `salestax` → `saTax.tax_id`
