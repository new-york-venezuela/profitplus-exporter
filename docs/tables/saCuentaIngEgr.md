...
|---|---|---|---|---|
| `co_cta_ingr_egr` | char(20) | NOT NULL | b'C\xc3\xb3digo de la cuenta de ingreso/egreso' | — |
| `descrip` | varchar(60) | NOT NULL | b'Descripci\xc3\xb3n del registro o documento' | — |
| `co_islr` | char(6) | NULL | b'Concepto de I.S.L.R.' | FK → `saConISLR.co_islr` |
...
- `FK_saCuentaIngEgr_saConISLR`: `co_islr` → `saConISLR.co_islr`
