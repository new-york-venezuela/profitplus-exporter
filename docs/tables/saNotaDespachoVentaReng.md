...
| `doc_num` | char(20) | NOT NULL | b'Numero de documento' | FK → `saNotaDespachoVenta.doc_num` |
...
- `FK_saNotaDespachoVentaReng_saAlmacen`: `co_alma` → `saAlmacen.co_alma`
- `FK_saNotaDespachoVentaReng_saArtUnidad`: `co_art` → `saArtUnidad.co_art`
- `FK_saNotaDespachoVentaReng_saArtUnidad`: `co_uni` → `saArtUnidad.co_uni`
- `FK_saNotaDespachoVentaReng_saArtUnidadSecundaria`: `co_art` → `saArtUnidad.co_art`
- `FK_saNotaDespachoVentaReng_saArtUnidadSecundaria`: `sco_uni` → `saArtUnidad.co_uni`
- `FK_saNotaDespachoVentaReng_saNotaDespachoVenta`: `doc_num` → `saNotaDespachoVenta.doc_num`
