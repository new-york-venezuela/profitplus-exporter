...
|---|---|---|---|---|
| `co_comi` | char(6) | NOT NULL | b'Codigo del tipo de comision' | — |
| `des_comi` | varchar(60) | NOT NULL | b'Descripcion del tipo de comision' | — |
| `inactivo` | bit(1,0) | NOT NULL | b'Tipo de comision inactiva' | — |
