...
|---|---|---|---|---|
| `co_seg` | char(6) | NOT NULL | b'C\xc3\xb3digo del Segmento' | — |
| `seg_des` | varchar(60) | NOT NULL | b'Descripci\xc3\xb3n del Segmento' | — |
| `c_cuenta` | char(20) | NULL | b'*' | — |
| `p_cuenta` | char(20) | NULL | b'*' | — |
