...
- `TrigEstado_saOrdenCompra`

## Foreign Keys (explícitas)
- `FK_saOrdenCompra_saCondicionPago`: `co_cond` → `saCondicionPago.co_cond`
- `FK_saOrdenCompra_saCuentaIngEgr`: `co_cta_ingr_egr` → `saCuentaIngEgr.co_cta_ingr_egr`
- `FK_saOrdenCompra_saMoneda`: `co_mone` → `saMoneda.co_mone`
- `FK_saOrdenCompra_saProveedor`: `co_prov` → `saProveedor.co_prov`
- `FK_saOrdenCompra_saTax`: `salestax` → `saTax.tax_id`
