...
| `rowguid_num_turno` | uniqueidentifier | NOT NULL | b'Indicador \xc3\xbanico (Tabla pvTurnoExe)' | FK → `pvTurnoExe.rowguid` |
...
| `rowguid_mov_caj_gen` | uniqueidentifier | NULL | — | — |

## Triggers Relacionados
_Ninguno_

## Foreign Keys (explícitas)
- `FK_pvMovimientoCajaExt_pvTurnoExe`: `rowguid_num_turno` → `pvTurnoExe.rowguid`
- `FK_pvMovimientoCajaExt_saMovimientoCaja`: `rowguid_mov_num` → `saMovimientoCaja.rowguid`
