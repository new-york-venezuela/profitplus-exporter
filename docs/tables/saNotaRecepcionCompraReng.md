# Tabla: saNotaRecepcionCompraReng
**Módulo**: Compras
...
| `doc_num` | char(20) | NOT NULL | b'Numero de documento' | FK → `saNotaRecepcionCompra.doc_num` |
...
- `FK_saNotaRecepcionCompraReng_saAlmacen`: `co_alma` → `saAlmacen.co_alma`
- `FK_saNotaRecepcionCompraReng_saArtUnidad`: `co_art` → `saArtUnidad.co_art`
- `FK_saNotaRecepcionCompraReng_saArtUnidad`: `co_uni` → `saArtUnidad.co_uni`
- `FK_saNotaRecepcionCompraReng_saArtUnidadSecundaria`: `co_art` → `saArtUnidad.co_art`
- `FK_saNotaRecepcionCompraReng_saArtUnidadSecundaria`: `sco_uni` → `saArtUnidad.co_uni`
- `FK_saNotaRecepcionCompraReng_saNotaRecepcionCompra`: `doc_num` → `saNotaRecepcionCompra.doc_num`
