...
|---|---|---|---|---|
| `rowguid_cob_num` | uniqueidentifier | NOT NULL | b'Identificador \xc3\xbanico (Tabla saCobro)' | FK → `saCobro.rowguid` |
...
- `FK_pvCobroExt_pvTurnoExe`: `rowguid_num_turno` → `pvTurnoExe.rowguid`
- `FK_pvCobroExt_saCobro`: `rowguid_cob_num` → `saCobro.rowguid`
