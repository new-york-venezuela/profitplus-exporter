...
|---|---|---|---|---|
| `co_tipo_imag` | char(6) | NOT NULL | b'C\xc3\xb3digo del Tipo de Imagen' | — |
| `descrip` | varchar(60) | NOT NULL | b'Descripci\xc3\xb3n del Tipo de Imagen' | — |
| `campo_Adic` | varchar(60) | NULL | — | — |
