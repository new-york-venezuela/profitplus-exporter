...
|---|---|---|---|---|
| `rowguid_co_tar` | uniqueidentifier | NOT NULL | b'Codigo de Tarjeta asociado' | FK → `saTarjetaCredito.rowguid` |
| `rowguid_co_tipo_tar` | uniqueidentifier | NOT NULL | b'Codigo Tipo de Tarjeta' | FK → `pvTipoTarjeta.Rowguid` |
...
- `FK_pvTarjetaCreditoExt_pvTipoTarjeta`: `rowguid_co_tipo_tar` → `pvTipoTarjeta.Rowguid`
- `FK_pvTarjetaCreditoExt_saTarjetaCredito`: `rowguid_co_tar` → `saTarjetaCredito.rowguid`
