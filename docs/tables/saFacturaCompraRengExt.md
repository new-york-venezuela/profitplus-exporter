...
|---|---|---|---|---|
| `rowguid_reng` | uniqueidentifier | NOT NULL | b'Identificador \xc3\xbanico (Tabla saFacturaCompraReng)' | FK → `saFacturaCompraReng.rowguid` |
| `sin_der_cre_fis` | bit(1,0) | NULL | b'Indica si en el rengl\xc3\xb3n de la factura el articulo esta marcado "Sin credito Fiscal"' | — |
...
- `FK_saFacturaCompraRengExt_saFacturaCompraReng`: `rowguid_reng` → `saFacturaCompraReng.rowguid`
