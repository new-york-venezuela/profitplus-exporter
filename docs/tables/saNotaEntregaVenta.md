...
- `TrigDelete_saNotaEntregaVenta`
- `TrigEstado_saNotaEntregaVenta`

## Foreign Keys (explícitas)
- `FK_saNotaEntregaVenta_saVendedor`: `co_ven` → `saVendedor.co_ven`
- `FK_saNotaEntregaVenta_saCuentaIngEgr`: `co_cta_ingr_egr` → `saCuentaIngEgr.co_cta_ingr_egr`
- `FK_saNotaEntregaVenta_saCliente`: `co_cli` → `saCliente.co_cli`
- `FK_saNotaEntregaVenta_saCondicionPago`: `co_cond` → `saCondicionPago.co_cond`
- `FK_saNotaEntregaVenta_saMoneda`: `co_mone` → `saMoneda.co_mone`
- `FK_saNotaEntregaVenta_saTax`: `salestax` → `saTax.tax_id`
- `FK_saNotaEntregaVenta_saTransporte`: `co_tran` → `saTransporte.co_tran`
