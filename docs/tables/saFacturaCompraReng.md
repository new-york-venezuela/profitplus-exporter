...
| `doc_num` | char(20) | NOT NULL | b'Numero de documento' | FK → `saFacturaCompra.doc_num` |
...
- `FK_saFacturaCompraReng_saAlmacen`: `co_alma` → `saAlmacen.co_alma`
- `FK_saFacturaCompraReng_saArtUnidad`: `co_art` → `saArtUnidad.co_art`
- `FK_saFacturaCompraReng_saArtUnidad`: `co_uni` → `saArtUnidad.co_uni`
- `FK_saFacturaCompraReng_saArtUnidadSecundaria`: `co_art` → `saArtUnidad.co_art`
- `FK_saFacturaCompraReng_saArtUnidadSecundaria`: `sco_uni` → `saArtUnidad.co_uni`
- `FK_saFacturaCompraReng_saFacturaCompra`: `doc_num` → `saFacturaCompra.doc_num`
