# Tabla: saDevolucionProveedorReng
**Módulo**: Compras
...
| `doc_num` | char(20) | NOT NULL | b'Numero de documento' | FK → `saDevolucionProveedor.doc_num` |
...
- `FK_saDevolucionProveedorReng_saAlmacen`: `co_alma` → `saAlmacen.co_alma`
- `FK_saDevolucionProveedorReng_saArtUnidad`: `co_art` → `saArtUnidad.co_art`
- `FK_saDevolucionProveedorReng_saArtUnidad`: `co_uni` → `saArtUnidad.co_uni`
- `FK_saDevolucionProveedorReng_saArtUnidadSecundaria`: `co_art` → `saArtUnidad.co_art`
- `FK_saDevolucionProveedorReng_saArtUnidadSecundaria`: `sco_uni` → `saArtUnidad.co_uni`
- `FK_saDevolucionProveedorReng_saDevolucionProveedor`: `doc_num` → `saDevolucionProveedor.doc_num`
