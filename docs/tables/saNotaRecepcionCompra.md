...
- `TrigEstado_saNotaRecepcionCompra`

## Foreign Keys (explícitas)
- `FK_saNotaRecepcionCompra_saCondicionPago`: `co_cond` → `saCondicionPago.co_cond`
- `FK_saNotaRecepcionCompra_saCuentaIngEgr`: `co_cta_ingr_egr` → `saCuentaIngEgr.co_cta_ingr_egr`
- `FK_saNotaRecepcionCompra_saMoneda`: `co_mone` → `saMoneda.co_mone`
- `FK_saNotaRecepcionCompra_saProveedor`: `co_prov` → `saProveedor.co_prov`
- `FK_saNotaRecepcionCompra_saTax`: `salestax` → `saTax.tax_id`
