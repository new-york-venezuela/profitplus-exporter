# Tabla: pvMovimientoCajaDevolucionExt
...
|---|---|---|---|---|
| `rowguid_nro_doc` | uniqueidentifier | NOT NULL | b'Indicador \xc3\xbanico (Tabla saDocumentoVenta)' | FK → `saDocumentoVenta.rowguid` |
| `rowguid_mov_num` | uniqueidentifier | NOT NULL | b'Indicador \xc3\xbanico (Tabla saMovimientoCaja)' | FK → `saMovimientoCaja.rowguid` |
...
- `FK_pvMovimientoCajaDevolucionExt_saDocumentoVenta`: `rowguid_nro_doc` → `saDocumentoVenta.rowguid`
- `FK_pvMovimientoCajaDevolucionExt_saMovimientoCaja`: `rowguid_mov_num` → `saMovimientoCaja.rowguid`
