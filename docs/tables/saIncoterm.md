...
|---|---|---|---|---|
| `co_incoterm` | char(6) | NOT NULL | b'C\xc3\xb3digo' | — |
| `incoterm_des` | varchar(60) | NOT NULL | b'Descripci\xc3\xb3n' | — |
| `secuencia` | int(10,0) | NOT NULL | b'N\xc3\xbamero de secuencia' | — |
| `maritimo` | bit(1,0) | NOT NULL | — | — |
| `aereo` | bit(1,0) | NOT NULL | — | — |
| `terrestre` | bit(1,0) | NOT NULL | — | — |
| `descrip_detallada` | nvarchar(max) | NULL | — | — |
