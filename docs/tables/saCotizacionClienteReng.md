...
| `doc_num` | char(20) | NOT NULL | b'Numero de documento' | FK → `saCotizacionCliente.doc_num` |
...
- `FK_saCotizacionClienteReng_saAlmacen`: `co_alma` → `saAlmacen.co_alma`
- `FK_saCotizacionClienteReng_saArtUnidad`: `co_art` → `saArtUnidad.co_art`
- `FK_saCotizacionClienteReng_saArtUnidad`: `co_uni` → `saArtUnidad.co_uni`
- `FK_saCotizacionClienteReng_saArtUnidadSecundaria`: `co_art` → `saArtUnidad.co_art`
- `FK_saCotizacionClienteReng_saArtUnidadSecundaria`: `sco_uni` → `saArtUnidad.co_uni`
- `FK_saCotizacionClienteReng_saCotizacionCliente`: `doc_num` → `saCotizacionCliente.doc_num`
