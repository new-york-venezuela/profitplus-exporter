# Tabla: saCotizacionProveedorReng
**Módulo**: Compras
...
| `doc_num` | char(20) | NOT NULL | b'Numero de documento' | FK → `saCotizacionProveedor.doc_num` |
...
- `FK_saCotizacionProveedorReng_saAlmacen`: `co_alma` → `saAlmacen.co_alma`
- `FK_saCotizacionProveedorReng_saArtUnidad`: `co_art` → `saArtUnidad.co_art`
- `FK_saCotizacionProveedorReng_saArtUnidad`: `co_uni` → `saArtUnidad.co_uni`
- `FK_saCotizacionProveedorReng_saArtUnidadSecundaria`: `co_art` → `saArtUnidad.co_art`
- `FK_saCotizacionProveedorReng_saArtUnidadSecundaria`: `sco_uni` → `saArtUnidad.co_uni`
- `FK_saCotizacionProveedorReng_saCotizacionProveedor`: `doc_num` → `saCotizacionProveedor.doc_num`
