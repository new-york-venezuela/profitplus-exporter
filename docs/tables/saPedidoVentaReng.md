...
| `doc_num` | char(20) | NOT NULL | b'Numero de documento' | FK → `saPedidoVenta.doc_num` |
...
- `FK_saPedidoVentaReng_saAlmacen`: `co_alma` → `saAlmacen.co_alma`
- `FK_saPedidoVentaReng_saArtUnidad`: `co_art` → `saArtUnidad.co_art`
- `FK_saPedidoVentaReng_saArtUnidad`: `co_uni` → `saArtUnidad.co_uni`
- `FK_saPedidoVentaReng_saArtUnidadSecundaria`: `co_art` → `saArtUnidad.co_art`
- `FK_saPedidoVentaReng_saArtUnidadSecundaria`: `sco_uni` → `saArtUnidad.co_uni`
- `FK_saPedidoVentaReng_saPedidoVenta`: `doc_num` → `saPedidoVenta.doc_num`
