...
|---|---|---|---|---|
| `cod_impuesto` | char(6) | NOT NULL | b'C\xc3\xb3digo del Impuesto' | — |
| `des_impuesto` | varchar(60) | NOT NULL | b'Descripci\xc3\xb3n del Impuesto' | — |
| `registro_sist` | bit(1,0) | NOT NULL | b'Valor booleano para indicar si el registro es propio del sistema y no puede ser editado. (true = es del sistema - no editable;  false = es editable).' | — |
