...
| `doc_num` | char(20) | NOT NULL | b'Numero de documento' | FK → `saNotaEntregaVenta.doc_num` |
...
- `FK_saNotaEntregaVentaReng_saAlmacen`: `co_alma` → `saAlmacen.co_alma`
- `FK_saNotaEntregaVentaReng_saArtUnidad`: `co_art` → `saArtUnidad.co_art`
- `FK_saNotaEntregaVentaReng_saArtUnidad`: `co_uni` → `saArtUnidad.co_uni`
- `FK_saNotaEntregaVentaReng_saArtUnidadSecundaria`: `co_art` → `saArtUnidad.co_art`
- `FK_saNotaEntregaVentaReng_saArtUnidadSecundaria`: `sco_uni` → `saArtUnidad.co_uni`
- `FK_saNotaEntregaVentaReng_saNotaEntregaVenta`: `doc_num` → `saNotaEntregaVenta.doc_num`
