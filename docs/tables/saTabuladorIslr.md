...
|---|---|---|---|---|
| `co_tab` | char(20) | NOT NULL | b'C\xc3\xb3digo del tabulado de ISLR' | — |
| `tab_des` | varchar(60) | NOT NULL | b'Descripci\xc3\xb3n del tabulado de ISLR' | — |
| `tipo_per` | char(1) | NOT NULL | b'Tipo de persona a la que aplica el concepto de ISLR' | — |
