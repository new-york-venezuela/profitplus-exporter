...
|---|---|---|---|---|
| `co_etiqueta` | char(6) | NOT NULL | b'C\xc3\xb3digo de la etiqueta' | — |
| `des_etiqueta` | varchar(60) | NOT NULL | b'Decripci\xc3\xb3n de la etiqueta' | — |
| `pre` | int(10,0) | NOT NULL | b'N\xc3\xbamero de d\xc3\xadgitos del prefijo de la etiqueta' | — |
| `cod` | int(10,0) | NOT NULL | b'N\xc3\xbamero de d\xc3\xadgitos del c\xc3\xb3digo de la etiqueta' | — |
| `suf` | int(10,0) | NOT NULL | b'N\xc3\xbamero de d\xc3\xadgitos del sufijo de la etiqueta' | — |
| `ent` | int(10,0) | NOT NULL | b'N\xc3\xbamero de d\xc3\xadgitos enteros de la etiqueta' | — |
| `dec` | int(10,0) | NOT NULL | b'N\xc3\xbamero de d\xc3\xadgitos decimales de la etiqueta' | — |
| `adic` | int(10,0) | NOT NULL | b'N\xc3\xbamero de d\xc3\xadgitos adicionales de la etiqueta' | — |
| `activo` | bit(1,0) | NULL | b'Identifica si esta Activo' | — |
| `peso_precio` | char(2) | NULL | b'Determina si la etiqueta de la balanza es para peso o precio' | — |
| `campo1` | varchar(60) | NULL | b'Campo Adicional 4' | — |
