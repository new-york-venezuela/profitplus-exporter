...
| `doc_num` | char(20) | NOT NULL | b'Numero de documento' | FK → `saPlantillaCompra.doc_num` |
...
- `FK_saPlantillaCompraReng_saAlmacen`: `co_alma` → `saAlmacen.co_alma`
- `FK_saPlantillaCompraReng_saArtUnidad`: `co_art` → `saArtUnidad.co_art`
- `FK_saPlantillaCompraReng_saArtUnidad`: `co_uni` → `saArtUnidad.co_uni`
- `FK_saPlantillaCompraReng_saArtUnidadSecundaria`: `co_art` → `saArtUnidad.co_art`
- `FK_saPlantillaCompraReng_saArtUnidadSecundaria`: `sco_uni` → `saArtUnidad.co_uni`
- `FK_saPlantillaCompraReng_saPlantillaCompra`: `doc_num` → `saPlantillaCompra.doc_num`
